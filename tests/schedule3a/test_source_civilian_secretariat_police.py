...
def test_civilian_secretariat_police_source_initialization():
...
def test_civilian_secretariat_police_parse_mock_html():
    from tender_getter.sources.schedule3a.civilian_secretariat_police import CivilianSecretariatPoliceSource, MOCK_HTML
    src = CivilianSecretariatPoliceSource()
    tenders = src.parse_html(MOCK_HTML)
    assert len(tenders) >= 2


def test_civilian_secretariat_police_fetch_uses_fallback_on_empty():
    from tender_getter.sources.schedule3a.civilian_secretariat_police import CivilianSecretariatPoliceSource
    src = CivilianSecretariatPoliceSource()
