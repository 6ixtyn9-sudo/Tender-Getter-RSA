...
# ---------------------------------------------------------------------------
# 28 — Chain composition (ROUND 6: OpenCorporates retired — archived dataset)
# ---------------------------------------------------------------------------


def test_default_chain_excludes_stale_mirrors():
    """OpenCorporates ZA is an archive frozen at Sept 2014 (CIPRO-era data):
    every post-2014 company is a false NOT_FOUND and stale 'In Business'
    statuses would falsely bless dead companies. It must never re-enter the
    chain; only authoritative SA sources may answer."""
