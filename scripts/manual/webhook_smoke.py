...
Run this after starting the local server with TG_ALLOW_INSECURE_WEBHOOK=1.
Example: TG_ALLOW_INSECURE_WEBHOOK=1 PYTHONPATH=src python -m tender_getter.whatsapp.webhook
"""
