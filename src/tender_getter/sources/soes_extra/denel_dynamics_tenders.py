"""Denel Dynamics tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Denel Dynamics Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Denel Dynamics tenders</h1>
        <table>
            <thead>
...
class DenelDynamicsSource:
    """Tender source plug-in for Denel Dynamics."""

    source_id: str = "denel_dynamics_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.deneldynamics.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Denel Dynamics"
