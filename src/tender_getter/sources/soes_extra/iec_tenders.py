"""Independent Electoral Commission (IEC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Independent Electoral Commission (IEC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Independent Electoral Commission (IEC) tenders</h1>
        <table>
            <thead>
...
class IecSource:
    """Tender source plug-in for Independent Electoral Commission (IEC)."""

    source_id: str = "iec_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.elections.org.za/content/Procurement"):
        self.url = url
        self.issuing_entity = "Independent Electoral Commission (IEC)"
