"""iGas (SA Gas Development Company) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>iGas (SA Gas Development Company) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active iGas (SA Gas Development Company) tenders</h1>
        <table>
            <thead>
...
class IgasSource:
    """Tender source plug-in for iGas (SA Gas Development Company)."""

    source_id: str = "igas_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.igas.co.za/procurement"):
        self.url = url
        self.issuing_entity = "iGas (SA Gas Development Company)"
