"""Autopax Passenger Services tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Autopax Passenger Services Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Autopax Passenger Services tenders</h1>
        <table>
            <thead>
...
class AutopaxSource:
    """Tender source plug-in for Autopax Passenger Services."""

    source_id: str = "autopax_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.autopax.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Autopax Passenger Services"
