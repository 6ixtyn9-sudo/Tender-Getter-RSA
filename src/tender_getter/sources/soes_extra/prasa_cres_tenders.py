"""PRASA CRES (Capital, Real Estate & Sustainability) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>PRASA CRES (Capital, Real Estate & Sustainability) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active PRASA CRES (Capital, Real Estate & Sustainability) tenders</h1>
        <table>
            <thead>
...
class PrasaCresSource:
    """Tender source plug-in for PRASA CRES (Capital, Real Estate & Sustainability)."""

    source_id: str = "prasa_cres_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.prasacres.co.za/procurement"):
        self.url = url
        self.issuing_entity = "PRASA CRES (Capital, Real Estate & Sustainability)"
