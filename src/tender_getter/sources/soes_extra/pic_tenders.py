"""Public Investment Corporation (PIC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Public Investment Corporation (PIC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Public Investment Corporation (PIC) tenders</h1>
        <table>
            <thead>
...
class PicSource:
    """Tender source plug-in for Public Investment Corporation (PIC)."""

    source_id: str = "pic_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.pic.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Public Investment Corporation (PIC)"
