"""South African Post Office (SAPO) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Post Office (SAPO) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Post Office (SAPO) tenders</h1>
        <table>
            <thead>
...
class SapoSource:
    """Tender source plug-in for South African Post Office (SAPO)."""

    source_id: str = "sapo_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.postoffice.co.za/about-us/procurement"):
        self.url = url
        self.issuing_entity = "South African Post Office (SAPO)"
