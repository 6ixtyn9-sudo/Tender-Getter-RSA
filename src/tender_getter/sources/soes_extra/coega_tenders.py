"""Coega Development Corporation (CDC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Coega Development Corporation (CDC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Coega Development Corporation (CDC) tenders</h1>
        <table>
            <thead>
...
class CoegaSource:
    """Tender source plug-in for Coega Development Corporation (CDC)."""

    source_id: str = "coega_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.coega.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Coega Development Corporation (CDC)"
