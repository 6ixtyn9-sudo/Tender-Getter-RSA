"""KZN Industrial Economic Cluster (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Industrial Economic Cluster (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Industrial Economic Cluster (alt) tenders</h1>
        <table>
            <thead>
...
class KznIecSource:
    """Tender source plug-in for KZN Industrial Economic Cluster (alt)."""

    source_id: str = "kzn_iec_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kzniec.org.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Industrial Economic Cluster (alt)"
