"""Strategic Fuel Fund (SFF) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Strategic Fuel Fund (SFF) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Strategic Fuel Fund (SFF) tenders</h1>
        <table>
            <thead>
...
class SffSource:
    """Tender source plug-in for Strategic Fuel Fund (SFF)."""

    source_id: str = "sff_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.strategicfuelfund.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Strategic Fuel Fund (SFF)"
