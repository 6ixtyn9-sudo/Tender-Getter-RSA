"""Transnet Port Terminals (TPT) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Transnet Port Terminals (TPT) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Transnet Port Terminals (TPT) tenders</h1>
        <table>
            <thead>
...
class TptSource:
    """Tender source plug-in for Transnet Port Terminals (TPT)."""

    source_id: str = "tpt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.transnetportterminals.net/procurement"):
        self.url = url
        self.issuing_entity = "Transnet Port Terminals (TPT)"
