"""Eskom Finance Company tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eskom Finance Company Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eskom Finance Company tenders</h1>
        <table>
            <thead>
...
class EskomFinanceSource:
    """Tender source plug-in for Eskom Finance Company."""

    source_id: str = "eskom_finance_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.eskom.co.za/finance/procurement"):
        self.url = url
        self.issuing_entity = "Eskom Finance Company"
