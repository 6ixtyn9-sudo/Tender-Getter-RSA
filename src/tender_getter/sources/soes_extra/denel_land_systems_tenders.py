"""Denel Land Systems tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Denel Land Systems Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Denel Land Systems tenders</h1>
        <table>
            <thead>
...
class DenelLandSystemsSource:
    """Tender source plug-in for Denel Land Systems."""

    source_id: str = "denel_land_systems_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.denells.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Denel Land Systems"
