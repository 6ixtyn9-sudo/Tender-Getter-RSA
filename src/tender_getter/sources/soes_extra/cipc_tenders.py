"""Companies and Intellectual Property Commission (CIPC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Companies and Intellectual Property Commission (CIPC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Companies and Intellectual Property Commission (CIPC) tenders</h1>
        <table>
            <thead>
...
class CipcSource:
    """Tender source plug-in for Companies and Intellectual Property Commission (CIPC)."""

    source_id: str = "cipc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cipc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Companies and Intellectual Property Commission (CIPC)"
