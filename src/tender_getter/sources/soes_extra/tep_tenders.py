"""Transnet Engineering (TEP) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Transnet Engineering (TEP) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Transnet Engineering (TEP) tenders</h1>
        <table>
            <thead>
...
class TepSource:
    """Tender source plug-in for Transnet Engineering (TEP)."""

    source_id: str = "tep_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.transnetengineering.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Transnet Engineering (TEP)"
