"""National Prosecuting Authority (NPA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Prosecuting Authority (NPA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Prosecuting Authority (NPA) tenders</h1>
        <table>
            <thead>
...
class NpaSource:
    """Tender source plug-in for National Prosecuting Authority (NPA)."""

    source_id: str = "npa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.npa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "National Prosecuting Authority (NPA)"
