"""Petroleum Agency SA (PASA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Petroleum Agency SA (PASA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Petroleum Agency SA (PASA) tenders</h1>
        <table>
            <thead>
...
class PasaSource:
    """Tender source plug-in for Petroleum Agency SA (PASA)."""

    source_id: str = "pasa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.petroleumagencysa.com/procurement"):
        self.url = url
        self.issuing_entity = "Petroleum Agency SA (PASA)"
