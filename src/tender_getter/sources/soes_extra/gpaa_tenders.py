"""Government Pensions Administration Agency (GPAA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Government Pensions Administration Agency (GPAA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Government Pensions Administration Agency (GPAA) tenders</h1>
        <table>
            <thead>
...
class GpaaSource:
    """Tender source plug-in for Government Pensions Administration Agency (GPAA)."""

    source_id: str = "gpaa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.gpaa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Government Pensions Administration Agency (GPAA)"
