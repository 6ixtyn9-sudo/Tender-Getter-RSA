"""Denel Aerostructures (SOC) Ltd tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Denel Aerostructures (SOC) Ltd Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Denel Aerostructures (SOC) Ltd tenders</h1>
        <table>
            <thead>
...
class DenelAerostructuresSource:
    """Tender source plug-in for Denel Aerostructures (SOC) Ltd."""

    source_id: str = "denel_aerostructures_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.denelaerostructures.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Denel Aerostructures (SOC) Ltd"
