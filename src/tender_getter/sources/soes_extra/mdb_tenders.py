"""Municipal Demarcation Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Municipal Demarcation Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Municipal Demarcation Board tenders</h1>
        <table>
            <thead>
...
class MdbSource:
    """Tender source plug-in for Municipal Demarcation Board."""

    source_id: str = "mdb_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.demarcation.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Municipal Demarcation Board"
