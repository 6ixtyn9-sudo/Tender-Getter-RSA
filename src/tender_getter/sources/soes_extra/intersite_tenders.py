"""PRASA Intersite Asset Management tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>PRASA Intersite Asset Management Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active PRASA Intersite Asset Management tenders</h1>
        <table>
            <thead>
...
class IntersiteSource:
    """Tender source plug-in for PRASA Intersite Asset Management."""

    source_id: str = "intersite_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.intersite.co.za/procurement"):
        self.url = url
        self.issuing_entity = "PRASA Intersite Asset Management"
