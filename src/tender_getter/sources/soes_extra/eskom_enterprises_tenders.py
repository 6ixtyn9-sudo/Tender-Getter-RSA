"""Eskom Enterprises tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eskom Enterprises Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eskom Enterprises tenders</h1>
        <table>
            <thead>
...
class EskomEnterprisesSource:
    """Tender source plug-in for Eskom Enterprises."""

    source_id: str = "eskom_enterprises_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.eskomenterprises.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eskom Enterprises"
