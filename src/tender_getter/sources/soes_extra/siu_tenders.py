"""Special Investigating Unit (SIU) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Special Investigating Unit (SIU) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Special Investigating Unit (SIU) tenders</h1>
        <table>
            <thead>
...
class SiuSource:
    """Tender source plug-in for Special Investigating Unit (SIU)."""

    source_id: str = "siu_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.siu.org.za/current-tenders/"):
        self.url = url
        self.issuing_entity = "Special Investigating Unit (SIU)"
