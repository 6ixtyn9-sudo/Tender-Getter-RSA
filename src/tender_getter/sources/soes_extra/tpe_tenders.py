"""Transnet Pipelines (TPE) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Transnet Pipelines (TPE) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Transnet Pipelines (TPE) tenders</h1>
        <table>
            <thead>
...
class TpeSource:
    """Tender source plug-in for Transnet Pipelines (TPE)."""

    source_id: str = "tpe_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.transnetpipelines.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Transnet Pipelines (TPE)"
