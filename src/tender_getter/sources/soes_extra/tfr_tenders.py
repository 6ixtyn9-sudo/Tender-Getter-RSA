"""Transnet Freight Rail (TFR) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Transnet Freight Rail (TFR) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Transnet Freight Rail (TFR) tenders</h1>
        <table>
            <thead>
...
class TfrSource:
    """Tender source plug-in for Transnet Freight Rail (TFR)."""

    source_id: str = "tfr_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.transnetfreightrail.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Transnet Freight Rail (TFR)"
