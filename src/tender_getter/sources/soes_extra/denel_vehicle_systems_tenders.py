"""Denel Vehicle Systems tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Denel Vehicle Systems Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Denel Vehicle Systems tenders</h1>
        <table>
            <thead>
...
class DenelVehicleSystemsSource:
    """Tender source plug-in for Denel Vehicle Systems."""

    source_id: str = "denel_vehicle_systems_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.denelvs.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Denel Vehicle Systems"
