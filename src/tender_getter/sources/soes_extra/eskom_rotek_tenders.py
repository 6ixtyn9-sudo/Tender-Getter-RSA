"""Eskom Rotek Industries tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eskom Rotek Industries Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eskom Rotek Industries tenders</h1>
        <table>
            <thead>
...
class EskomRotekSource:
    """Tender source plug-in for Eskom Rotek Industries."""

    source_id: str = "eskom_rotek_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.eskom.co.za/rotek/procurement"):
        self.url = url
        self.issuing_entity = "Eskom Rotek Industries"
