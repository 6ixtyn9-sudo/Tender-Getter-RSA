"""Transnet National Ports Authority (TNPA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Transnet National Ports Authority (TNPA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Transnet National Ports Authority (TNPA) tenders</h1>
        <table>
            <thead>
...
class TnpaSource:
    """Tender source plug-in for Transnet National Ports Authority (TNPA)."""

    source_id: str = "tnpa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.transnetnationalportsauthority.net/procurement"):
        self.url = url
        self.issuing_entity = "Transnet National Ports Authority (TNPA)"
