"""Metrorail tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Metrorail Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Metrorail tenders</h1>
        <table>
            <thead>
...
class MetrorailSource:
    """Tender source plug-in for Metrorail."""

    source_id: str = "metrorail_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.metrorail.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Metrorail"
