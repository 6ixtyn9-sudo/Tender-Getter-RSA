"""Ehlanzeni District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_EHLANZENI_HTML = """
<!DOCTYPE html><html><head><title>Ehlanzeni District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active Ehlanzeni District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>EDM/CE/2025/15</td>
                    <td>Bridge Rehabilitation – Mbombela (Mpumalanga, Grade 4CE)</td>
                    <td>2026-09-15 11:00:00</td>
                </tr>
                <tr>
                    <td>EDM/GB/2025/06</td>
                    <td>Community Centre Construction (Mpumalanga, Grade 2GB)</td>
                    <td>2026-08-31 11:00:00</td>
                </tr>
                <tr>
                    <td>EDM/EE/2025/03</td>
                    <td>Street Lighting Retrofit (Mpumalanga, Grade 2EE)</td>
                    <td>2026-09-08 11:00:00</td>
                </tr>
...
class EhlanzeniSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Ehlanzeni District Municipality tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_EHLANZENI_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_EHLANZENI_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Ehlanzeni District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Ehlanzeni District Municipality",
