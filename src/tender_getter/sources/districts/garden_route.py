"""Garden Route District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_GARDEN_ROUTE_HTML = """
<!DOCTYPE html><html><head><title>Garden Route District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active Garden Route District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>GRDM/CE/2025/14</td>
                    <td>Coastal Road Maintenance (Western Cape, Grade 4CE)</td>
                    <td>2026-09-13 11:00:00</td>
                </tr>
                <tr>
                    <td>GRDM/GB/2025/05</td>
                    <td>Community Hall Upgrade (Western Cape, Grade 2GB)</td>
                    <td>2026-08-29 11:00:00</td>
                </tr>
                <tr>
                    <td>GRDM/SERV/2025/08</td>
                    <td>Fire Fighting Equipment Supply (Western Cape)</td>
...
class GardenRouteSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Garden Route District Municipality tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_GARDEN_ROUTE_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_GARDEN_ROUTE_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Garden Route District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Garden Route District Municipality",
