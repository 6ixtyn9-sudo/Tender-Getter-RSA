"""OR Tambo District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_OR_TAMBO_HTML = """
<!DOCTYPE html><html><head><title>OR Tambo District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active OR Tambo District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>ORTDM/CE/2025/16</td>
                    <td>Rural Access Road – Mthatha (Eastern Cape, Grade 4CE)</td>
                    <td>2026-09-14 11:00:00</td>
                </tr>
                <tr>
                    <td>ORTDM/EE/2025/05</td>
                    <td>Solar Street Lights – PSJ (Eastern Cape, Grade 2EE)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>ORTDM/GB/2025/08</td>
                    <td>Municipal Office Refurbishment (Eastern Cape, Grade 2GB)</td>
...
class ORTamboSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active OR Tambo District Municipality tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_OR_TAMBO_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_OR_TAMBO_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses OR Tambo District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="OR Tambo District Municipality",
