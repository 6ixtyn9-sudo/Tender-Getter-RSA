"""Capricorn District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_CAPRICORN_HTML = """
<!DOCTYPE html><html><head><title>Capricorn District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active Capricorn District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>CDM/CE/2025/13</td>
                    <td>Water Reticulation – Polokwane (Limpopo, Grade 3CE)</td>
                    <td>2026-09-12 11:00:00</td>
                </tr>
                <tr>
                    <td>CDM/EE/2025/04</td>
                    <td>Pump Station Electrical Upgrade (Limpopo, Grade 2EE)</td>
                    <td>2026-08-29 11:00:00</td>
                </tr>
                <tr>
                    <td>CDM/SERV/2025/07</td>
                    <td>Road Maintenance Services (Limpopo)</td>
...
class CapricornSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Capricorn District Municipality tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_CAPRICORN_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_CAPRICORN_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Capricorn District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Capricorn District Municipality",
