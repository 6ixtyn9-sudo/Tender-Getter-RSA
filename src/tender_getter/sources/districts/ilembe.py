"""iLembe District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_ILEMBE_HTML = """
<!DOCTYPE html><html><head><title>iLembe District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active iLembe District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>IDM/CE/2025/09</td>
                    <td>Road Gravel to Tar – KwaDukuza (KwaZulu-Natal, Grade 3CE)</td>
                    <td>2026-09-07 11:00:00</td>
                </tr>
                <tr>
                    <td>IDM/GB/2025/03</td>
                    <td>Clinic Building Maintenance (KwaZulu-Natal, Grade 2GB)</td>
                    <td>2026-08-26 11:00:00</td>
                </tr>
                <tr>
                    <td>IDM/SERV/2025/05</td>
                    <td>Water Tanker Services (KwaZulu-Natal)</td>
                    <td>2026-09-11 11:00:00</td>
                </tr>
...
class ILembeSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active iLembe District Municipality tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_ILEMBE_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses iLembe District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="iLembe District Municipality",
