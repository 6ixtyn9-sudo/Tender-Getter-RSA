"""Sedibeng District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_SEDIBENG_DM_HTML = """
<!DOCTYPE html><html><head><title>Sedibeng District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active Sedibeng District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>SDM/CE/2025/12</td>
                    <td>Water Pipeline – Emfuleni (Gauteng, Grade 4CE)</td>
                    <td>2026-09-11 11:00:00</td>
                </tr>
                <tr>
                    <td>SDM/GB/2025/04</td>
                    <td>Clinic Renovation – Midvaal (Gauteng, Grade 2GB)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>SDM/SERV/2025/07</td>
                    <td>Security Services Panel (Gauteng)</td>
...
class SedibengDMSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Sedibeng District Municipality tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_SEDIBENG_DM_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SEDIBENG_DM_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Sedibeng District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Sedibeng District Municipality",
