"""West Rand District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_WEST_RAND_HTML = """
<!DOCTYPE html><html><head><title>West Rand District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active West Rand District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>WRDM/CE/2025/08</td>
                    <td>Rural Road Upgrade – Randfontein (Gauteng, Grade 3CE)</td>
                    <td>2026-09-09 11:00:00</td>
                </tr>
                <tr>
                    <td>WRDM/EE/2025/03</td>
                    <td>Street Lighting – Mogale City (Gauteng, Grade 2EE)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>WRDM/SERV/2025/05</td>
                    <td>Waste Collection Services (Gauteng)</td>
...
class WestRandSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active West Rand District Municipality tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_WEST_RAND_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_WEST_RAND_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses West Rand District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="West Rand District Municipality",
