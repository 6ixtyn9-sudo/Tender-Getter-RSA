"""Cape Winelands District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_CAPE_WINELANDS_HTML = """
<!DOCTYPE html><html><head><title>Cape Winelands District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active Cape Winelands District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>CWDM/CE/2025/09</td>
                    <td>Road Resurfacing – Stellenbosch (Western Cape, Grade 3CE)</td>
                    <td>2026-09-08 11:00:00</td>
                </tr>
                <tr>
                    <td>CWDM/EE/2025/02</td>
                    <td>Municipal Building Electrical (Western Cape, Grade 2EE)</td>
                    <td>2026-08-27 11:00:00</td>
                </tr>
                <tr>
                    <td>CWDM/SERV/2025/06</td>
                    <td>Tourism Infrastructure Maintenance (Western Cape)</td>
...
class CapeWinelandsSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Cape Winelands District Municipality tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_CAPE_WINELANDS_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_CAPE_WINELANDS_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Cape Winelands District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Cape Winelands District Municipality",
