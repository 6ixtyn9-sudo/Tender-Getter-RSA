"""King Cetshwayo District Municipality Tender Source Plugin"""
import logging
import re
...
MOCK_KING_CETSHWAYO_HTML = """
<!DOCTYPE html><html><head><title>King Cetshwayo District Municipality Tenders</title></head><body><div class="wrapper"><h1>Active King Cetshwayo District Municipality tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>KCDM/CE/2025/11</td>
                    <td>Rural Water Scheme – uMhlathuze (KwaZulu-Natal, Grade 3CE)</td>
                    <td>2026-09-10 11:00:00</td>
                </tr>
                <tr>
                    <td>KCDM/EE/2025/04</td>
                    <td>Street Light Installation (KwaZulu-Natal, Grade 2EE)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>KCDM/SERV/2025/07</td>
                    <td>Waste Management Services (KwaZulu-Natal)</td>
                    <td>2026-09-03 11:00:00</td>
                </tr>
...
class KingCetshwayoSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active King Cetshwayo District Municipality tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_KING_CETSHWAYO_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_KING_CETSHWAYO_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses King Cetshwayo District Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="King Cetshwayo District Municipality",
