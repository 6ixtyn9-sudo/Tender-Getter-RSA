...
<!DOCTYPE html>
<html>
<head><title>City of Tshwane Metropolitan Municipality Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active City of Tshwane Metropolitan Municipality tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>CTMM/EE007/25-26</td>
                    <td>Substation Refurbishment – Pretoria CBD (Gauteng, Grade 4EE)</td>
                    <td>2026-08-30 10:30:00</td>
                </tr>
                <tr>
                    <td>CTMM/CE033/25-26</td>
                    <td>Road Rehabilitation – Mamelodi (Gauteng, Grade 5CE)</td>
                    <td>2026-09-10 10:30:00</td>
                </tr>
                <tr>
                    <td>CTMM/ICT012/25-26</td>
                    <td>Municipal Wi-Fi Access Points Supply (Gauteng)</td>
                    <td>2026-08-26 10:30:00</td>
                </tr>
            </tbody>
        </table>
    </div>
...
class TshwaneSource:
    ...
    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses City of Tshwane Metropolitan Municipality tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            location_target = province_from_text(combined_text) or "Gauteng"  # Default to Gauteng for Tshwane
