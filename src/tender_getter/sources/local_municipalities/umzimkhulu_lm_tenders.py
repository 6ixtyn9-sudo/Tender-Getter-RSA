"""uMzimkhulu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMzimkhulu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMzimkhulu LM tenders</h1>
        <table>
            <thead>
...
class UmzimkhuluLmSource:
    """Tender source plug-in for uMzimkhulu LM."""

    source_id: str = "umzimkhulu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umzimkhulu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMzimkhulu LM"
