"""Sol Plaatje (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sol Plaatje (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sol Plaatje (alt) tenders</h1>
        <table>
            <thead>
...
class SolPlaatjeLmAltSource:
    """Tender source plug-in for Sol Plaatje (alt)."""

    source_id: str = "sol_plaatje_lm_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.solplaatje.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Sol Plaatje (alt)"
