"""Ngcobo Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ngcobo Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ngcobo Local Municipality tenders</h1>
        <table>
            <thead>
...
class NgcoboLmSource:
    """Tender source plug-in for Ngcobo Local Municipality."""

    source_id: str = "ngcobo_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ngcobomun.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ngcobo Local Municipality"
