"""uMngeni LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMngeni LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMngeni LM tenders</h1>
        <table>
            <thead>
...
class UmngeniLmSource:
    """Tender source plug-in for uMngeni LM."""

    source_id: str = "umngeni_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umgeni.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMngeni LM"
