"""Mkhondo LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mkhondo LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mkhondo LM tenders</h1>
        <table>
            <thead>
...
class MkhondoLmSource:
    """Tender source plug-in for Mkhondo LM."""

    source_id: str = "mkhondo_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mkhondo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mkhondo LM"
