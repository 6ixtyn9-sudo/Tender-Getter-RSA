"""Siyathemba LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Siyathemba LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Siyathemba LM tenders</h1>
        <table>
            <thead>
...
class SiyathembaLmSource:
    """Tender source plug-in for Siyathemba LM."""

    source_id: str = "siyathemba_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.siyathemba.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Siyathemba LM"
