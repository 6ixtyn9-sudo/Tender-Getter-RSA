"""Musina Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Musina Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Musina Local Municipality tenders</h1>
        <table>
            <thead>
...
class MusinaLmSource:
    """Tender source plug-in for Musina Local Municipality."""

    source_id: str = "musina_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.musina.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Musina Local Municipality"
