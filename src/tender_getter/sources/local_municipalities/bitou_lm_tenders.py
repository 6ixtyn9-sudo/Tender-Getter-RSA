"""Bitou LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Bitou LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Bitou LM tenders</h1>
        <table>
            <thead>
...
class BitouLmSource:
    """Tender source plug-in for Bitou LM."""

    source_id: str = "bitou_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.bitou.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Bitou LM"
