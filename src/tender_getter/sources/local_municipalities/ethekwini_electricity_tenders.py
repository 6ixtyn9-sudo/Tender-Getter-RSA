"""eThekwini Electricity tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>eThekwini Electricity Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active eThekwini Electricity tenders</h1>
        <table>
            <thead>
...
class EthekwiniElectricitySource:
    """Tender source plug-in for eThekwini Electricity."""

    source_id: str = "ethekwini_electricity_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.durban.gov.za/Electricity/procurement"):
        self.url = url
        self.issuing_entity = "eThekwini Electricity"
