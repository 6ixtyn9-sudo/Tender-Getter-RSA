"""Greater Letaba LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Greater Letaba LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Greater Letaba LM tenders</h1>
        <table>
            <thead>
...
class GreaterLetabaLmSource:
    """Tender source plug-in for Greater Letaba LM."""

    source_id: str = "greater_letaba_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.greaterletaba.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Greater Letaba LM"
