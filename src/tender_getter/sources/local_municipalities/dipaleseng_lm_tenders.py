"""Dipaleseng Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Dipaleseng Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Dipaleseng Local Municipality tenders</h1>
        <table>
            <thead>
...
class DipalesengLmSource:
    """Tender source plug-in for Dipaleseng Local Municipality."""

    source_id: str = "dipaleseng_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dipaleseng.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Dipaleseng Local Municipality"
