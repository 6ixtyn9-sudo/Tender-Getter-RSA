"""Sakhisizwe LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sakhisizwe LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sakhisizwe LM tenders</h1>
        <table>
            <thead>
...
class SakhisizweLmSource:
    """Tender source plug-in for Sakhisizwe LM."""

    source_id: str = "sakhisizwe_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sakhisizwe.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Sakhisizwe LM"
