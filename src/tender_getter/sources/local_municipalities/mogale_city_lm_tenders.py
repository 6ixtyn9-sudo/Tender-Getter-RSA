"""Mogale City Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mogale City Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mogale City Local Municipality tenders</h1>
        <table>
            <thead>
...
class MogaleCityLmSource:
    """Tender source plug-in for Mogale City Local Municipality."""

    source_id: str = "mogale_city_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mogalecity.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Mogale City Local Municipality"
