"""Sol Plaatje Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sol Plaatje Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sol Plaatje Local Municipality tenders</h1>
        <table>
            <thead>
...
class SolPlaatjeLmSource:
    """Tender source plug-in for Sol Plaatje Local Municipality."""

    source_id: str = "sol_plaatje_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.solplaatje.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Sol Plaatje Local Municipality"
