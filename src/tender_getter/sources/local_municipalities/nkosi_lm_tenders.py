"""Nkosi LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nkosi LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nkosi LM tenders</h1>
        <table>
            <thead>
...
class NkosiLmSource:
    """Tender source plug-in for Nkosi LM."""

    source_id: str = "nkosi_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nkosi.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Nkosi LM"
