"""Overstrand Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Overstrand Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Overstrand Municipality tenders</h1>
        <table>
            <thead>
...
class OverstrandLmSource:
    """Tender source plug-in for Overstrand Municipality."""

    source_id: str = "overstrand_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.overstrand.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Overstrand Municipality"
