"""Tshwane South LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Tshwane South LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Tshwane South LM tenders</h1>
        <table>
            <thead>
...
class TshwaneSouthLmSource:
    """Tender source plug-in for Tshwane South LM."""

    source_id: str = "tshwane_south_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.tshwanesouth.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Tshwane South LM"
