"""Emfuleni Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Emfuleni Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Emfuleni Local Municipality tenders</h1>
        <table>
            <thead>
...
class EmfuleniLmSource:
    """Tender source plug-in for Emfuleni Local Municipality."""

    source_id: str = "emfuleni_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.emfuleni.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Emfuleni Local Municipality"
