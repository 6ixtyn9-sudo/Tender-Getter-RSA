"""Modimolle (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Modimolle (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Modimolle (alt) tenders</h1>
        <table>
            <thead>
...
class ModimolleLmAltSource:
    """Tender source plug-in for Modimolle (alt)."""

    source_id: str = "modimolle_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.modimolle.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Modimolle (alt)"
