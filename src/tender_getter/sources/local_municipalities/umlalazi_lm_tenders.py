"""uMlalazi LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMlalazi LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMlalazi LM tenders</h1>
        <table>
            <thead>
...
class UmlalaziLmSource:
    """Tender source plug-in for uMlalazi LM."""

    source_id: str = "umlalazi_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umlalazi.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMlalazi LM"
