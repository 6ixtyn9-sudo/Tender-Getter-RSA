"""Khoisan LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Khoisan LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Khoisan LM tenders</h1>
        <table>
            <thead>
...
class KhoisanLmSource:
    """Tender source plug-in for Khoisan LM."""

    source_id: str = "khoisan_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.khoisan.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Khoisan LM"
