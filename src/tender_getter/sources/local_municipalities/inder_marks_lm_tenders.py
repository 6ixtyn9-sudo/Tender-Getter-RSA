"""Inder Marks LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Inder Marks LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Inder Marks LM tenders</h1>
        <table>
            <thead>
...
class InderMarksLmSource:
    """Tender source plug-in for Inder Marks LM."""

    source_id: str = "inder_marks_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.indermarks.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Inder Marks LM"
