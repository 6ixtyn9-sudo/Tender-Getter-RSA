"""Port St Johns Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Port St Johns Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Port St Johns Local Municipality tenders</h1>
        <table>
            <thead>
...
class PortStJohnsLmSource:
    """Tender source plug-in for Port St Johns Local Municipality."""

    source_id: str = "port_st_johns_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.psjmunicipality.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Port St Johns Local Municipality"
