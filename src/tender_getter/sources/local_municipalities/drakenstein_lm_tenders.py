"""Drakenstein Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Drakenstein Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Drakenstein Municipality tenders</h1>
        <table>
            <thead>
...
class DrakensteinLmSource:
    """Tender source plug-in for Drakenstein Municipality."""

    source_id: str = "drakenstein_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.drakenstein.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Drakenstein Municipality"
