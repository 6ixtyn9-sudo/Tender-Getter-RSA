"""Mantsopa Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mantsopa Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mantsopa Local Municipality tenders</h1>
        <table>
            <thead>
...
class ManuaweLmSource:
    """Tender source plug-in for Mantsopa Local Municipality."""

    source_id: str = "manuawe_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mantsopa.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Mantsopa Local Municipality"
