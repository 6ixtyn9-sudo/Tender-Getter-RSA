"""Tsolwana LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Tsolwana LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Tsolwana LM tenders</h1>
        <table>
            <thead>
...
class TsolwanaLmSource:
    """Tender source plug-in for Tsolwana LM."""

    source_id: str = "tsolwana_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.tsolwana.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Tsolwana LM"
