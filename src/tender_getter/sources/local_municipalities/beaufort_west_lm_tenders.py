"""Beaufort West Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Beaufort West Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Beaufort West Municipality tenders</h1>
        <table>
            <thead>
...
class BeaufortWestLmSource:
    """Tender source plug-in for Beaufort West Municipality."""

    source_id: str = "beaufort_west_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.beaufortwestmun.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Beaufort West Municipality"
