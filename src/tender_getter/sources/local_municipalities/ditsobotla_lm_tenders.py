"""Ditsobotla LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ditsobotla LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ditsobotla LM tenders</h1>
        <table>
            <thead>
...
class DitsobotlaLmSource:
    """Tender source plug-in for Ditsobotla LM."""

    source_id: str = "ditsobotla_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ditsobotla.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ditsobotla LM"
