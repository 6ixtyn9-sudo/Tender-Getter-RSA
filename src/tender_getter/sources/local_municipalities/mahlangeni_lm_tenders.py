"""Mahlangeni LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mahlangeni LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mahlangeni LM tenders</h1>
        <table>
            <thead>
...
class MahlangeniLmSource:
    """Tender source plug-in for Mahlangeni LM."""

    source_id: str = "mahlangeni_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mahlangeni.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mahlangeni LM"
