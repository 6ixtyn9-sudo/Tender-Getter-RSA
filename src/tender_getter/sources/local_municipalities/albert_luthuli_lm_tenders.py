"""Albert Luthuli LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Albert Luthuli LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Albert Luthuli LM tenders</h1>
        <table>
            <thead>
...
class AlbertLuthuliLmSource:
    """Tender source plug-in for Albert Luthuli LM."""

    source_id: str = "albert_luthuli_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.albertluthuli.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Albert Luthuli LM"
