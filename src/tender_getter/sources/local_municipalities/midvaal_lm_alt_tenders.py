"""Midvaal (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Midvaal (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Midvaal (alt) tenders</h1>
        <table>
            <thead>
...
class MidvaalLmAltSource:
    """Tender source plug-in for Midvaal (alt)."""

    source_id: str = "midvaal_lm_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.midvaal.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Midvaal (alt)"
