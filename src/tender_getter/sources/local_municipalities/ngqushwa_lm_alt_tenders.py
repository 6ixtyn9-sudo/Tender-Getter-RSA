"""Ngqushwa LM (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ngqushwa LM (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ngqushwa LM (alt) tenders</h1>
        <table>
            <thead>
...
class NgqushwaLmAltSource:
    """Tender source plug-in for Ngqushwa LM (alt)."""

    source_id: str = "ngqushwa_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ngqushwa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ngqushwa LM (alt)"
