"""Mbombela Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mbombela Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mbombela Local Municipality tenders</h1>
        <table>
            <thead>
...
class MbombelaLmSource:
    """Tender source plug-in for Mbombela Local Municipality."""

    source_id: str = "mbombela_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mbombela.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Mbombela Local Municipality"
