"""Greater Giyani LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Greater Giyani LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Greater Giyani LM tenders</h1>
        <table>
            <thead>
...
class GreaterGiyaniLmSource:
    """Tender source plug-in for Greater Giyani LM."""

    source_id: str = "greater_giyani_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.giyani.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Greater Giyani LM"
