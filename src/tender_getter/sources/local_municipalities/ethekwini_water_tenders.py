"""eThekwini Water and Sanitation tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>eThekwini Water and Sanitation Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active eThekwini Water and Sanitation tenders</h1>
        <table>
            <thead>
...
class EthekwiniWaterSource:
    """Tender source plug-in for eThekwini Water and Sanitation."""

    source_id: str = "ethekwini_water_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.durban.gov.za/Water/procurement"):
        self.url = url
        self.issuing_entity = "eThekwini Water and Sanitation"
