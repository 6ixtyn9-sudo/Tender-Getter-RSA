"""Siyancuma LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Siyancuma LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Siyancuma LM tenders</h1>
        <table>
            <thead>
...
class SiyancumaLmSource:
    """Tender source plug-in for Siyancuma LM."""

    source_id: str = "siyancuma_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.siyancuma.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Siyancuma LM"
