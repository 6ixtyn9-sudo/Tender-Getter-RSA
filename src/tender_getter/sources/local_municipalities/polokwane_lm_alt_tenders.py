"""Polokwane (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Polokwane (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Polokwane (alt) tenders</h1>
        <table>
            <thead>
...
class PolokwaneLmAltSource:
    """Tender source plug-in for Polokwane (alt)."""

    source_id: str = "polokwane_lm_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.polokwane.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Polokwane (alt)"
