"""Ingwe LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ingwe LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ingwe LM tenders</h1>
        <table>
            <thead>
...
class IngweLmSource:
    """Tender source plug-in for Ingwe LM."""

    source_id: str = "ingwe_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ingwe.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ingwe LM"
