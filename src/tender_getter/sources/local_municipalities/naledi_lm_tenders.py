"""Naledi LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Naledi LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Naledi LM tenders</h1>
        <table>
            <thead>
...
class NalediLmSource:
    """Tender source plug-in for Naledi LM."""

    source_id: str = "naledi_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.naledi.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Naledi LM"
