"""Mmabatho LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mmabatho LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mmabatho LM tenders</h1>
        <table>
            <thead>
...
class MmabathoLmSource:
    """Tender source plug-in for Mmabatho LM."""

    source_id: str = "mmabatho_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mmabatho.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mmabatho LM"
