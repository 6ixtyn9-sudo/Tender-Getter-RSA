"""Mandeni LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mandeni LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mandeni LM tenders</h1>
        <table>
            <thead>
...
class MandeniLmSource:
    """Tender source plug-in for Mandeni LM."""

    source_id: str = "mandeni_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mandeni.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mandeni LM"
