"""Victor Khanye (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Victor Khanye (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Victor Khanye (alt) tenders</h1>
        <table>
            <thead>
...
class VictorKhanyeLmAltSource:
    """Tender source plug-in for Victor Khanye (alt)."""

    source_id: str = "victor_khanye_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.victorkhanye.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Victor Khanye (alt)"
