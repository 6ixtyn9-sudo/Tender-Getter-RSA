"""Ephraim Mogale Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ephraim Mogale Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ephraim Mogale Local Municipality tenders</h1>
        <table>
            <thead>
...
class EphraimMogaleLmSource:
    """Tender source plug-in for Ephraim Mogale Local Municipality."""

    source_id: str = "ephraim_mogale_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.emlm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ephraim Mogale Local Municipality"
