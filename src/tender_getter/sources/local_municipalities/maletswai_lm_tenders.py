"""Maletswai LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Maletswai LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Maletswai LM tenders</h1>
        <table>
            <thead>
...
class MaletswaiLmSource:
    """Tender source plug-in for Maletswai LM."""

    source_id: str = "maletswai_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.maletswai.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Maletswai LM"
