"""Molemole LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Molemole LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Molemole LM tenders</h1>
        <table>
            <thead>
...
class MolemoleLmSource:
    """Tender source plug-in for Molemole LM."""

    source_id: str = "molemole_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.molemole.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Molemole LM"
