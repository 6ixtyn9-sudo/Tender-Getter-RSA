"""Masilonyana Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Masilonyana Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Masilonyana Local Municipality tenders</h1>
        <table>
            <thead>
...
class MasilonyanaLmSource:
    """Tender source plug-in for Masilonyana Local Municipality."""

    source_id: str = "masilonyana_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.masilonyana.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Masilonyana Local Municipality"
