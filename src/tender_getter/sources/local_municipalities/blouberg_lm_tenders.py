"""Blouberg LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Blouberg LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Blouberg LM tenders</h1>
        <table>
            <thead>
...
class BloubergLmSource:
    """Tender source plug-in for Blouberg LM."""

    source_id: str = "blouberg_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.blouberg.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Blouberg LM"
