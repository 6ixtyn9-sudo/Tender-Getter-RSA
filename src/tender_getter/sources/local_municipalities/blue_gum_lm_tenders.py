"""Blue Gum LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Blue Gum LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Blue Gum LM tenders</h1>
        <table>
            <thead>
...
class BlueGumLmSource:
    """Tender source plug-in for Blue Gum LM."""

    source_id: str = "blue_gum_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.bluegum.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Blue Gum LM"
