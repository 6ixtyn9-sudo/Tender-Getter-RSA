"""Moretele LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Moretele LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Moretele LM tenders</h1>
        <table>
            <thead>
...
class MoreteleLmSource:
    """Tender source plug-in for Moretele LM."""

    source_id: str = "moretele_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.moretele.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Moretele LM"
