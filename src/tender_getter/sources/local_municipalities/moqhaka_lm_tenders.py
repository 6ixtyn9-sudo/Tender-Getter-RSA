"""Moqhaka LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Moqhaka LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Moqhaka LM tenders</h1>
        <table>
            <thead>
...
class MoqhakaLmSource:
    """Tender source plug-in for Moqhaka LM."""

    source_id: str = "moqhaka_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.moqhaka.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Moqhaka LM"
