"""Maclear LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Maclear LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Maclear LM tenders</h1>
        <table>
            <thead>
...
class MaclearLmSource:
    """Tender source plug-in for Maclear LM."""

    source_id: str = "maclear_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.maclear.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Maclear LM"
