"""Mkhambathini LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mkhambathini LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mkhambathini LM tenders</h1>
        <table>
            <thead>
...
class MkhambathiniLmSource:
    """Tender source plug-in for Mkhambathini LM."""

    source_id: str = "mkhambathini_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mkhambathini.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mkhambathini LM"
