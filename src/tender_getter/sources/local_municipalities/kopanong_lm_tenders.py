"""Kopanong LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Kopanong LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Kopanong LM tenders</h1>
        <table>
            <thead>
...
class KopanongLmSource:
    """Tender source plug-in for Kopanong LM."""

    source_id: str = "kopanong_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kopanong.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Kopanong LM"
