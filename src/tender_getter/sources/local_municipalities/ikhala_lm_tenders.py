"""Ikhala LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ikhala LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ikhala LM tenders</h1>
        <table>
            <thead>
...
class IkhalaLmSource:
    """Tender source plug-in for Ikhala LM."""

    source_id: str = "ikhala_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ikhala.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ikhala LM"
