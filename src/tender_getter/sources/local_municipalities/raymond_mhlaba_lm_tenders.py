"""Raymond Mhlaba LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Raymond Mhlaba LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Raymond Mhlaba LM tenders</h1>
        <table>
            <thead>
...
class RaymondMhlabaLmSource:
    """Tender source plug-in for Raymond Mhlaba LM."""

    source_id: str = "raymond_mhlaba_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.raymondmhlaba.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Raymond Mhlaba LM"
