"""Tokologo Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Tokologo Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Tokologo Local Municipality tenders</h1>
        <table>
            <thead>
...
class TokologoLmSource:
    """Tender source plug-in for Tokologo Local Municipality."""

    source_id: str = "tokologo_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tokologo.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Tokologo Local Municipality"
