"""Aberdeen Plain LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Aberdeen Plain LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Aberdeen Plain LM tenders</h1>
        <table>
            <thead>
...
class AberdeenPlainLmSource:
    """Tender source plug-in for Aberdeen Plain LM."""

    source_id: str = "aberdeen_plain_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.aplm.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Aberdeen Plain LM"
