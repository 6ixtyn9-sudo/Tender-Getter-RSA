"""Port St Johns (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Port St Johns (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Port St Johns (alt) tenders</h1>
        <table>
            <thead>
...
class PortStJohnsLmAltSource:
    """Tender source plug-in for Port St Johns (alt)."""

    source_id: str = "port_st_johns_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.psjmun.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Port St Johns (alt)"
