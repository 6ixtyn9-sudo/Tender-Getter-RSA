"""Tswaing Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Tswaing Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Tswaing Local Municipality tenders</h1>
        <table>
            <thead>
...
class TswaingLmSource:
    """Tender source plug-in for Tswaing Local Municipality."""

    source_id: str = "tswaing_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tswaing.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Tswaing Local Municipality"
