"""Nkonkobe LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nkonkobe LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nkonkobe LM tenders</h1>
        <table>
            <thead>
...
class NkonkobeLmSource:
    """Tender source plug-in for Nkonkobe LM."""

    source_id: str = "nkonkobe_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nkonkobe.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Nkonkobe LM"
