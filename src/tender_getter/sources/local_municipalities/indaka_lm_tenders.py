"""Indaka LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Indaka LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Indaka LM tenders</h1>
        <table>
            <thead>
...
class IndakaLmSource:
    """Tender source plug-in for Indaka LM."""

    source_id: str = "indaka_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.indaka.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Indaka LM"
