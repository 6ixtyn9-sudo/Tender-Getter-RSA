"""Modimolle Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Modimolle Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Modimolle Local Municipality tenders</h1>
        <table>
            <thead>
...
class ModimolleLmSource:
    """Tender source plug-in for Modimolle Local Municipality."""

    source_id: str = "modimolle_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.modimolle.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Modimolle Local Municipality"
