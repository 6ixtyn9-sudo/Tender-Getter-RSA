"""Elundini LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Elundini LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Elundini LM tenders</h1>
        <table>
            <thead>
...
class ElundiniLmSource:
    """Tender source plug-in for Elundini LM."""

    source_id: str = "elundini_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.elundini.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Elundini LM"
