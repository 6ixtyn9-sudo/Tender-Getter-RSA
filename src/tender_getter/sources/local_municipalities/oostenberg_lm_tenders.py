"""Oostenberg Municipality (legacy) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Oostenberg Municipality (legacy) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Oostenberg Municipality (legacy) tenders</h1>
        <table>
            <thead>
...
class OostenbergLmSource:
    """Tender source plug-in for Oostenberg Municipality (legacy)."""

    source_id: str = "oostenberg_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.oostenberg.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Oostenberg Municipality (legacy)"
