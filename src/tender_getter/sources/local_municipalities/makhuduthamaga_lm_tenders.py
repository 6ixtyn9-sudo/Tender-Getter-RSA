"""Makhuduthamaga LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Makhuduthamaga LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Makhuduthamaga LM tenders</h1>
        <table>
            <thead>
...
class MakhuduthamagaLmSource:
    """Tender source plug-in for Makhuduthamaga LM."""

    source_id: str = "makhuduthamaga_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.makhuduthamaga.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Makhuduthamaga LM"
