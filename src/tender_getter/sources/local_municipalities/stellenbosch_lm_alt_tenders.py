"""Stellenbosch (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Stellenbosch (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Stellenbosch (alt) tenders</h1>
        <table>
            <thead>
...
class StellenboschLmAltSource:
    """Tender source plug-in for Stellenbosch (alt)."""

    source_id: str = "stellenbosch_lm_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.stellenbosch.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Stellenbosch (alt)"
