"""Overstrand (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Overstrand (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Overstrand (alt) tenders</h1>
        <table>
            <thead>
...
class OverstrandLmAltSource:
    """Tender source plug-in for Overstrand (alt)."""

    source_id: str = "overstrand_lm_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.overstrand.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Overstrand (alt)"
