"""Alfred Duma LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Alfred Duma LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Alfred Duma LM tenders</h1>
        <table>
            <thead>
...
class AlfredDumaLmSource:
    """Tender source plug-in for Alfred Duma LM."""

    source_id: str = "alfred_duma_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.alfredduma.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Alfred Duma LM"
