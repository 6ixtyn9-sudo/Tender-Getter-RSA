"""Langeberg LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Langeberg LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Langeberg LM tenders</h1>
        <table>
            <thead>
...
class LangebergLmSource:
    """Tender source plug-in for Langeberg LM."""

    source_id: str = "langeberg_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.langeberg.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Langeberg LM"
