"""Mossel Bay Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mossel Bay Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mossel Bay Municipality tenders</h1>
        <table>
            <thead>
...
class MosselBayLmSource:
    """Tender source plug-in for Mossel Bay Municipality."""

    source_id: str = "mossel_bay_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mosselbay.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Mossel Bay Municipality"
