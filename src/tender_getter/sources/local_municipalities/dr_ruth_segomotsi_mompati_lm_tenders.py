"""Ruth Mompati LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ruth Mompati LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ruth Mompati LM tenders</h1>
        <table>
            <thead>
...
class DrRuthSegomotsiMompatiLmSource:
    """Tender source plug-in for Ruth Mompati LM."""

    source_id: str = "dr_ruth_segomotsi_mompati_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.rsmdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ruth Mompati LM"
