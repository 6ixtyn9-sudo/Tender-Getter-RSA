"""Okhahlamba Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Okhahlamba Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Okhahlamba Local Municipality tenders</h1>
        <table>
            <thead>
...
class OkhahlambaLmSource:
    """Tender source plug-in for Okhahlamba Local Municipality."""

    source_id: str = "okhahlamba_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.okhahlamba.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Okhahlamba Local Municipality"
