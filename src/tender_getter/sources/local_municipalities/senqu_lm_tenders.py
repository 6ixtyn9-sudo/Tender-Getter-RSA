"""Senqu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Senqu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Senqu LM tenders</h1>
        <table>
            <thead>
...
class SenquLmSource:
    """Tender source plug-in for Senqu LM."""

    source_id: str = "senqu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.senqu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Senqu LM"
