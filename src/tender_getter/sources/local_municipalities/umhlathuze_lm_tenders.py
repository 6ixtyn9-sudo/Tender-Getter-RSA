"""uMhlathuze Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMhlathuze Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMhlathuze Local Municipality tenders</h1>
        <table>
            <thead>
...
class UmhlathuzeLmSource:
    """Tender source plug-in for uMhlathuze Local Municipality."""

    source_id: str = "umhlathuze_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.umhlathuze.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "uMhlathuze Local Municipality"
