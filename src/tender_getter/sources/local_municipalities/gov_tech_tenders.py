"""GovTech SA tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>GovTech SA Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active GovTech SA tenders</h1>
        <table>
            <thead>
...
class GovTechSource:
    """Tender source plug-in for GovTech SA."""

    source_id: str = "gov_tech_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.govtech.co.za/procurement"):
        self.url = url
        self.issuing_entity = "GovTech SA"
