"""Diamond LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Diamond LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Diamond LM tenders</h1>
        <table>
            <thead>
...
class DiamondLmSource:
    """Tender source plug-in for Diamond LM."""

    source_id: str = "diamond_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.diamondlm.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Diamond LM"
