"""Matjhabeng Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Matjhabeng Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Matjhabeng Local Municipality tenders</h1>
        <table>
            <thead>
...
class MatjhabengLmSource:
    """Tender source plug-in for Matjhabeng Local Municipality."""

    source_id: str = "matjhabeng_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.matjhabeng.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Matjhabeng Local Municipality"
