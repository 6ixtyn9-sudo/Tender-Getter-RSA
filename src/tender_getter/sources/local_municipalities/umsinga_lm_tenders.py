"""uMsinga LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMsinga LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMsinga LM tenders</h1>
        <table>
            <thead>
...
class UmsingaLmSource:
    """Tender source plug-in for uMsinga LM."""

    source_id: str = "umsinga_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umsinga.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMsinga LM"
