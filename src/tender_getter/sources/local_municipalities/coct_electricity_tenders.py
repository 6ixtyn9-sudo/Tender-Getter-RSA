"""City of Cape Town Electricity Services tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>City of Cape Town Electricity Services Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active City of Cape Town Electricity Services tenders</h1>
        <table>
            <thead>
...
class CoctElectricitySource:
    """Tender source plug-in for City of Cape Town Electricity Services."""

    source_id: str = "coct_electricity_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.capetown.gov.za/Electricity/procurement"):
        self.url = url
        self.issuing_entity = "City of Cape Town Electricity Services"
