"""uMzimvubu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMzimvubu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMzimvubu LM tenders</h1>
        <table>
            <thead>
...
class UmzimvubuLmSource:
    """Tender source plug-in for uMzimvubu LM."""

    source_id: str = "umzimvubu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umzimvubu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMzimvubu LM"
