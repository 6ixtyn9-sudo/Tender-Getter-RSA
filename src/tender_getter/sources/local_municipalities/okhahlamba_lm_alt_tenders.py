"""Okhahlamba (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Okhahlamba (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Okhahlamba (alt) tenders</h1>
        <table>
            <thead>
...
class OkhahlambaLmAltSource:
    """Tender source plug-in for Okhahlamba (alt)."""

    source_id: str = "okhahlamba_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.okhahlamba.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Okhahlamba (alt)"
