"""Thulamela Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Thulamela Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Thulamela Local Municipality tenders</h1>
        <table>
            <thead>
...
class ThulamelaLmSource:
    """Tender source plug-in for Thulamela Local Municipality."""

    source_id: str = "thulamela_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.thulamela.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Thulamela Local Municipality"
