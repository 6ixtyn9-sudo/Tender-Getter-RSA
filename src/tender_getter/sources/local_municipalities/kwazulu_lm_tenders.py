"""Kwazulu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Kwazulu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Kwazulu LM tenders</h1>
        <table>
            <thead>
...
class KwazuluLmSource:
    """Tender source plug-in for Kwazulu LM."""

    source_id: str = "kwazulu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kwazulu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Kwazulu LM"
