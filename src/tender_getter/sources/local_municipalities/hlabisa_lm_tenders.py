"""Hlabisa LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Hlabisa LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Hlabisa LM tenders</h1>
        <table>
            <thead>
...
class HlabisaLmSource:
    """Tender source plug-in for Hlabisa LM."""

    source_id: str = "hlabisa_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.hlabisa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Hlabisa LM"
