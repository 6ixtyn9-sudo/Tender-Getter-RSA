"""Makhado Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Makhado Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Makhado Local Municipality tenders</h1>
        <table>
            <thead>
...
class MakhadoLmSource:
    """Tender source plug-in for Makhado Local Municipality."""

    source_id: str = "makhado_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.makhado.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Makhado Local Municipality"
