"""Randfontein LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Randfontein LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Randfontein LM tenders</h1>
        <table>
            <thead>
...
class RandfonteinLmSource:
    """Tender source plug-in for Randfontein LM."""

    source_id: str = "randfontein_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.randfontein.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Randfontein LM"
