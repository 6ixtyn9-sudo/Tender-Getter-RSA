"""Setsoto LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Setsoto LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Setsoto LM tenders</h1>
        <table>
            <thead>
...
class SetsotoLmSource:
    """Tender source plug-in for Setsoto LM."""

    source_id: str = "setsoto_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.setsoto.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Setsoto LM"
