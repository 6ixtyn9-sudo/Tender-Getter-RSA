...
<body>
    <div class="tenders-wrapper">
        <h1>Active Newcastle Local Municipality tenders</h1>
        <table>
            <thead>
...
class NewcastleLmSource:
    ...
    source_id: str = "newcastle_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.newcastle.gov.za/tenders"):
        self.url = url
