"""Govan Mbeki (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Govan Mbeki (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Govan Mbeki (alt) tenders</h1>
        <table>
            <thead>
...
class GovanMbekiAltSource:
    """Tender source plug-in for Govan Mbeki (alt)."""

    source_id: str = "govan_mbeki_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.govanmbeki.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Govan Mbeki (alt)"
