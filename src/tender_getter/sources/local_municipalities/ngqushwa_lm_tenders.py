"""Ngqushwa Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ngqushwa Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ngqushwa Local Municipality tenders</h1>
        <table>
            <thead>
...
class NgqushwaLmSource:
    """Tender source plug-in for Ngqushwa Local Municipality."""

    source_id: str = "ngqushwa_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ngqushwa.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ngqushwa Local Municipality"
