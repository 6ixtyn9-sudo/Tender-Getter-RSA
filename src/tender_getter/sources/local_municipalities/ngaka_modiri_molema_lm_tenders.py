"""Ngaka Modiri Molema DM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ngaka Modiri Molema DM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ngaka Modiri Molema DM tenders</h1>
        <table>
            <thead>
...
class NgakaModiriMolemaLmSource:
    """Tender source plug-in for Ngaka Modiri Molema DM."""

    source_id: str = "ngaka_modiri_molema_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nmmdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ngaka Modiri Molema DM"
