"""Matlosana Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Matlosana Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Matlosana Local Municipality tenders</h1>
        <table>
            <thead>
...
class MatlosanaLmSource:
    """Tender source plug-in for Matlosana Local Municipality."""

    source_id: str = "matlosana_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.matlosana.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Matlosana Local Municipality"
