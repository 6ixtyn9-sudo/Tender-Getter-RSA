"""Ulundi LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ulundi LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ulundi LM tenders</h1>
        <table>
            <thead>
...
class UlundiLmSource:
    """Tender source plug-in for Ulundi LM."""

    source_id: str = "ulundi_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ulundi.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ulundi LM"
