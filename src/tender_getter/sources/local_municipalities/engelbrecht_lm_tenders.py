"""Engelbrecht LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Engelbrecht LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Engelbrecht LM tenders</h1>
        <table>
            <thead>
...
class EngelbrechtLmSource:
    """Tender source plug-in for Engelbrecht LM."""

    source_id: str = "engelbrecht_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.engelbrecht.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Engelbrecht LM"
