"""Nquthu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nquthu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nquthu LM tenders</h1>
        <table>
            <thead>
...
class NquthuLmSource:
    """Tender source plug-in for Nquthu LM."""

    source_id: str = "nquthu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nquthu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Nquthu LM"
