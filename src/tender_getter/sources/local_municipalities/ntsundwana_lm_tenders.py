"""Ntsundwana LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ntsundwana LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ntsundwana LM tenders</h1>
        <table>
            <thead>
...
class NtsundwanaLmSource:
    """Tender source plug-in for Ntsundwana LM."""

    source_id: str = "ntsundwana_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ntsundwana.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ntsundwana LM"
