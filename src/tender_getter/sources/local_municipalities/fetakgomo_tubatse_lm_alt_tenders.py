"""Fetakgomo Tubatse (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Fetakgomo Tubatse (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Fetakgomo Tubatse (alt) tenders</h1>
        <table>
            <thead>
...
class FetakgomoTubatseLmAltSource:
    """Tender source plug-in for Fetakgomo Tubatse (alt)."""

    source_id: str = "fetakgomo_tubatse_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ftlm.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Fetakgomo Tubatse (alt)"
