"""Saldanha Bay Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Saldanha Bay Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Saldanha Bay Municipality tenders</h1>
        <table>
            <thead>
...
class SaldanhaBayLmSource:
    """Tender source plug-in for Saldanha Bay Municipality."""

    source_id: str = "saldanha_bay_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.saldanhabay.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Saldanha Bay Municipality"
