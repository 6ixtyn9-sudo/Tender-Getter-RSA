"""Mnquma LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mnquma LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mnquma LM tenders</h1>
        <table>
            <thead>
...
class MnqumaLmSource:
    """Tender source plug-in for Mnquma LM."""

    source_id: str = "mnquma_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mnquma.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mnquma LM"
