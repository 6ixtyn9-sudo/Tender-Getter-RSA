"""Knysna Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Knysna Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Knysna Municipality tenders</h1>
        <table>
            <thead>
...
class KnysnaLmSource:
    """Tender source plug-in for Knysna Municipality."""

    source_id: str = "knysna_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.knysna.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Knysna Municipality"
