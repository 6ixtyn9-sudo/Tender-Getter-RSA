"""uPhongolo LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uPhongolo LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uPhongolo LM tenders</h1>
        <table>
            <thead>
...
class UphongoloLmSource:
    """Tender source plug-in for uPhongolo LM."""

    source_id: str = "uphongolo_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.uphongolo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uPhongolo LM"
