"""Inxuba Yethemba LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Inxuba Yethemba LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Inxuba Yethemba LM tenders</h1>
        <table>
            <thead>
...
class InxubaYethembaLmSource:
    """Tender source plug-in for Inxuba Yethemba LM."""

    source_id: str = "inxuba_yethemba_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.inxubayethemba.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Inxuba Yethemba LM"
