"""uMzinyathi LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMzinyathi LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMzinyathi LM tenders</h1>
        <table>
            <thead>
...
class UmzinyathiLmSource:
    """Tender source plug-in for uMzinyathi LM."""

    source_id: str = "umzinyathi_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umzinyathi.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMzinyathi LM"
