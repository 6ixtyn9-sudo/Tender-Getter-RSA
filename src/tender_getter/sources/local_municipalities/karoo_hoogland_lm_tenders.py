"""Karoo Hoogland LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Karoo Hoogland LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Karoo Hoogland LM tenders</h1>
        <table>
            <thead>
...
class KarooHooglandLmSource:
    """Tender source plug-in for Karoo Hoogland LM."""

    source_id: str = "karoo_hoogland_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.karoohoogland.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Karoo Hoogland LM"
