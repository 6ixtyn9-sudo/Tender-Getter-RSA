"""Lekwetse LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lekwetse LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lekwetse LM tenders</h1>
        <table>
            <thead>
...
class LekwetseLmSource:
    """Tender source plug-in for Lekwetse LM."""

    source_id: str = "lekwetse_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.lekwetse.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Lekwetse LM"
