"""Ubuntu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ubuntu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ubuntu LM tenders</h1>
        <table>
            <thead>
...
class UbuntuLmSource:
    """Tender source plug-in for Ubuntu LM."""

    source_id: str = "ubuntu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ubuntu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ubuntu LM"
