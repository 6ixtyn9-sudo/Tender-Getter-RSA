"""King Sabata Dalindyebo Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>King Sabata Dalindyebo Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active King Sabata Dalindyebo Local Municipality tenders</h1>
        <table>
            <thead>
...
class KingSabataDalindyeboLmSource:
    """Tender source plug-in for King Sabata Dalindyebo Local Municipality."""

    source_id: str = "king_sabata_dalindyebo_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ksd.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "King Sabata Dalindyebo Local Municipality"
