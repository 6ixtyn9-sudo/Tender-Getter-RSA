"""Ramotshere Moiloa LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ramotshere Moiloa LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ramotshere Moiloa LM tenders</h1>
        <table>
            <thead>
...
class RamotshereMoiloaLmSource:
    """Tender source plug-in for Ramotshere Moiloa LM."""

    source_id: str = "ramotshere_moiloa_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ramotsheremoiloa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ramotshere Moiloa LM"
