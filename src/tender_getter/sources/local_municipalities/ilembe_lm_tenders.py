"""iLembe District Municipality (LM form) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>iLembe District Municipality (LM form) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active iLembe District Municipality (LM form) tenders</h1>
        <table>
            <thead>
...
class IlembeLmSource:
    """Tender source plug-in for iLembe District Municipality (LM form)."""

    source_id: str = "ilembe_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ilembe.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "iLembe District Municipality (LM form)"
