"""Stevetsberg LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Stevetsberg LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Stevetsberg LM tenders</h1>
        <table>
            <thead>
...
class StevetsbergLmSource:
    """Tender source plug-in for Stevetsberg LM."""

    source_id: str = "stevetsberg_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.stevetsberg.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Stevetsberg LM"
