"""Midvaal Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Midvaal Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Midvaal Local Municipality tenders</h1>
        <table>
            <thead>
...
class MidvaalLmSource:
    """Tender source plug-in for Midvaal Local Municipality."""

    source_id: str = "midvaal_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.midvaal.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Midvaal Local Municipality"
