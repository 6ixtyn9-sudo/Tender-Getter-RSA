"""uMuziwabantu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMuziwabantu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMuziwabantu LM tenders</h1>
        <table>
            <thead>
...
class UmuziwabantuLmSource:
    """Tender source plug-in for uMuziwabantu LM."""

    source_id: str = "umuziwabantu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umuziwabantu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMuziwabantu LM"
