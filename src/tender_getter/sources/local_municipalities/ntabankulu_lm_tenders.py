"""Ntabankulu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ntabankulu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ntabankulu LM tenders</h1>
        <table>
            <thead>
...
class NtabankuluLmSource:
    """Tender source plug-in for Ntabankulu LM."""

    source_id: str = "ntabankulu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ntabankulu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ntabankulu LM"
