"""Breede Valley Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Breede Valley Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Breede Valley Municipality tenders</h1>
        <table>
            <thead>
...
class BreedeValleyLmSource:
    """Tender source plug-in for Breede Valley Municipality."""

    source_id: str = "breede_valley_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.bvm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Breede Valley Municipality"
