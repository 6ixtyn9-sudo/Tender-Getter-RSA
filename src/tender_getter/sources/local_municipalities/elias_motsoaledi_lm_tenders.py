"""Elias Motsoaledi Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Elias Motsoaledi Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Elias Motsoaledi Local Municipality tenders</h1>
        <table>
            <thead>
...
class EliasMotsoalediLmSource:
    """Tender source plug-in for Elias Motsoaledi Local Municipality."""

    source_id: str = "elias_motsoaledi_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.eliasmotsoaledi.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Elias Motsoaledi Local Municipality"
