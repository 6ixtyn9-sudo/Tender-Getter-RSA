"""Lesedi Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lesedi Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lesedi Local Municipality tenders</h1>
        <table>
            <thead>
...
class LesediLmSource:
    """Tender source plug-in for Lesedi Local Municipality."""

    source_id: str = "lesedi_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.lesedi.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Lesedi Local Municipality"
