"""Cedarville LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Cedarville LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Cedarville LM tenders</h1>
        <table>
            <thead>
...
class CedarvilleLmSource:
    """Tender source plug-in for Cedarville LM."""

    source_id: str = "cedarville_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.cedarville.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Cedarville LM"
