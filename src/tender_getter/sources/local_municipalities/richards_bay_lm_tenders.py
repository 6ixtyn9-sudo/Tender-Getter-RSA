"""Richards Bay (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Richards Bay (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Richards Bay (alt) tenders</h1>
        <table>
            <thead>
...
class RichardsBayLmSource:
    """Tender source plug-in for Richards Bay (alt)."""

    source_id: str = "richards_bay_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.richardsbay.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Richards Bay (alt)"
