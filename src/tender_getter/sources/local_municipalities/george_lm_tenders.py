"""George Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>George Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active George Municipality tenders</h1>
        <table>
            <thead>
...
class GeorgeLmSource:
    """Tender source plug-in for George Municipality."""

    source_id: str = "george_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.george.gov.za/tenders"):
        self.url = url
