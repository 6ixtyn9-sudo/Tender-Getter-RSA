"""uMhlabuyalingana LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMhlabuyalingana LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMhlabuyalingana LM tenders</h1>
        <table>
            <thead>
...
class UmhlabuyalinganaLmSource:
    """Tender source plug-in for uMhlabuyalingana LM."""

    source_id: str = "umhlabuyalingana_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umhlabuyalingana.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMhlabuyalingana LM"
