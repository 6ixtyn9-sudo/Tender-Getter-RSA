"""Kagisano-Molopo LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Kagisano-Molopo LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Kagisano-Molopo LM tenders</h1>
        <table>
            <thead>
...
class KagisanoMolopoLmSource:
    """Tender source plug-in for Kagisano-Molopo LM."""

    source_id: str = "kagisano_molopo_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kagisanomolopo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Kagisano-Molopo LM"
