"""City Power Johannesburg tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>City Power Johannesburg Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active City Power Johannesburg tenders</h1>
        <table>
            <thead>
...
class CojCityPowerSource:
    """Tender source plug-in for City Power Johannesburg."""

    source_id: str = "coj_city_power_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.citypower.co.za/procurement"):
        self.url = url
        self.issuing_entity = "City Power Johannesburg"
