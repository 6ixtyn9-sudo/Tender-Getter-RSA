"""ZF Mgcawu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>ZF Mgcawu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active ZF Mgcawu LM tenders</h1>
        <table>
            <thead>
...
class ZFMgcawuLmSource:
    """Tender source plug-in for ZF Mgcawu LM."""

    source_id: str = "z_f_mgcawu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.zfmcawu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "ZF Mgcawu LM"
