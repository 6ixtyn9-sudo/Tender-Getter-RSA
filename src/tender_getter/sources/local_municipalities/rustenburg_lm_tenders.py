"""Rustenburg Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Rustenburg Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Rustenburg Local Municipality tenders</h1>
        <table>
            <thead>
...
class RustenburgLmSource:
    """Tender source plug-in for Rustenburg Local Municipality."""

    source_id: str = "rustenburg_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.rustenburg.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Rustenburg Local Municipality"
