"""Overberg LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Overberg LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Overberg LM tenders</h1>
        <table>
            <thead>
...
class OverbergLmSource:
    """Tender source plug-in for Overberg LM."""

    source_id: str = "overberg_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.overberg.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Overberg LM"
