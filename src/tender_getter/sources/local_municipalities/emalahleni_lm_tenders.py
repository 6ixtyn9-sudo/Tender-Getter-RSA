"""Emalahleni Local Municipality (Mpumalanga) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Emalahleni Local Municipality (Mpumalanga) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Emalahleni Local Municipality (Mpumalanga) tenders</h1>
        <table>
            <thead>
...
class EmalahleniLmSource:
    """Tender source plug-in for Emalahleni Local Municipality (Mpumalanga)."""

    source_id: str = "emalahleni_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.emalahleni.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Emalahleni Local Municipality (Mpumalanga)"
