"""Kamiesberg LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Kamiesberg LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Kamiesberg LM tenders</h1>
        <table>
            <thead>
...
class KamiesbergLmSource:
    """Tender source plug-in for Kamiesberg LM."""

    source_id: str = "kamiesberg_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kamiesberg.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Kamiesberg LM"
