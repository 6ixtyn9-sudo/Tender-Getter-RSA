"""Nyandeni LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nyandeni LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nyandeni LM tenders</h1>
        <table>
            <thead>
...
class NyandeniLmSource:
    """Tender source plug-in for Nyandeni LM."""

    source_id: str = "nyandeni_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nyandeni.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Nyandeni LM"
