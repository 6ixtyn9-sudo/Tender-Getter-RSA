"""Fetakgomo Tubatse Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Fetakgomo Tubatse Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Fetakgomo Tubatse Local Municipality tenders</h1>
        <table>
            <thead>
...
class FetakgomoTubatseLmSource:
    """Tender source plug-in for Fetakgomo Tubatse Local Municipality."""

    source_id: str = "fetakgomo_tubatse_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ftlm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Fetakgomo Tubatse Local Municipality"
