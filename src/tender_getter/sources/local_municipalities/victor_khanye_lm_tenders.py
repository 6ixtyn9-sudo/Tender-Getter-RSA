"""Victor Khanye Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Victor Khanye Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Victor Khanye Local Municipality tenders</h1>
        <table>
            <thead>
...
class VictorKhanyeLmSource:
    """Tender source plug-in for Victor Khanye Local Municipality."""

    source_id: str = "victor_khanye_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.vkle.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Victor Khanye Local Municipality"
