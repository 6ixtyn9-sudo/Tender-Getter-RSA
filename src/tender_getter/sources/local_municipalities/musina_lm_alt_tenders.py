"""Musina (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Musina (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Musina (alt) tenders</h1>
        <table>
            <thead>
...
class MusinaLmAltSource:
    """Tender source plug-in for Musina (alt)."""

    source_id: str = "musina_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.musina.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Musina (alt)"
