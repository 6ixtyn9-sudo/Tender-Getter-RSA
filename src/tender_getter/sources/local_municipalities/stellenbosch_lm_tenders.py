"""Stellenbosch Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Stellenbosch Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Stellenbosch Municipality tenders</h1>
        <table>
            <thead>
...
class StellenboschLmSource:
    """Tender source plug-in for Stellenbosch Municipality."""

    source_id: str = "stellenbosch_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.stellenbosch.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Stellenbosch Municipality"
