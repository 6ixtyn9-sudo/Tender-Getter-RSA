"""Kagisano LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Kagisano LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Kagisano LM tenders</h1>
        <table>
            <thead>
...
class KagisanoLmSource:
    """Tender source plug-in for Kagisano LM."""

    source_id: str = "kagisano_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kagisano.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Kagisano LM"
