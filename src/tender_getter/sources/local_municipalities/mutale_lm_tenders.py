"""Mutale LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mutale LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mutale LM tenders</h1>
        <table>
            <thead>
...
class MutaleLmSource:
    """Tender source plug-in for Mutale LM."""

    source_id: str = "mutale_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mutale.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mutale LM"
