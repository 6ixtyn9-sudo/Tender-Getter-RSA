"""De Hoop LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>De Hoop LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active De Hoop LM tenders</h1>
        <table>
            <thead>
...
class DeHoopLmSource:
    """Tender source plug-in for De Hoop LM."""

    source_id: str = "de_hoop_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.dehoop.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "De Hoop LM"
