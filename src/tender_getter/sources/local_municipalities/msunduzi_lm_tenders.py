"""Msunduzi Local Municipality (Pietermaritzburg) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Msunduzi Local Municipality (Pietermaritzburg) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Msunduzi Local Municipality (Pietermaritzburg) tenders</h1>
        <table>
            <thead>
...
class MsunduziLmSource:
    """Tender source plug-in for Msunduzi Local Municipality (Pietermaritzburg)."""

    source_id: str = "msunduzi_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.msunduzi.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Msunduzi Local Municipality (Pietermaritzburg)"
