"""PE Municipality (legacy) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>PE Municipality (legacy) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active PE Municipality (legacy) tenders</h1>
        <table>
            <thead>
...
class PortElizabethLmSource:
    """Tender source plug-in for PE Municipality (legacy)."""

    source_id: str = "port_elizabeth_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.pemun.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "PE Municipality (legacy)"
