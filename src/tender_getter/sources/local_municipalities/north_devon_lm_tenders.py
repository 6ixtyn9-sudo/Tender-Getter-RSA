"""North Devon LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North Devon LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North Devon LM tenders</h1>
        <table>
            <thead>
...
class NorthDevonLmSource:
    """Tender source plug-in for North Devon LM."""

    source_id: str = "north_devon_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.northdevon.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "North Devon LM"
