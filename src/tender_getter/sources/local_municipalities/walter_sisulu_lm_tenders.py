"""Walter Sisulu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Walter Sisulu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Walter Sisulu LM tenders</h1>
        <table>
            <thead>
...
class WalterSisuluLmSource:
    """Tender source plug-in for Walter Sisulu LM."""

    source_id: str = "walter_sisulu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.waltersisulu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Walter Sisulu LM"
