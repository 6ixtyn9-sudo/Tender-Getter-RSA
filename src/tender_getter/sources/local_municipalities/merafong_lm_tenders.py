...
<!DOCTYPE html>
<html>
<head><title>Merafong City Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Merafong City Local Municipality tenders</h1>
        <table>
            <thead>
...
class MerafongLmSource:
    """Tender source plug-in for Merafong City Local Municipality."""

    source_id: str = "merafong_lm_tenders"
    live: bool = True
