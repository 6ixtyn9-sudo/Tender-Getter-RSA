"""Makhado (alt 2) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Makhado (alt 2) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Makhado (alt 2) tenders</h1>
        <table>
            <thead>
...
class MakhadoLmAlt2Source:
    """Tender source plug-in for Makhado (alt 2)."""

    source_id: str = "makhado_lm_alt_2_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.makhado.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Makhado (alt 2)"
