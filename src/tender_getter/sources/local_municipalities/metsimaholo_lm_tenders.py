"""Metsimaholo LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Metsimaholo LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Metsimaholo LM tenders</h1>
        <table>
            <thead>
...
class MetsimaholoLmSource:
    """Tender source plug-in for Metsimaholo LM."""

    source_id: str = "metsimaholo_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.metsimaholo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Metsimaholo LM"
