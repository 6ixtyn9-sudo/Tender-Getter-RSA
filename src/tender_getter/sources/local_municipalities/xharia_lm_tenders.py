"""Xharia LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Xharia LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Xharia LM tenders</h1>
        <table>
            <thead>
...
class XhariaLmSource:
    """Tender source plug-in for Xharia LM."""

    source_id: str = "xharia_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.xharia.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Xharia LM"
