"""Polokwane Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Polokwane Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Polokwane Local Municipality tenders</h1>
        <table>
            <thead>
...
class PolokwaneLmSource:
    """Tender source plug-in for Polokwane Local Municipality."""

    source_id: str = "polokwane_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.polokwane.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Polokwane Local Municipality"
