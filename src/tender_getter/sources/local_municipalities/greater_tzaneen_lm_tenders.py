"""Greater Tzaneen LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Greater Tzaneen LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Greater Tzaneen LM tenders</h1>
        <table>
            <thead>
...
class GreaterTzaneenLmSource:
    """Tender source plug-in for Greater Tzaneen LM."""

    source_id: str = "greater_tzaneen_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.greatertzaneen.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Greater Tzaneen LM"
