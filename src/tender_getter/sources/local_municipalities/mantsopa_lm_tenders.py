"""Mantsopa LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mantsopa LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mantsopa LM tenders</h1>
        <table>
            <thead>
...
class MantsopaLmSource:
    """Tender source plug-in for Mantsopa LM."""

    source_id: str = "mantsopa_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mantsopa.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Mantsopa LM"
