"""Pixley Ka Seme LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Pixley Ka Seme LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Pixley Ka Seme LM tenders</h1>
        <table>
            <thead>
...
class PixleyKaSemeLmSource:
    """Tender source plug-in for Pixley Ka Seme LM."""

    source_id: str = "pixley_ka_seme_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.pixleykaseme.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Pixley Ka Seme LM"
