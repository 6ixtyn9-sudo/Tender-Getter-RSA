"""Govan Mbeki Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Govan Mbeki Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Govan Mbeki Local Municipality tenders</h1>
        <table>
            <thead>
...
class GovanMbekiLmSource:
    """Tender source plug-in for Govan Mbeki Local Municipality."""

    source_id: str = "govan_mbeki_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.govanmbeki.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Govan Mbeki Local Municipality"
