"""City of Joburg Property Company (JPC) SOC tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>City of Joburg Property Company (JPC) SOC Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active City of Joburg Property Company (JPC) SOC tenders</h1>
        <table>
            <thead>
...
class CojPropertyCompanySource:
    """Tender source plug-in for City of Joburg Property Company (JPC) SOC."""

    source_id: str = "coj_property_company_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.jpc.co.za/tenders"):
        self.url = url
        self.issuing_entity = "City of Joburg Property Company (JPC) SOC"
