...
<!DOCTYPE html>
<html>
<head><title>Swartland Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Swartland Municipality tenders</h1>
        <table>
            <thead>
...
class SwartlandLmSource:
    """Tender source plug-in for Swartland Municipality."""

    source_id: str = "swartland_lm_tenders"
    live: bool = True
