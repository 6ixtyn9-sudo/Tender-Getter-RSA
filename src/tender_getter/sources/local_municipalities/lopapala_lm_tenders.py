"""Lopapala LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lopapala LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lopapala LM tenders</h1>
        <table>
            <thead>
...
class LopapalaLmSource:
    """Tender source plug-in for Lopapala LM."""

    source_id: str = "lopapala_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.lopapala.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Lopapala LM"
