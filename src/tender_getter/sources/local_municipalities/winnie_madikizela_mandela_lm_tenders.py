"""Winnie Madikizela-Mandela LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Winnie Madikizela-Mandela LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Winnie Madikizela-Mandela LM tenders</h1>
        <table>
            <thead>
...
class WinnieMadikizelaMandelaLmSource:
    """Tender source plug-in for Winnie Madikizela-Mandela LM."""

    source_id: str = "winnie_madikizela_mandela_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.wmm.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Winnie Madikizela-Mandela LM"
