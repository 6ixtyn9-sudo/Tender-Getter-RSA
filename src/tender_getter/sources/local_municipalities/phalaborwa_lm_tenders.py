"""Phalaborwa LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Phalaborwa LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Phalaborwa LM tenders</h1>
        <table>
            <thead>
...
class PhalaborwaLmSource:
    """Tender source plug-in for Phalaborwa LM."""

    source_id: str = "phalaborwa_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.phalaborwa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Phalaborwa LM"
