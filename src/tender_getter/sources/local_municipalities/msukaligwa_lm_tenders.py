"""Msukaligwa LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Msukaligwa LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Msukaligwa LM tenders</h1>
        <table>
            <thead>
...
class MsukaligwaLmSource:
    """Tender source plug-in for Msukaligwa LM."""

    source_id: str = "msukaligwa_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.msukaligwa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Msukaligwa LM"
