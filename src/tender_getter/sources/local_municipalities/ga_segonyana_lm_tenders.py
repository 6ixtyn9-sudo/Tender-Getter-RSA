"""Ga-Segonyana Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ga-Segonyana Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ga-Segonyana Local Municipality tenders</h1>
        <table>
            <thead>
...
class GaSegonyanaLmSource:
    """Tender source plug-in for Ga-Segonyana Local Municipality."""

    source_id: str = "ga_segonyana_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.gasegonyana.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ga-Segonyana Local Municipality"
