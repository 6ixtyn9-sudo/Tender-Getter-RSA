"""Greater Lebowakgomo LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Greater Lebowakgomo LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Greater Lebowakgomo LM tenders</h1>
        <table>
            <thead>
...
class GreaterLebowakgomoLmSource:
    """Tender source plug-in for Greater Lebowakgomo LM."""

    source_id: str = "greater_lebowakgomo_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.lebowakgomo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Greater Lebowakgomo LM"
