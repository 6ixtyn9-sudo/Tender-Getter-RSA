"""Jakarta LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Jakarta LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Jakarta LM tenders</h1>
        <table>
            <thead>
...
class JakartaLmSource:
    """Tender source plug-in for Jakarta LM."""

    source_id: str = "jakarta_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.jakarta.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Jakarta LM"
