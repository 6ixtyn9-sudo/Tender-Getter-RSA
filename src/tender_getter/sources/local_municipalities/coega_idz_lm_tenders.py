"""Coega IDZ tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Coega IDZ Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Coega IDZ tenders</h1>
        <table>
            <thead>
...
class CoegaIdzLmSource:
    """Tender source plug-in for Coega IDZ."""

    source_id: str = "coega_idz_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.coega.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Coega IDZ"
