"""Greater Tubatse LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Greater Tubatse LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Greater Tubatse LM tenders</h1>
        <table>
            <thead>
...
class GreaterTubatseLmSource:
    """Tender source plug-in for Greater Tubatse LM."""

    source_id: str = "greater_tubatse_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.greatertubatse.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Greater Tubatse LM"
