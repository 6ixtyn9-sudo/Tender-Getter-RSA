"""Mpofana LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpofana LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpofana LM tenders</h1>
        <table>
            <thead>
...
class MpofanaLmSource:
    """Tender source plug-in for Mpofana LM."""

    source_id: str = "mpofana_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mpofana.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpofana LM"
