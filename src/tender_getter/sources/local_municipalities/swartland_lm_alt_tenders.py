"""Swartland (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Swartland (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Swartland (alt) tenders</h1>
        <table>
            <thead>
...
class SwartlandLmAltSource:
    """Tender source plug-in for Swartland (alt)."""

    source_id: str = "swartland_lm_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.swartland.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Swartland (alt)"
