"""Mbizana LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mbizana LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mbizana LM tenders</h1>
        <table>
            <thead>
...
class MbizanaLmSource:
    """Tender source plug-in for Mbizana LM."""

    source_id: str = "mbizana_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mbizana.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mbizana LM"
