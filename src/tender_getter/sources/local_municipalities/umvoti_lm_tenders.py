"""uMvoti LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMvoti LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMvoti LM tenders</h1>
        <table>
            <thead>
...
class UmvotiLmSource:
    """Tender source plug-in for uMvoti LM."""

    source_id: str = "umvoti_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umvoti.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "uMvoti LM"
