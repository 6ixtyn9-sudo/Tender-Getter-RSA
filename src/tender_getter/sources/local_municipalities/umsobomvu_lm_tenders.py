"""Umsobomvu LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Umsobomvu LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Umsobomvu LM tenders</h1>
        <table>
            <thead>
...
class UmsobomvuLmSource:
    """Tender source plug-in for Umsobomvu LM."""

    source_id: str = "umsobomvu_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.umsobomvu.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Umsobomvu LM"
