"""Manteng LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Manteng LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Manteng LM tenders</h1>
        <table>
            <thead>
...
class MantengLmSource:
    """Tender source plug-in for Manteng LM."""

    source_id: str = "manteng_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.manteng.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Manteng LM"
