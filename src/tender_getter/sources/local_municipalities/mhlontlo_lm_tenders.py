"""Mhlontlo LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mhlontlo LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mhlontlo LM tenders</h1>
        <table>
            <thead>
...
class MhlontloLmSource:
    """Tender source plug-in for Mhlontlo LM."""

    source_id: str = "mhlontlo_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mhlontlo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mhlontlo LM"
