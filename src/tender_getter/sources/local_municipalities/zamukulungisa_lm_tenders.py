"""Zamukulungisa LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Zamukulungisa LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Zamukulungisa LM tenders</h1>
        <table>
            <thead>
...
class ZamukulungisaLmSource:
    """Tender source plug-in for Zamukulungisa LM."""

    source_id: str = "zamukulungisa_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.zamukulungisa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Zamukulungisa LM"
