"""Ba-Phalaborwa LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ba-Phalaborwa LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ba-Phalaborwa LM tenders</h1>
        <table>
            <thead>
...
class BaBaPhalaborwaLmSource:
    """Tender source plug-in for Ba-Phalaborwa LM."""

    source_id: str = "ba_ba_phalaborwa_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.baphalaborwa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ba-Phalaborwa LM"
