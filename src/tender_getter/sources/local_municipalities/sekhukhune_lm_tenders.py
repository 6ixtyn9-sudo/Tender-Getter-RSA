"""Sekhukhune LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sekhukhune LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sekhukhune LM tenders</h1>
        <table>
            <thead>
...
class SekhukhuneLmSource:
    """Tender source plug-in for Sekhukhune LM."""

    source_id: str = "sekhukhune_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sekhukhune.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Sekhukhune LM"
