"""Ephraim Mogale (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ephraim Mogale (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ephraim Mogale (alt) tenders</h1>
        <table>
            <thead>
...
class EphraimMogaleLmAltSource:
    """Tender source plug-in for Ephraim Mogale (alt)."""

    source_id: str = "ephraim_mogale_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.emlm.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ephraim Mogale (alt)"
