"""Maquassi Hills Local Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Maquassi Hills Local Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Maquassi Hills Local Municipality tenders</h1>
        <table>
            <thead>
...
class MaquassiHillsLmSource:
    """Tender source plug-in for Maquassi Hills Local Municipality."""

    source_id: str = "maquassi_hills_lm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.maquassi.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Maquassi Hills Local Municipality"
