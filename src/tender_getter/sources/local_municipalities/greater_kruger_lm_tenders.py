"""Greater Kruger LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Greater Kruger LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Greater Kruger LM tenders</h1>
        <table>
            <thead>
...
class GreaterKrugerLmSource:
    """Tender source plug-in for Greater Kruger LM."""

    source_id: str = "greater_kruger_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.greaterkruger.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Greater Kruger LM"
