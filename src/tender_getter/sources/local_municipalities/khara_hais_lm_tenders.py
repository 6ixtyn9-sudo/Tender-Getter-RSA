"""Khai-Ma LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Khai-Ma LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Khai-Ma LM tenders</h1>
        <table>
            <thead>
...
class KharaHaisLmSource:
    """Tender source plug-in for Khai-Ma LM."""

    source_id: str = "khara_hais_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.khara-hais.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Khai-Ma LM"
