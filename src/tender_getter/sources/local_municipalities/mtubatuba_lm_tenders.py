"""Mtubatuba LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mtubatuba LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mtubatuba LM tenders</h1>
        <table>
            <thead>
...
class MtubatubaLmSource:
    """Tender source plug-in for Mtubatuba LM."""

    source_id: str = "mtubatuba_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mtubatuba.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mtubatuba LM"
