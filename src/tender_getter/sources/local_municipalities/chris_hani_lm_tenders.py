"""Chris Hani LM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Chris Hani LM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Chris Hani LM tenders</h1>
        <table>
            <thead>
...
class ChrisHaniLmSource:
    """Tender source plug-in for Chris Hani LM."""

    source_id: str = "chris_hani_lm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.chrishanilm.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Chris Hani LM"
