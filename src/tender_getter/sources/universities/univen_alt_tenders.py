"""Univen (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Univen (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Univen (alt) tenders</h1>
        <table>
            <thead>
...
class UnivenAltSource:
    """Tender source plug-in for Univen (alt)."""

    source_id: str = "univen_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.univen.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "Univen (alt)"
