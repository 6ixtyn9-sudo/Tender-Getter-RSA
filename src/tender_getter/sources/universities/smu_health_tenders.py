"""Sefako Makgatho Health Sciences University (alternate) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sefako Makgatho Health Sciences University (alternate) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sefako Makgatho Health Sciences University (alternate) tenders</h1>
        <table>
            <thead>
...
class SmuHealthSource:
    """Tender source plug-in for Sefako Makgatho Health Sciences University (alternate)."""

    source_id: str = "smu_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.smu.ac.za/procurement/tenders"):
        self.url = url
        self.issuing_entity = "Sefako Makgatho Health Sciences University (alternate)"
