"""Nelson Mandela University (legacy) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nelson Mandela University (legacy) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nelson Mandela University (legacy) tenders</h1>
        <table>
            <thead>
...
class MandelaUniSource:
    """Tender source plug-in for Nelson Mandela University (legacy)."""

    source_id: str = "mandela_uni_tenders"
    live: bool = True

    def __init__(self, url: str = "https://legacy.nelsonmandela.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "Nelson Mandela University (legacy)"
