...
<!DOCTYPE html>
<html>
<head><title>SMU (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SMU (alt) tenders</h1>
        <table>
            <thead>
...
class SmuAltSource:
    """Tender source plug-in for SMU (alt)."""

    source_id: str = "smu_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.smu.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "SMU (alt)"
