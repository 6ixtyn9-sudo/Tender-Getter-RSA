"""University of the Western Cape tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of the Western Cape Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of the Western Cape tenders</h1>
        <table>
            <thead>
...
class UwcSource:
    """Tender source plug-in for University of the Western Cape."""

    source_id: str = "uwc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.uwc.ac.za/supply-chain-management/tenders"):
        self.url = url
        self.issuing_entity = "University of the Western Cape"
