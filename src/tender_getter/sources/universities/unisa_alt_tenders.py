"""UNISA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>UNISA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UNISA (alt) tenders</h1>
        <table>
            <thead>
...
class UnisaAltSource:
    """Tender source plug-in for UNISA (alt)."""

    source_id: str = "unisa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.unisa.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UNISA (alt)"
