...
<!DOCTYPE html>
<html>
<head><title>UFH (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UFH (alt) tenders</h1>
        <table>
            <thead>
...
class UfhAltSource:
    """Tender source plug-in for UFH (alt)."""

    source_id: str = "ufh_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ufh.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UFH (alt)"
