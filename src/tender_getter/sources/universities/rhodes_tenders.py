"""Rhodes University tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Rhodes University Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Rhodes University tenders</h1>
        <table>
            <thead>
...
class RhodesSource:
    """Tender source plug-in for Rhodes University."""

    source_id: str = "rhodes_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ru.ac.za/procurement/tenders/"):
        self.url = url
        self.issuing_entity = "Rhodes University"
