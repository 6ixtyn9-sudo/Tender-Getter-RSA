"""Stellenbosch University tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Stellenbosch University Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Stellenbosch University tenders</h1>
        <table>
            <thead>
...
class StellenboschSource:
    """Tender source plug-in for Stellenbosch University."""

    source_id: str = "stellenbosch_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sun.ac.za/finance/procurement"):
        self.url = url
        self.issuing_entity = "Stellenbosch University"
