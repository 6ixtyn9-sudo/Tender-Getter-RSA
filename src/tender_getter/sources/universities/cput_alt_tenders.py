"""CPUT (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>CPUT (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CPUT (alt) tenders</h1>
        <table>
            <thead>
...
class CputAltSource:
    """Tender source plug-in for CPUT (alt)."""

    source_id: str = "cput_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cput.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "CPUT (alt)"
