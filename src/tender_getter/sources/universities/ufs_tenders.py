"""University of the Free State tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of the Free State Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of the Free State tenders</h1>
        <table>
            <thead>
...
class UfsSource:
    """Tender source plug-in for University of the Free State."""

    source_id: str = "ufs_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ufs.ac.za/procurement/tenders"):
        self.url = url
        self.issuing_entity = "University of the Free State"
