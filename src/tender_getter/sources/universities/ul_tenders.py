"""University of Limpopo tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of Limpopo Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of Limpopo tenders</h1>
        <table>
            <thead>
...
class UlSource:
    """Tender source plug-in for University of Limpopo."""

    source_id: str = "ul_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ul.ac.za/procurement/"):
        self.url = url
        self.issuing_entity = "University of Limpopo"
