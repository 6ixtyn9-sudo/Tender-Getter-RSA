...
<!DOCTYPE html>
<html>
<head><title>UCT (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UCT (alt) tenders</h1>
        <table>
            <thead>
...
class UctAltSource:
    """Tender source plug-in for UCT (alt)."""

    source_id: str = "uct_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.uct.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UCT (alt)"
