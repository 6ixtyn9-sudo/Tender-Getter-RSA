...
<!DOCTYPE html>
<html>
<head><title>University of KwaZulu-Natal Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of KwaZulu-Natal tenders</h1>
        <table>
            <thead>
...
class UkznSource:
    """Tender source plug-in for University of KwaZulu-Natal."""

    source_id: str = "ukzn_tenders"
    live: bool = True
