...
<!DOCTYPE html>
<html>
<head><title>CUT (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CUT (alt) tenders</h1>
        <table>
            <thead>
...
class CutAltSource:
    """Tender source plug-in for CUT (alt)."""

    source_id: str = "cut_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cut.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "CUT (alt)"
