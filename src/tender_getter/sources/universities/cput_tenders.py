"""Cape Peninsula University of Technology tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Cape Peninsula University of Technology Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Cape Peninsula University of Technology tenders</h1>
        <table>
            <thead>
...
class CputSource:
    """Tender source plug-in for Cape Peninsula University of Technology."""

    source_id: str = "cput_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cput.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "Cape Peninsula University of Technology"
