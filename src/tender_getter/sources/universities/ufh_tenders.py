"""University of Fort Hare tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of Fort Hare Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of Fort Hare tenders</h1>
        <table>
            <thead>
...
class UfhSource:
    """Tender source plug-in for University of Fort Hare."""

    source_id: str = "ufh_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ufh.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "University of Fort Hare"
