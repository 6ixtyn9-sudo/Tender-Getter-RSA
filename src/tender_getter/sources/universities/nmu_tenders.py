"""Nelson Mandela University tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nelson Mandela University Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nelson Mandela University tenders</h1>
        <table>
            <thead>
...
class NmuSource:
    """Tender source plug-in for Nelson Mandela University."""

    source_id: str = "nmu_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mandela.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "Nelson Mandela University"
