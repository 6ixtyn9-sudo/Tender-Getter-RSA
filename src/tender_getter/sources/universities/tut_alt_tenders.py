...
<!DOCTYPE html>
<html>
<head><title>TUT (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active TUT (alt) tenders</h1>
        <table>
            <thead>
...
class TutAltSource:
    """Tender source plug-in for TUT (alt)."""

    source_id: str = "tut_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tut.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "TUT (alt)"
