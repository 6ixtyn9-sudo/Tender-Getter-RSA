...
<!DOCTYPE html>
<html>
<head><title>NMU (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NMU (alt) tenders</h1>
        <table>
            <thead>
...
class NmuAltSource:
    """Tender source plug-in for NMU (alt)."""

    source_id: str = "nmu_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nmmu.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "NMU (alt)"
