"""Sefako Makgatho Health Sciences University tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sefako Makgatho Health Sciences University Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sefako Makgatho Health Sciences University tenders</h1>
        <table>
            <thead>
...
class SmuSource:
    """Tender source plug-in for Sefako Makgatho Health Sciences University."""

    source_id: str = "smu_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.smu.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "Sefako Makgatho Health Sciences University"
