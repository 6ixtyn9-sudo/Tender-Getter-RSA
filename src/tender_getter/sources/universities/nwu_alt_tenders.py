...
<!DOCTYPE html>
<html>
<head><title>NWU (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NWU (alt) tenders</h1>
        <table>
            <thead>
...
class NwuAltSource:
    """Tender source plug-in for NWU (alt)."""

    source_id: str = "nwu_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nwu.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "NWU (alt)"
