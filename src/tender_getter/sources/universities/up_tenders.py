...
<!DOCTYPE html>
<html>
<head><title>University of Pretoria Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of Pretoria tenders</h1>
        <table>
            <thead>
...
class UpSource:
    """Tender source plug-in for University of Pretoria."""

    source_id: str = "up_tenders"
    live: bool = True
