"""University of Cape Town tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of Cape Town Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of Cape Town tenders</h1>
        <table>
            <thead>
...
class UctSource:
    """Tender source plug-in for University of Cape Town."""

    source_id: str = "uct_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.uct.ac.za/procurement/tenders/"):
        self.url = url
        self.issuing_entity = "University of Cape Town"
