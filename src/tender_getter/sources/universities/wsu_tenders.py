"""Walter Sisulu University tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Walter Sisulu University Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Walter Sisulu University tenders</h1>
        <table>
            <thead>
...
class WsuSource:
    """Tender source plug-in for Walter Sisulu University."""

    source_id: str = "wsu_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.wsu.ac.za/wsu-tenders/"):
        self.url = url
        self.issuing_entity = "Walter Sisulu University"
