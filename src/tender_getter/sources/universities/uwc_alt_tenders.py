...
<!DOCTYPE html>
<html>
<head><title>UWC (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UWC (alt) tenders</h1>
        <table>
            <thead>
...
class UwcAltSource:
    """Tender source plug-in for UWC (alt)."""

    source_id: str = "uwc_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.uwc.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UWC (alt)"
