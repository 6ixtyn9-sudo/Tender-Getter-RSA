"""Rhodes (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Rhodes (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Rhodes (alt) tenders</h1>
        <table>
            <thead>
...
class RhodesAltSource:
    """Tender source plug-in for Rhodes (alt)."""

    source_id: str = "rhodes_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ru.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "Rhodes (alt)"
