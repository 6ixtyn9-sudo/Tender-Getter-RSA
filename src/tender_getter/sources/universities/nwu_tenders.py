"""North-West University tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North-West University Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North-West University tenders</h1>
        <table>
            <thead>
...
class NwuSource:
    """Tender source plug-in for North-West University."""

    source_id: str = "nwu_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nwu.ac.za/procurement/tenders"):
        self.url = url
        self.issuing_entity = "North-West University"
