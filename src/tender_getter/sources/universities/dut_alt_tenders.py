...
<!DOCTYPE html>
<html>
<head><title>DUT (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DUT (alt) tenders</h1>
        <table>
            <thead>
...
class DutAltSource:
    """Tender source plug-in for DUT (alt)."""

    source_id: str = "dut_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dut.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "DUT (alt)"
