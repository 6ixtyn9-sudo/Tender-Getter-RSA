"""University of Venda tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of Venda Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of Venda tenders</h1>
        <table>
            <thead>
...
class UnivenSource:
    """Tender source plug-in for University of Venda."""

    source_id: str = "univen_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.univen.ac.za/procurement/"):
        self.url = url
        self.issuing_entity = "University of Venda"
