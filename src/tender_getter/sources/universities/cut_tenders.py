"""Central University of Technology, Free State tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Central University of Technology, Free State Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Central University of Technology, Free State tenders</h1>
        <table>
            <thead>
...
class CutSource:
    """Tender source plug-in for Central University of Technology, Free State."""

    source_id: str = "cut_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cut.ac.za/procurement/tenders"):
        self.url = url
        self.issuing_entity = "Central University of Technology, Free State"
