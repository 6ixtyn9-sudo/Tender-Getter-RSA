...
<!DOCTYPE html>
<html>
<head><title>UFS (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UFS (alt) tenders</h1>
        <table>
            <thead>
...
class UfsAltSource:
    """Tender source plug-in for UFS (alt)."""

    source_id: str = "ufs_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ufs.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UFS (alt)"
