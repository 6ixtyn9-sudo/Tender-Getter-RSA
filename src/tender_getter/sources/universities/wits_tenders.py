"""University of the Witwatersrand tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of the Witwatersrand Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of the Witwatersrand tenders</h1>
        <table>
            <thead>
...
class WitsSource:
    """Tender source plug-in for University of the Witwatersrand."""

    source_id: str = "wits_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.wits.ac.za/purchase/tenders/"):
        self.url = url
        self.issuing_entity = "University of the Witwatersrand"
