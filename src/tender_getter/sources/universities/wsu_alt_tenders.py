...
<!DOCTYPE html>
<html>
<head><title>WSU (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active WSU (alt) tenders</h1>
        <table>
            <thead>
...
class WsuAltSource:
    """Tender source plug-in for WSU (alt)."""

    source_id: str = "wsu_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.wsu.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "WSU (alt)"
