"""UKZN (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>UKZN (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UKZN (alt) tenders</h1>
        <table>
            <thead>
...
class UkznAltSource:
    """Tender source plug-in for UKZN (alt)."""

    source_id: str = "ukzn_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ukzn.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UKZN (alt)"
