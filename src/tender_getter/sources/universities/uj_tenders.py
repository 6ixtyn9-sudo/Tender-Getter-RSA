"""University of Johannesburg tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of Johannesburg Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of Johannesburg tenders</h1>
        <table>
            <thead>
...
class UjSource:
    """Tender source plug-in for University of Johannesburg."""

    source_id: str = "uj_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.uj.ac.za/about/procurement/Pages/Tenders.aspx"):
        self.url = url
        self.issuing_entity = "University of Johannesburg"
