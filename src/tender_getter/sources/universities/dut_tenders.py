"""Durban University of Technology tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Durban University of Technology Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Durban University of Technology tenders</h1>
        <table>
            <thead>
...
class DutSource:
    """Tender source plug-in for Durban University of Technology."""

    source_id: str = "dut_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dut.ac.za/procurement/tenders/"):
        self.url = url
        self.issuing_entity = "Durban University of Technology"
