"""Sol Plaatje University tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sol Plaatje University Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sol Plaatje University tenders</h1>
        <table>
            <thead>
...
class SolplaatjeSource:
    """Tender source plug-in for Sol Plaatje University."""

    source_id: str = "solplaatje_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.spu.ac.za/procurement/"):
        self.url = url
        self.issuing_entity = "Sol Plaatje University"
