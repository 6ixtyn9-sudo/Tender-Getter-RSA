...
<!DOCTYPE html>
<html>
<head><title>UP (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UP (alt) tenders</h1>
        <table>
            <thead>
...
class UpAltSource:
    """Tender source plug-in for UP (alt)."""

    source_id: str = "up_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.up.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UP (alt)"
