...
<!DOCTYPE html>
<html>
<head><title>UMP (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UMP (alt) tenders</h1>
        <table>
            <thead>
...
class UmpAltSource:
    """Tender source plug-in for UMP (alt)."""

    source_id: str = "ump_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ump.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UMP (alt)"
