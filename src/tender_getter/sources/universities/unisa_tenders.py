"""University of South Africa (UNISA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of South Africa (UNISA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of South Africa (UNISA) tenders</h1>
        <table>
            <thead>
...
class UnisaSource:
    """Tender source plug-in for University of South Africa (UNISA)."""

    source_id: str = "unisa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.unisa.ac.za/sites/corporate/default/Procurement"):
        self.url = url
        self.issuing_entity = "University of South Africa (UNISA)"
