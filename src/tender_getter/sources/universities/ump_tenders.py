"""University of Mpumalanga tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of Mpumalanga Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of Mpumalanga tenders</h1>
        <table>
            <thead>
...
class UmpSource:
    """Tender source plug-in for University of Mpumalanga."""

    source_id: str = "ump_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ump.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "University of Mpumalanga"
