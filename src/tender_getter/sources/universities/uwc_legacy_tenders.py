"""University of the Western Cape (legacy) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>University of the Western Cape (legacy) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active University of the Western Cape (legacy) tenders</h1>
        <table>
            <thead>
...
class UwcLegacySource:
    """Tender source plug-in for University of the Western Cape (legacy)."""

    source_id: str = "uwc_legacy_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.uwc.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "University of the Western Cape (legacy)"
