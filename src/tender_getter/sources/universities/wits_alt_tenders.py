"""Wits (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Wits (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Wits (alt) tenders</h1>
        <table>
            <thead>
...
class WitsAltSource:
    """Tender source plug-in for Wits (alt)."""

    source_id: str = "wits_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.wits.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "Wits (alt)"
