...
<!DOCTYPE html>
<html>
<head><title>UJ (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UJ (alt) tenders</h1>
        <table>
            <thead>
...
class UjAltSource:
    """Tender source plug-in for UJ (alt)."""

    source_id: str = "uj_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.uj.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UJ (alt)"
