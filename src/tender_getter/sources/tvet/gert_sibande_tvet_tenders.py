"""Gert Sibande TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gert Sibande TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gert Sibande TVET College tenders</h1>
        <table>
            <thead>
...
class GertSibandeTvetSource:
    """Tender source plug-in for Gert Sibande TVET College."""

    source_id: str = "gert_sibande_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.gscollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Gert Sibande TVET College"
