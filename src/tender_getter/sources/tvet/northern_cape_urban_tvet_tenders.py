"""Northern Cape Urban TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Urban TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Urban TVET College tenders</h1>
        <table>
            <thead>
...
class NorthernCapeUrbanTvetSource:
    """Tender source plug-in for Northern Cape Urban TVET College."""

    source_id: str = "northern_cape_urban_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ncutvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Urban TVET College"
