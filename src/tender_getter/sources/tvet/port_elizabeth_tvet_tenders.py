"""Port Elizabeth TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Port Elizabeth TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Port Elizabeth TVET College tenders</h1>
        <table>
            <thead>
...
class PortElizabethTvetSource:
    """Tender source plug-in for Port Elizabeth TVET College."""

    source_id: str = "port_elizabeth_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.petvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Port Elizabeth TVET College"
