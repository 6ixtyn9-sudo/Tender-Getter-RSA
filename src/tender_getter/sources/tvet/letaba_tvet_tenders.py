"""Letaba TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Letaba TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Letaba TVET College tenders</h1>
        <table>
            <thead>
...
class LetabaTvetSource:
    """Tender source plug-in for Letaba TVET College."""

    source_id: str = "letaba_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.letabacollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Letaba TVET College"
