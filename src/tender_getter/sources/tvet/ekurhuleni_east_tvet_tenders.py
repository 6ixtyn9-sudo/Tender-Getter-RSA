"""Ekurhuleni East TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ekurhuleni East TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ekurhuleni East TVET College tenders</h1>
        <table>
            <thead>
...
class EkurhuleniEastTvetSource:
    """Tender source plug-in for Ekurhuleni East TVET College."""

    source_id: str = "ekurhuleni_east_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.eec.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Ekurhuleni East TVET College"
