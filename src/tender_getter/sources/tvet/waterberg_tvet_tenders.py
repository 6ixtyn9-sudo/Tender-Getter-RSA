"""Waterberg TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Waterberg TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Waterberg TVET College tenders</h1>
        <table>
            <thead>
...
class WaterbergTvetSource:
    """Tender source plug-in for Waterberg TVET College."""

    source_id: str = "waterberg_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.waterbergcollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Waterberg TVET College"
