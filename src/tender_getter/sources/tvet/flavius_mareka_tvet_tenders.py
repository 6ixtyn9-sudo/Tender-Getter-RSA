"""Flavius Mareka TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Flavius Mareka TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Flavius Mareka TVET College tenders</h1>
        <table>
            <thead>
...
class FlaviusMarekaTvetSource:
    """Tender source plug-in for Flavius Mareka TVET College."""

    source_id: str = "flavius_mareka_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.flaviusmareka.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Flavius Mareka TVET College"
