"""King Hintsa TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>King Hintsa TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active King Hintsa TVET College tenders</h1>
        <table>
            <thead>
...
class KingHintsaTvetSource:
    """Tender source plug-in for King Hintsa TVET College."""

    source_id: str = "king_hintsa_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.kinghintsacollege.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "King Hintsa TVET College"
