"""South Cape TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South Cape TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South Cape TVET College tenders</h1>
        <table>
            <thead>
...
class SouthCapeTvetSource:
    """Tender source plug-in for South Cape TVET College."""

    source_id: str = "south_cape_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sccollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South Cape TVET College"
