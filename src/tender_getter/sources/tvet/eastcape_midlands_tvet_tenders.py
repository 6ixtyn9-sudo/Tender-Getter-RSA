"""Eastcape Midlands TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastcape Midlands TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastcape Midlands TVET College tenders</h1>
        <table>
            <thead>
...
class EastcapeMidlandsTvetSource:
    """Tender source plug-in for Eastcape Midlands TVET College."""

    source_id: str = "eastcape_midlands_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.emcol.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastcape Midlands TVET College"
