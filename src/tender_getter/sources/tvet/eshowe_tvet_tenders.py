"""Eshowe TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eshowe TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eshowe TVET College tenders</h1>
        <table>
            <thead>
...
class EshoweTvetSource:
    """Tender source plug-in for Eshowe TVET College."""

    source_id: str = "eshowe_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.eshowetvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eshowe TVET College"
