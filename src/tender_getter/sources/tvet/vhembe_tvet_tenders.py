"""Vhembe TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Vhembe TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Vhembe TVET College tenders</h1>
        <table>
            <thead>
...
class VhembeTvetSource:
    """Tender source plug-in for Vhembe TVET College."""

    source_id: str = "vhembe_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.vhembetvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Vhembe TVET College"
