"""Nkangala TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nkangala TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nkangala TVET College tenders</h1>
        <table>
            <thead>
...
class NkangalaTvetSource:
    """Tender source plug-in for Nkangala TVET College."""

    source_id: str = "nkangala_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nkangalafet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Nkangala TVET College"
