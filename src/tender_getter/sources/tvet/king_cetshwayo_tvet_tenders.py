"""King Cetshwayo TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>King Cetshwayo TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active King Cetshwayo TVET College tenders</h1>
        <table>
            <thead>
...
class KingCetshwayoTvetSource:
    """Tender source plug-in for King Cetshwayo TVET College."""

    source_id: str = "king_cetshwayo_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.kingcetshwayo.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "King Cetshwayo TVET College"
