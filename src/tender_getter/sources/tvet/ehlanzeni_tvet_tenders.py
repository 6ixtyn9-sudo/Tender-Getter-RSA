"""Ehlanzeni TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ehlanzeni TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ehlanzeni TVET College tenders</h1>
        <table>
            <thead>
...
class EhlanzeniTvetSource:
    """Tender source plug-in for Ehlanzeni TVET College."""

    source_id: str = "ehlanzeni_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ehlanzeni.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Ehlanzeni TVET College"
