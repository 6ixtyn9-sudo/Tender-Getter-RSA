"""Northern Cape Rural TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Rural TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Rural TVET College tenders</h1>
        <table>
            <thead>
...
class NorthernCapeRuralTvetSource:
    """Tender source plug-in for Northern Cape Rural TVET College."""

    source_id: str = "northern_cape_rural_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ncrfet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Rural TVET College"
