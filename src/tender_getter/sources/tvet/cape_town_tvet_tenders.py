"""College of Cape Town TVET tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>College of Cape Town TVET Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active College of Cape Town TVET tenders</h1>
        <table>
            <thead>
...
class CapeTownTvetSource:
    """Tender source plug-in for College of Cape Town TVET."""

    source_id: str = "cape_town_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.capetowncollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "College of Cape Town TVET"
