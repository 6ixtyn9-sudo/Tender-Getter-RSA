"""Taletso TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Taletso TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Taletso TVET College tenders</h1>
        <table>
            <thead>
...
class TaletsoTvetSource:
    """Tender source plug-in for Taletso TVET College."""

    source_id: str = "taletso_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.taletso.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Taletso TVET College"
