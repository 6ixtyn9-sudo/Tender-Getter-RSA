"""Lephalale TVET tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lephalale TVET Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lephalale TVET tenders</h1>
        <table>
            <thead>
...
class LephalaleTvetSource:
    """Tender source plug-in for Lephalale TVET."""

    source_id: str = "lephalale_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ltvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Lephalale TVET"
