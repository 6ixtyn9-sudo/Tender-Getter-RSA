"""Mopani East TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mopani East TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mopani East TVET College tenders</h1>
        <table>
            <thead>
...
class MopaniEastTvetSource:
    """Tender source plug-in for Mopani East TVET College."""

    source_id: str = "mopani_east_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.metvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mopani East TVET College"
