"""Tshwane South TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Tshwane South TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Tshwane South TVET College tenders</h1>
        <table>
            <thead>
...
class TvetTshwaneSouthSource:
    """Tender source plug-in for Tshwane South TVET College."""

    source_id: str = "tvet_tshwane_south_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tsc.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Tshwane South TVET College"
