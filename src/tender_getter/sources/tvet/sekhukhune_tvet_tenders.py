"""Sekhukhune TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sekhukhune TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sekhukhune TVET College tenders</h1>
        <table>
            <thead>
...
class SekhukhuneTvetSource:
    """Tender source plug-in for Sekhukhune TVET College."""

    source_id: str = "sekhukhune_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sekhukhune.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Sekhukhune TVET College"
