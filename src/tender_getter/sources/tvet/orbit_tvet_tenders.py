"""Orbit TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Orbit TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Orbit TVET College tenders</h1>
        <table>
            <thead>
...
class OrbitTvetSource:
    """Tender source plug-in for Orbit TVET College."""

    source_id: str = "orbit_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.orbitcollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Orbit TVET College"
