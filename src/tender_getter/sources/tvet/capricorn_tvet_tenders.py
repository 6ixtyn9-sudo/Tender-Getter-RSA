"""Capricorn TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Capricorn TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Capricorn TVET College tenders</h1>
        <table>
            <thead>
...
class CapricornTvetSource:
    """Tender source plug-in for Capricorn TVET College."""

    source_id: str = "capricorn_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.capricorncollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Capricorn TVET College"
