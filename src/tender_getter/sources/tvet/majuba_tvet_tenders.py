"""Majuba TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Majuba TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Majuba TVET College tenders</h1>
        <table>
            <thead>
...
class MajubaTvetSource:
    """Tender source plug-in for Majuba TVET College."""

    source_id: str = "majuba_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.majuba.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Majuba TVET College"
