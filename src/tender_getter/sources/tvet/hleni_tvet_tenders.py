"""Lephalale TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lephalale TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lephalale TVET College tenders</h1>
        <table>
            <thead>
...
class HleniTvetSource:
    """Tender source plug-in for Lephalale TVET College."""

    source_id: str = "hleni_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ltvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Lephalale TVET College"
