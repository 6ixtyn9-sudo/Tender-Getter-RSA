"""Sedibeng TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sedibeng TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sedibeng TVET College tenders</h1>
        <table>
            <thead>
...
class SedibengTvetSource:
    """Tender source plug-in for Sedibeng TVET College."""

    source_id: str = "sedibeng_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sedibengtvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Sedibeng TVET College"
