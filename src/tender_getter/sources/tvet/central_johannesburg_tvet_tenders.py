"""Central Johannesburg TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Central Johannesburg TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Central Johannesburg TVET College tenders</h1>
        <table>
            <thead>
...
class CentralJohannesburgTvetSource:
    """Tender source plug-in for Central Johannesburg TVET College."""

    source_id: str = "central_johannesburg_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cjc.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Central Johannesburg TVET College"
