"""Mopani West TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mopani West TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mopani West TVET College tenders</h1>
        <table>
            <thead>
...
class MopaniWestTvetSource:
    """Tender source plug-in for Mopani West TVET College."""

    source_id: str = "mopani_west_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mwtvetcollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mopani West TVET College"
