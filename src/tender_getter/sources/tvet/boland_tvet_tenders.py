"""Boland TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Boland TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Boland TVET College tenders</h1>
        <table>
            <thead>
...
class BolandTvetSource:
    """Tender source plug-in for Boland TVET College."""

    source_id: str = "boland_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.bolandcollege.com/procurement"):
        self.url = url
        self.issuing_entity = "Boland TVET College"
