"""South West Gauteng TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South West Gauteng TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South West Gauteng TVET College tenders</h1>
        <table>
            <thead>
...
class SouthWestGautengTvetSource:
    """Tender source plug-in for South West Gauteng TVET College."""

    source_id: str = "south_west_gauteng_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.swgc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South West Gauteng TVET College"
