"""uMgungundlovu TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMgungundlovu TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMgungundlovu TVET College tenders</h1>
        <table>
            <thead>
...
class UmgungundlovuTvetSource:
    """Tender source plug-in for uMgungundlovu TVET College."""

    source_id: str = "umgungundlovu_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ufet.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "uMgungundlovu TVET College"
