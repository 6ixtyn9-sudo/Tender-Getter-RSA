"""Ingwe TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ingwe TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ingwe TVET College tenders</h1>
        <table>
            <thead>
...
class IngweTvetSource:
    """Tender source plug-in for Ingwe TVET College."""

    source_id: str = "ingwe_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ingwecollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ingwe TVET College"
