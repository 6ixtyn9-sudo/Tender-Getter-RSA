"""Lovedale TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lovedale TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lovedale TVET College tenders</h1>
        <table>
            <thead>
...
class LovedaleTvetSource:
    """Tender source plug-in for Lovedale TVET College."""

    source_id: str = "lovedale_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.lovedale.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Lovedale TVET College"
