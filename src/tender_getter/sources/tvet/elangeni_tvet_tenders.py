"""Elangeni TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Elangeni TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Elangeni TVET College tenders</h1>
        <table>
            <thead>
...
class ElangeniTvetSource:
    """Tender source plug-in for Elangeni TVET College."""

    source_id: str = "elangeni_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.elangeni.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Elangeni TVET College"
