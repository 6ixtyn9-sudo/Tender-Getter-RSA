"""Thekwini TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Thekwini TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Thekwini TVET College tenders</h1>
        <table>
            <thead>
...
class ThekwiniTvetSource:
    """Tender source plug-in for Thekwini TVET College."""

    source_id: str = "thekwini_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.thekwini.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Thekwini TVET College"
