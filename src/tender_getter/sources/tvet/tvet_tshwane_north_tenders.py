"""Tshwane North TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Tshwane North TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Tshwane North TVET College tenders</h1>
        <table>
            <thead>
...
class TvetTshwaneNorthSource:
    """Tender source plug-in for Tshwane North TVET College."""

    source_id: str = "tvet_tshwane_north_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tnc.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Tshwane North TVET College"
