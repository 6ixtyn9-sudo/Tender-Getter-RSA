"""Mnambithi TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mnambithi TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mnambithi TVET College tenders</h1>
        <table>
            <thead>
...
class MnambithiTvetSource:
    """Tender source plug-in for Mnambithi TVET College."""

    source_id: str = "mnambithi_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mnambithicollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mnambithi TVET College"
