"""Mthashana TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mthashana TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mthashana TVET College tenders</h1>
        <table>
            <thead>
...
class MthashanaTvetSource:
    """Tender source plug-in for Mthashana TVET College."""

    source_id: str = "mthashana_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mthashanacollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mthashana TVET College"
