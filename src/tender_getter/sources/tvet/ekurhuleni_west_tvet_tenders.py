"""Ekurhuleni West TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ekurhuleni West TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ekurhuleni West TVET College tenders</h1>
        <table>
            <thead>
...
class EkurhuleniWestTvetSource:
    """Tender source plug-in for Ekurhuleni West TVET College."""

    source_id: str = "ekurhuleni_west_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ewc.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Ekurhuleni West TVET College"
