"""Northlink TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northlink TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northlink TVET College tenders</h1>
        <table>
            <thead>
...
class NorthlinkTvetSource:
    """Tender source plug-in for Northlink TVET College."""

    source_id: str = "northlink_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.northlink.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Northlink TVET College"
