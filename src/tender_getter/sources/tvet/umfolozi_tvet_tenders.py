"""uMfolozi TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMfolozi TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMfolozi TVET College tenders</h1>
        <table>
            <thead>
...
class UmfoloziTvetSource:
    """Tender source plug-in for uMfolozi TVET College."""

    source_id: str = "umfolozi_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.umfolozi.co.za/procurement"):
        self.url = url
        self.issuing_entity = "uMfolozi TVET College"
