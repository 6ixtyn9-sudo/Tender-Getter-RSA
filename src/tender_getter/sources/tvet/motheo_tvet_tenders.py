"""Motheo TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Motheo TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Motheo TVET College tenders</h1>
        <table>
            <thead>
...
class MotheoTvetSource:
    """Tender source plug-in for Motheo TVET College."""

    source_id: str = "motheo_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.motheotvetcollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Motheo TVET College"
