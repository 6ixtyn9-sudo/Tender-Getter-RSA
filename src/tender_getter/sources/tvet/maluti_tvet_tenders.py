"""Maluti TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Maluti TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Maluti TVET College tenders</h1>
        <table>
            <thead>
...
class MalutiTvetSource:
    """Tender source plug-in for Maluti TVET College."""

    source_id: str = "maluti_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.malutitvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Maluti TVET College"
