"""Ikhala TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ikhala TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ikhala TVET College tenders</h1>
        <table>
            <thead>
...
class IkhalaTvetSource:
    """Tender source plug-in for Ikhala TVET College."""

    source_id: str = "ikhala_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ikhala.edu.za/procurement"):
        self.url = url
        self.issuing_entity = "Ikhala TVET College"
