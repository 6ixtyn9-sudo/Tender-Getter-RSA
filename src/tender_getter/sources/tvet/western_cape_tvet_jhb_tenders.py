"""Western Cape TVET (JHB campus) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape TVET (JHB campus) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape TVET (JHB campus) tenders</h1>
        <table>
            <thead>
...
class WesternCapeTvetJhbSource:
    """Tender source plug-in for Western Cape TVET (JHB campus)."""

    source_id: str = "western_cape_tvet_jhb_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.westerncape.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape TVET (JHB campus)"
