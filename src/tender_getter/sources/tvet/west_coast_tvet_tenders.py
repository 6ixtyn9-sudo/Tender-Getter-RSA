"""West Coast TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>West Coast TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active West Coast TVET College tenders</h1>
        <table>
            <thead>
...
class WestCoastTvetSource:
    """Tender source plug-in for West Coast TVET College."""

    source_id: str = "west_coast_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.westcoastcollege.co.za/procurement"):
        self.url = url
        self.issuing_entity = "West Coast TVET College"
