"""Buffalo City TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Buffalo City TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Buffalo City TVET College tenders</h1>
        <table>
            <thead>
...
class BuffaloCityTvetSource:
    """Tender source plug-in for Buffalo City TVET College."""

    source_id: str = "buffalo_city_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.bctvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Buffalo City TVET College"
