"""Vuselela TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Vuselela TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Vuselela TVET College tenders</h1>
        <table>
            <thead>
...
class VuselelaTvetSource:
    """Tender source plug-in for Vuselela TVET College."""

    source_id: str = "vuselela_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.vuselela.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Vuselela TVET College"
