"""Goldfields TVET College tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Goldfields TVET College Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Goldfields TVET College tenders</h1>
        <table>
            <thead>
...
class GoldfieldsTvetSource:
    """Tender source plug-in for Goldfields TVET College."""

    source_id: str = "goldfields_tvet_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.goldfieldstvet.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Goldfields TVET College"
