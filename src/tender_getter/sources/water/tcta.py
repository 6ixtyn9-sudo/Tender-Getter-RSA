"""Trans-Caledon Tunnel Authority Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Trans-Caledon Tunnel Authority Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Trans-Caledon Tunnel Authority tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>TCTA/2025/CE/19</td>
                    <td>Tunnel Engineering Consultancy (National, Grade 7CE)</td>
                    <td>2026-09-20 11:00:00</td>
                </tr>
                <tr>
                    <td>TCTA/2025/FIN/04</td>
                    <td>Project Finance Advisory (National)</td>
                    <td>2026-09-08 11:00:00</td>
                </tr>
                <tr>
                    <td>TCTA/2025/ENV/06</td>
                    <td>Hydrology Monitoring Services (National)</td>
...
class TCTASource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Trans-Caledon Tunnel Authority tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_TCTA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Trans-Caledon Tunnel Authority tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Trans-Caledon Tunnel Authority",
