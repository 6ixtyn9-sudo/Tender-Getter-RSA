"""Rand Water Tender Source Plugin"""
import logging
import re
...
MOCK_RAND_WATER_HTML = """
<!DOCTYPE html>
<html>
<head><title>Rand Water Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Rand Water tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>RW/2025/CE/14</td>
                    <td>Bulk Water Pipeline – Vaal Triangle (Gauteng, Grade 6CE)</td>
                    <td>2026-09-17 11:00:00</td>
                </tr>
                <tr>
                    <td>RW/2025/EE/05</td>
                    <td>Pump Station Electrical Upgrade (Gauteng, Grade 4EE)</td>
                    <td>2026-09-01 11:00:00</td>
                </tr>
                <tr>
                    <td>RW/2025/MECH/08</td>
                    <td>Water Treatment Plant Maintenance (Gauteng, Grade 3ME)</td>
...
class RandWaterSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Rand Water tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_RAND_WATER_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_RAND_WATER_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Rand Water tenders table/list from HTML using standard Python regex.
        """
        tenders = []
