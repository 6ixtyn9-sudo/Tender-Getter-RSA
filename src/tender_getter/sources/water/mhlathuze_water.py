"""Mhlathuze Water Tender Source Plugin"""
import logging
import re
...
MOCK_MHLATHUZE_WATER_HTML = """
<!DOCTYPE html>
<html>
<head><title>Mhlathuze Water Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Mhlathuze Water tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>MW/2025/CE/09</td>
                    <td>Desalination Plant Civil Works (KwaZulu-Natal, Grade 4CE)</td>
                    <td>2026-09-10 11:00:00</td>
                </tr>
                <tr>
                    <td>MW/2025/PIPE/04</td>
                    <td>Bulk Pipeline Replacement (KwaZulu-Natal, Grade 3CE)</td>
                    <td>2026-08-29 11:00:00</td>
                </tr>
                <tr>
                    <td>MW/2025/SERV/11</td>
...
class MhlathuzeWaterSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Mhlathuze Water tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_MHLATHUZE_WATER_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_MHLATHUZE_WATER_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Mhlathuze Water tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Mhlathuze Water",
