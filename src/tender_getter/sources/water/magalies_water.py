"""Magalies Water Tender Source Plugin"""
import logging
import re
...
MOCK_MAGALIES_WATER_HTML = """
<!DOCTYPE html>
<html>
<head><title>Magalies Water Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Magalies Water tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>MAGW/2025/CE/08</td>
                    <td>Reservoir Construction – Rustenburg (North West, Grade 4CE)</td>
                    <td>2026-09-09 11:00:00</td>
                </tr>
                <tr>
                    <td>MAGW/2025/PIPE/05</td>
                    <td>Distribution Line Upgrade (North West, Grade 2CE)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>MAGW/2025/MAINT/02</td>
                    <td>Bulk Meter Replacement (North West)</td>
...
class MagaliesWaterSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Magalies Water tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_MAGALIES_WATER_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_MAGALIES_WATER_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Magalies Water tenders table/list from HTML using standard Python regex.
        """
        tenders = []
