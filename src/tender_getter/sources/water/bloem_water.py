"""Bloem Water Tender Source Plugin"""
import logging
import re
...
MOCK_BLOEM_WATER_HTML = """
<!DOCTYPE html>
<html>
<head><title>Bloem Water Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Bloem Water tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>BW/2025/LAB/04</td>
                    <td>Water Quality Laboratory Supplies (Free State)</td>
                    <td>2026-09-06 11:00:00</td>
                </tr>
                <tr>
                    <td>BW/2025/CE/09</td>
                    <td>Reservoir Upgrade – Bloemfontein (Free State, Grade 3CE)</td>
                    <td>2026-09-11 11:00:00</td>
                </tr>
                <tr>
                    <td>BW/2025/EE/02</td>
                    <td>Pump Control Panel Upgrade (Free State, Grade 2EE)</td>
...
class BloemWaterSource:
    source_id: str = "bloem_water_tenders"

    def __init__(self, url: str = "https://www.bloemwater.co.za/tenders"):
        self.url = url

    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Bloem Water tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_BLOEM_WATER_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_BLOEM_WATER_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Bloem Water tenders table/list from HTML using standard Python regex.
        """
        tenders = []
