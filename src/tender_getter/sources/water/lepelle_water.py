"""Lepelle Northern Water Tender Source Plugin"""
import logging
import re
...
MOCK_LEPELLE_WATER_HTML = """
<!DOCTYPE html>
<html>
<head><title>Lepelle Northern Water Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Lepelle Northern Water tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>LNW/2025/CE/11</td>
                    <td>Regional Pipeline Maintenance (Limpopo, Grade 4CE)</td>
                    <td>2026-09-14 11:00:00</td>
                </tr>
                <tr>
                    <td>LNW/2025/EE/03</td>
                    <td>Pump Station Upgrade – Polokwane (Limpopo, Grade 3EE)</td>
                    <td>2026-08-31 11:00:00</td>
                </tr>
                <tr>
                    <td>LNW/2025/SERV/06</td>
                    <td>Water Quality Monitoring (Limpopo)</td>
...
class LepelleWaterSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Lepelle Northern Water tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_LEPELLE_WATER_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_LEPELLE_WATER_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Lepelle Northern Water tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Lepelle Northern Water",
