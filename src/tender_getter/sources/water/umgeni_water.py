"""Umgeni Water Tender Source Plugin"""
import logging
import re
...
MOCK_UMGENI_WATER_HTML = """
<!DOCTYPE html>
<html>
<head><title>Umgeni Water Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Umgeni Water tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>UW/2025/CE/22</td>
                    <td>Dam Wall Rehabilitation – Midmar (KwaZulu-Natal, Grade 5CE)</td>
                    <td>2026-09-15 11:00:00</td>
                </tr>
                <tr>
                    <td>UW/2025/EE/07</td>
                    <td>Purification Plant Electrical (KwaZulu-Natal, Grade 3EE)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>UW/2025/SERV/03</td>
                    <td>Water Quality Testing Services (KwaZulu-Natal)</td>
...
class UmgeniWaterSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Umgeni Water tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_UMGENI_WATER_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_UMGENI_WATER_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Umgeni Water tenders table/list from HTML using standard Python regex.
        """
        tenders = []
