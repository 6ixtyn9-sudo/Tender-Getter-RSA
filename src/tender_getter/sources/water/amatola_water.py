"""Amatola Water Tender Source Plugin"""
import logging
import re
...
MOCK_AMATOLA_WATER_HTML = """
<!DOCTYPE html>
<html>
<head><title>Amatola Water Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Amatola Water tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>AW/2025/CE/13</td>
                    <td>Community Water Scheme – Amathole (Eastern Cape, Grade 3CE)</td>
                    <td>2026-09-12 11:00:00</td>
                </tr>
                <tr>
                    <td>AW/2025/EE/04</td>
                    <td>Treatment Works Electrical (Eastern Cape, Grade 2EE)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>AW/2025/TRANS/07</td>
                    <td>Water Tanker Supply (Eastern Cape)</td>
...
class AmatolaWaterSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Amatola Water tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_AMATOLA_WATER_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_AMATOLA_WATER_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Amatola Water tenders table/list from HTML using standard Python regex.
        """
        tenders = []
