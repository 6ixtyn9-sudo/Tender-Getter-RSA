"""Sedibeng Water Tender Source Plugin"""
import logging
import re
...
MOCK_SEDIBENG_WATER_HTML = """
<!DOCTYPE html>
<html>
<head><title>Sedibeng Water Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Sedibeng Water tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>SEDW/2025/CE/07</td>
                    <td>Pump Station Repairs – Vaal (Free State, Grade 3CE)</td>
                    <td>2026-09-05 11:00:00</td>
                </tr>
                <tr>
                    <td>SEDW/2025/PIPE/03</td>
                    <td>Rural Water Piping – North West (Free State, Grade 2CE)</td>
                    <td>2026-08-29 11:00:00</td>
                </tr>
                <tr>
                    <td>SEDW/2025/SERV/09</td>
                    <td>Water Tanker Hire (Free State)</td>
...
class SedibengWaterSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Sedibeng Water tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_SEDIBENG_WATER_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SEDIBENG_WATER_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Sedibeng Water tenders table/list from HTML using standard Python regex.
        """
        tenders = []
