"""Gauteng Department of Roads and Transport Tender Source Plugin"""
import logging
import re
...
MOCK_GDRT_HTML = """
<!DOCTYPE html><html><head><title>Gauteng Department of Roads and Transport Tenders</title></head><body><div class="wrapper"><h1>Active Gauteng Department of Roads and Transport tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>GDRT/2025/001</td>
...
class GDRTSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Gauteng Department of Roads and Transport tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_GDRT_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Gauteng Department of Roads and Transport tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Gauteng Department of Roads and Transport",
