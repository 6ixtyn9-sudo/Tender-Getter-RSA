"""Gauteng Department of Health Tender Source Plugin"""
import logging
import re
...
MOCK_GDH_HTML = """
<!DOCTYPE html><html><head><title>Gauteng Department of Health Tenders</title></head><body><div class="wrapper"><h1>Active Gauteng Department of Health tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>GDH/2025/001</td>
...
class GDHSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Gauteng Department of Health tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_GDH_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Gauteng Department of Health tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Gauteng Department of Health",
