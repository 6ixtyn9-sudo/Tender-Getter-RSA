"""Western Cape Department of Infrastructure Tender Source Plugin"""
import logging
import re
...
MOCK_WCDI_HTML = """
<!DOCTYPE html><html><head><title>Western Cape Department of Infrastructure Tenders</title></head><body><div class="wrapper"><h1>Active Western Cape Department of Infrastructure tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>WCDI/2025/001</td>
...
class WCDISource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Western Cape Department of Infrastructure tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_WCDI_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Western Cape Department of Infrastructure tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Western Cape Department of Infrastructure",
