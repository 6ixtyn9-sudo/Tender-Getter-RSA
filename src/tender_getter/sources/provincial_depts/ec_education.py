"""Eastern Cape Department of Education Tender Source Plugin"""
import logging
import re
...
MOCK_EC_EDUCATION_HTML = """
<!DOCTYPE html><html><head><title>Eastern Cape Department of Education Tenders</title></head><body><div class="wrapper"><h1>Active Eastern Cape Department of Education tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>EC_E/2025/001</td>
...
class ECEducationSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Eastern Cape Department of Education tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_EC_EDUCATION_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_EC_EDUCATION_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Eastern Cape Department of Education tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Eastern Cape Department of Education",
