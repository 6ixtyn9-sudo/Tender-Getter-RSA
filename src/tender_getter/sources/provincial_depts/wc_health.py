"""Western Cape Department of Health & Wellness Tender Source Plugin"""
import logging
import re
...
MOCK_WC_HEALTH_HTML = """
<!DOCTYPE html><html><head><title>Western Cape Department of Health & Wellness Tenders</title></head><body><div class="wrapper"><h1>Active Western Cape Department of Health & Wellness tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>WC_H/2025/001</td>
                    <td>Infrastructure Maintenance – Western Cape (Western Cape, Grade 3CE)</td>
                    <td>2026-09-10 11:00:00</td>
                </tr>
                <tr>
                    <td>WC_H/2025/002</td>
                    <td>Building Refurbishment – Western Cape (Western Cape, Grade 2GB)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>WC_H/2025/003</td>
                    <td>Professional Services Panel (Western Cape)</td>
...
class WCHealthSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Western Cape Department of Health & Wellness tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_WC_HEALTH_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_WC_HEALTH_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Western Cape Department of Health & Wellness tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Western Cape Department of Health & Wellness",
