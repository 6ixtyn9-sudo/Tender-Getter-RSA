"""CoJ Solid Waste tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>CoJ Solid Waste Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CoJ Solid Waste tenders</h1>
        <table>
            <thead>
...
class CojSolidWasteSource:
    """Tender source plug-in for CoJ Solid Waste."""

    source_id: str = "coj_solid_waste_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.joburg.org.za/SolidWaste/procurement"):
        self.url = url
        self.issuing_entity = "CoJ Solid Waste"
