"""eThekwini Metropolitan Municipality tender source plug-in."""
import logging
import re
...
class EthekwiniSource:
    """Tender source plug-in for eThekwini Metropolitan Municipality."""
    ...
    def __init__(self, url: str = "https://www.durban.gov.za/pages/residents/tenders"):
        self.url = url
        self.issuing_entity = "eThekwini Metropolitan Municipality"
