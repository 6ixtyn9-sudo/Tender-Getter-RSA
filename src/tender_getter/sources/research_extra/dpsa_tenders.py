"""Department of Public Service & Administration tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Public Service & Administration Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Public Service & Administration tenders</h1>
        <table>
            <thead>
...
class DpsaSource:
    """Tender source plug-in for Department of Public Service & Administration."""
    ...
    def __init__(self, url: str = "https://www.dpsa.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Public Service & Administration"
