"""Limpopo Heritage Foundation tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Heritage Foundation Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Heritage Foundation tenders</h1>
        <table>
            <thead>
...
class LpHeritageSource:
    """Tender source plug-in for Limpopo Heritage Foundation."""

    source_id: str = "lp_heritage_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.limpopomuseum.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Heritage Foundation"
