"""Western Cape Blood Service (WCBS) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Blood Service (WCBS) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Blood Service (WCBS) tenders</h1>
        <table>
            <thead>
...
class WcbsSource:
    """Tender source plug-in for Western Cape Blood Service (WCBS)."""

    source_id: str = "wcbs_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.wcbs.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Blood Service (WCBS)"
