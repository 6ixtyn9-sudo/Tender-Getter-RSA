"""Mpumalanga Tourism Authority tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Tourism Authority Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Tourism Authority tenders</h1>
        <table>
            <thead>
...
class MpTourismSource:
    """Tender source plug-in for Mpumalanga Tourism Authority."""

    source_id: str = "mp_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mpumalanga.com/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Tourism Authority"
