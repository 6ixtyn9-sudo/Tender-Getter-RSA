"""South African Weather Service (SAWS) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Weather Service (SAWS) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Weather Service (SAWS) tenders</h1>
        <table>
            <thead>
...
class SawsSource:
    """Tender source plug-in for South African Weather Service (SAWS)."""

    source_id: str = "saws_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.weathersa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Weather Service (SAWS)"
