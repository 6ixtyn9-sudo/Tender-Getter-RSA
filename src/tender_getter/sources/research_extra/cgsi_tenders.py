...
<!DOCTYPE html>
<html>
<head><title>CGSI Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CGSI tenders</h1>
        <table>
            <thead>
...
class CgsiSource:
    """Tender source plug-in for CGSI."""

    source_id: str = "cgsi_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.cgsi.co.za/procurement"):
        self.url = url
        self.issuing_entity = "CGSI"
