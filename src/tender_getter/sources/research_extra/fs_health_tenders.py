"""Free State Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Health tenders</h1>
        <table>
            <thead>
...
class FsHealthSource:
    """Tender source plug-in for Free State Health."""

    source_id: str = "fs_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.fshealth.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Health"
