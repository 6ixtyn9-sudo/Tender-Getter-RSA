"""National Lotteries Commission (NLC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Lotteries Commission (NLC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Lotteries Commission (NLC) tenders</h1>
        <table>
            <thead>
...
class NlcSource:
    """Tender source plug-in for National Lotteries Commission (NLC)."""

    source_id: str = "nlc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nlcsa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Lotteries Commission (NLC)"
