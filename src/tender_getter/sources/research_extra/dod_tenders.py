"""Department of Defence tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Defence Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Defence tenders</h1>
        <table>
            <thead>
...
class DodSource:
    """Tender source plug-in for Department of Defence."""
    ...
    def __init__(self, url: str = "https://www.dod.mil.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Defence"
