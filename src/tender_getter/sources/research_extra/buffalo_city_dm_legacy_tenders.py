"""Buffalo City (legacy DM code) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Buffalo City (legacy DM code) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Buffalo City (legacy DM code) tenders</h1>
        <table>
            <thead>
...
class BuffaloCityDmLegacySource:
    """Tender source plug-in for Buffalo City (legacy DM code)."""

    source_id: str = "buffalo_city_dm_legacy_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.buffalocitydm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Buffalo City (legacy DM code)"
