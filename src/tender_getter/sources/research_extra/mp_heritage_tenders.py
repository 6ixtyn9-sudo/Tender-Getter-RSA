"""Mpumalanga Heritage tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Heritage Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Heritage tenders</h1>
        <table>
            <thead>
...
class MpHeritageSource:
    """Tender source plug-in for Mpumalanga Heritage."""

    source_id: str = "mp_heritage_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mpumalangaheritage.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Heritage"
