"""Airports Company South Africa tender source plug-in."""
import logging
import re
...
class AcsaSource:
    """Tender source plug-in for Airports Company South Africa."""
    ...
    def __init__(self, url: str = "https://www.airports.co.za/business/tender-bulletin"):
        self.url = url
        self.issuing_entity = "Airports Company South Africa"
