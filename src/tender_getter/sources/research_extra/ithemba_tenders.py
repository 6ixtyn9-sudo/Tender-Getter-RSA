"""iThemba Laboratory for Accelerator Based Sciences tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>iThemba Laboratory for Accelerator Based Sciences Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active iThemba Laboratory for Accelerator Based Sciences tenders</h1>
        <table>
            <thead>
...
class IthembaSource:
    """Tender source plug-in for iThemba Laboratory for Accelerator Based Sciences."""

    source_id: str = "ithemba_tenders"
    live: bool = True

    def __init__(self, url: str = "https://tlabs.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "iThemba Laboratory for Accelerator Based Sciences"
