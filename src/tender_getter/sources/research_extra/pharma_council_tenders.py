"""Pharma Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Pharma Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Pharma Council tenders</h1>
        <table>
            <thead>
...
class PharmaCouncilSource:
    """Tender source plug-in for Pharma Council."""

    source_id: str = "pharma_council_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.pharmacouncil.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Pharma Council"
