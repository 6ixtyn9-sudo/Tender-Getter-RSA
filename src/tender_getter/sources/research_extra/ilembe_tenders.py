"""iLembe District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>iLembe District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active iLembe District Municipality tenders</h1>
        <table>
            <thead>
...
class IlembeSource:
    """Tender source plug-in for iLembe District Municipality."""
    ...
    def __init__(self, url: str = "https://www.ilembe.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "iLembe District Municipality"
