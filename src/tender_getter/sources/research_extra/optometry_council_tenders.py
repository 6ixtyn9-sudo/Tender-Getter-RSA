"""Optometry Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Optometry Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Optometry Council tenders</h1>
        <table>
            <thead>
...
class OptometryCouncilSource:
    """Tender source plug-in for Optometry Council."""

    source_id: str = "optometry_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.saoa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Optometry Council"
