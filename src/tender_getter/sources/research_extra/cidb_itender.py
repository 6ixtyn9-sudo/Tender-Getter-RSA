"""CIDB i-Tender tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>CIDB i-Tender Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CIDB i-Tender tenders</h1>
        <table>
            <thead>
...
class CidbItenderSource:
    """Tender source plug-in for CIDB i-Tender."""

    source_id: str = "cidb_itender"
    live: bool = True

    def __init__(self, url: str = "https://www.cidb.org.za/"):
        self.url = url
        self.issuing_entity = "CIDB i-Tender"
