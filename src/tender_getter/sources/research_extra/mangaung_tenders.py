"""Mangaung Metropolitan Municipality tender source plug-in."""
import logging
import re
...
class MangaungSource:
    """Tender source plug-in for Mangaung Metropolitan Municipality."""
    ...
    def __init__(self, url: str = "http://www.mangaung.co.za/category/tenders/"):
        self.url = url
        self.issuing_entity = "Mangaung Metropolitan Municipality"
