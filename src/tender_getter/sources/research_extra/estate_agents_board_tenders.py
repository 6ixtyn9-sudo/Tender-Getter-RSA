...
<!DOCTYPE html>
<html>
<head><title>EAAB Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active EAAB tenders</h1>
        <table>
            <thead>
...
class EstateAgentsBoardSource:
    """Tender source plug-in for EAAB."""

    source_id: str = "estate_agents_board_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.eaab.org.za/procurement"):
        self.url = url
        self.issuing_entity = "EAAB"
