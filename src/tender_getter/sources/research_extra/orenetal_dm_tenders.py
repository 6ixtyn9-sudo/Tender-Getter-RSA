"""OR Tambo (DM-form legacy) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>OR Tambo (DM-form legacy) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active OR Tambo (DM-form legacy) tenders</h1>
        <table>
            <thead>
...
class OrenetalDmSource:
    """Tender source plug-in for OR Tambo (DM-form legacy)."""

    source_id: str = "orenetal_dm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ortambodm.co.za/tenders"):
        self.url = url
        self.issuing_entity = "OR Tambo (DM-form legacy)"
