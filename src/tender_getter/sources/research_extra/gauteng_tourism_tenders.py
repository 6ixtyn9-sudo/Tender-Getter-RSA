"""Gauteng Tourism Authority tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Tourism Authority Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Tourism Authority tenders</h1>
        <table>
            <thead>
...
class GautengTourismSource:
    """Tender source plug-in for Gauteng Tourism Authority."""

    source_id: str = "gauteng_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gautengtourism.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Tourism Authority"
