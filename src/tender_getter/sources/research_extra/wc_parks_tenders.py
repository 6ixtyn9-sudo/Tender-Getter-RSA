"""CapeNature tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>CapeNature Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CapeNature tenders</h1>
        <table>
            <thead>
...
class WcParksSource:
    """Tender source plug-in for CapeNature."""

    source_id: str = "wc_parks_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.capenature.co.za/procurement"):
        self.url = url
        self.issuing_entity = "CapeNature"
