...
<!DOCTYPE html>
<html>
<head><title>SAPU Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SAPU tenders</h1>
        <table>
            <thead>
...
class SapuSource:
    """Tender source plug-in for SAPU."""

    source_id: str = "sapu_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sapu.org.za/procurement"):
        self.url = url
        self.issuing_entity = "SAPU"
