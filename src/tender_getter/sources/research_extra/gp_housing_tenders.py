"""Gauteng Housing Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Housing Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Housing Board tenders</h1>
        <table>
            <thead>
...
class GpHousingSource:
    """Tender source plug-in for Gauteng Housing Board."""

    source_id: str = "gp_housing_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gphousing.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Housing Board"
