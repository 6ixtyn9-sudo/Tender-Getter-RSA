"""KZN Roads (DOT legacy) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Roads (DOT legacy) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Roads (DOT legacy) tenders</h1>
        <table>
            <thead>
...
class KznRoadsSource:
    """Tender source plug-in for KZN Roads (DOT legacy)."""

    source_id: str = "kzn_roads_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.kzntransport.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Roads (DOT legacy)"
