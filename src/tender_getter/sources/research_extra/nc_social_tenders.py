"""Northern Cape Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Social Development tenders</h1>
        <table>
            <thead>
...
class NcSocialSource:
    """Tender source plug-in for Northern Cape Social Development."""

    source_id: str = "nc_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ncsd.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Social Development"
