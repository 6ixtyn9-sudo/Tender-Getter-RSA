...
<!DOCTYPE html>
<html>
<head><title>NGB (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NGB (alt) tenders</h1>
        <table>
            <thead>
...
class NationalGamblingBoardSource:
    """Tender source plug-in for NGB (alt)."""

    source_id: str = "national_gambling_board_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ngb.org.za/procurement"):
        self.url = url
        self.issuing_entity = "NGB (alt)"
