"""Competition Tribunal tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Competition Tribunal Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Competition Tribunal tenders</h1>
        <table>
            <thead>
...
class CompetitionTribunalSource:
    """Tender source plug-in for Competition Tribunal."""

    source_id: str = "competition_tribunal_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.comptrib.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Competition Tribunal"
