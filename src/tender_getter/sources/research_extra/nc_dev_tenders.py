"""Northern Cape Economic Development Agency tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Economic Development Agency Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Economic Development Agency tenders</h1>
        <table>
            <thead>
...
class NcDevSource:
    """Tender source plug-in for Northern Cape Economic Development Agency."""

    source_id: str = "nc_dev_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ncEDA.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Economic Development Agency"
