"""Gauteng Liquor Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Liquor Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Liquor Board tenders</h1>
        <table>
            <thead>
...
class GpLiquorSource:
    """Tender source plug-in for Gauteng Liquor Board."""

    source_id: str = "gp_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gla.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Liquor Board"
