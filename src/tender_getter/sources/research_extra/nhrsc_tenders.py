"""National Health Research Ethics Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Health Research Ethics Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Health Research Ethics Council tenders</h1>
        <table>
            <thead>
...
class NhrscSource:
    """Tender source plug-in for National Health Research Ethics Council."""

    source_id: str = "nhrsc_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nhrec.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Health Research Ethics Council"
