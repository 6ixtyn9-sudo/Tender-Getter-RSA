...
<!DOCTYPE html>
<html>
<head><title>NG (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NG (alt) tenders</h1>
        <table>
            <thead>
...
class NationalGamblingSource:
    """Tender source plug-in for NG (alt)."""

    source_id: str = "national_gambling_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nationalgambling.co.za/procurement"):
        self.url = url
        self.issuing_entity = "NG (alt)"
