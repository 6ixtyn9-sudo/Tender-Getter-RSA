"""Council for Geoscience tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Council for Geoscience Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Council for Geoscience tenders</h1>
        <table>
            <thead>
...
class GeoscienceSource:
    """Tender source plug-in for Council for Geoscience."""
    ...
    def __init__(self, url: str = "https://www.geoscience.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Council for Geoscience"
