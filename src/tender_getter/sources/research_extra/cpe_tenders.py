"""Commission for the Promotion of Cultural Communities (CRL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Commission for the Promotion of Cultural Communities (CRL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Commission for the Promotion of Cultural Communities (CRL) tenders</h1>
        <table>
            <thead>
...
class CpeSource:
    """Tender source plug-in for Commission for the Promotion of Cultural Communities (CRL)."""

    source_id: str = "cpe_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.crlcommission.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Commission for the Promotion of Cultural Communities (CRL)"
