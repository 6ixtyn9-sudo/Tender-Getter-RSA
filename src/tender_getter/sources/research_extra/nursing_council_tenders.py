"""Nursing Council (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nursing Council (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nursing Council (alt) tenders</h1>
        <table>
            <thead>
...
class NursingCouncilSource:
    """Tender source plug-in for Nursing Council (alt)."""

    source_id: str = "nursing_council_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sanc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Nursing Council (alt)"
