"""Nelson Mandela Bay Metropolitan Municipality tender source plug-in."""
import logging
import re
...
class NelsonmandelabaySource:
    """Tender source plug-in for Nelson Mandela Bay Metropolitan Municipality."""
    ...
    def __init__(self, url: str = "https://www.nelsonmandelabay.gov.za/Tenders"):
        self.url = url
        self.issuing_entity = "Nelson Mandela Bay Metropolitan Municipality"
