"""Department of Mineral Resources & Energy tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Mineral Resources & Energy Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Mineral Resources & Energy tenders</h1>
        <table>
            <thead>
...
class DmreSource:
    """Tender source plug-in for Department of Mineral Resources & Energy."""
    ...
    def __init__(self, url: str = "https://www.dmre.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Mineral Resources & Energy"
