"""Gauteng Department of Education tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Department of Education Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Department of Education tenders</h1>
        <table>
            <thead>
...
class GdeSource:
    """Tender source plug-in for Gauteng Department of Education."""
    ...
    def __init__(self, url: str = "https://www.education.gpg.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Gauteng Department of Education"
