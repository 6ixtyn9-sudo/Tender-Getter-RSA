"""Food Agency tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Food Agency Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Food Agency tenders</h1>
        <table>
            <thead>
...
class FoodAgencySource:
    """Tender source plug-in for Food Agency."""

    source_id: str = "food_agency_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.foodagency.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Food Agency"
