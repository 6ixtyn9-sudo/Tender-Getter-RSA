"""SA Power Pool Operations tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SA Power Pool Operations Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SA Power Pool Operations tenders</h1>
        <table>
            <thead>
...
class SapowerSource:
    """Tender source plug-in for SA Power Pool Operations."""

    source_id: str = "sapower_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sappo.co.za/procurement"):
        self.url = url
        self.issuing_entity = "SA Power Pool Operations"
