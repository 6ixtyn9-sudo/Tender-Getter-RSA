...
<!DOCTYPE html>
<html>
<head><title>NL (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NL (alt) tenders</h1>
        <table>
            <thead>
...
class NationalLotteriesSource:
    """Tender source plug-in for NL (alt)."""

    source_id: str = "national_lotteries_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nationallotteries.co.za/procurement"):
        self.url = url
        self.issuing_entity = "NL (alt)"
