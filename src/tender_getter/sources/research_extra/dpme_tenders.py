"""Department of Planning, Monitoring & Evaluation tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Planning, Monitoring & Evaluation Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Planning, Monitoring & Evaluation tenders</h1>
        <table>
            <thead>
...
class DpmeSource:
    """Tender source plug-in for Department of Planning, Monitoring & Evaluation."""
    ...
    def __init__(self, url: str = "https://www.dpme.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Planning, Monitoring & Evaluation"
