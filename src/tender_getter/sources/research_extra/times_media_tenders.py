"""Times Media tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Times Media Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Times Media tenders</h1>
        <table>
            <thead>
...
class TimesMediaSource:
    """Tender source plug-in for Times Media."""

    source_id: str = "times_media_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.timesmedia.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Times Media"
