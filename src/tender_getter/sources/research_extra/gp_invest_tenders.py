"""Gauteng Investment Centre tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Investment Centre Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Investment Centre tenders</h1>
        <table>
            <thead>
...
class GpInvestSource:
    """Tender source plug-in for Gauteng Investment Centre."""

    source_id: str = "gp_invest_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gauteng-business.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Investment Centre"
