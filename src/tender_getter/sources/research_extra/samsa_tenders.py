"""South African Maritime Safety Authority tender source plug-in."""
import logging
import re
...
class SamsaSource:
    """Tender source plug-in for South African Maritime Safety Authority."""
    ...
    def __init__(self, url: str = "https://www.samsa.org.za/tenders"):
        self.url = url
        self.issuing_entity = "South African Maritime Safety Authority"
