"""Mhlathuze Water (legacy – merged into uMngeni-uThukela) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mhlathuze Water (legacy – merged into uMngeni-uThukela) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mhlathuze Water (legacy – merged into uMngeni-uThukela) tenders</h1>
        <table>
            <thead>
...
class MhlathuzeWaterSource:
    """Tender source plug-in for Mhlathuze Water (legacy – merged into uMngeni-uThukela)."""
    ...
    def __init__(self, url: str = "https://www.mhlathuzewater.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Mhlathuze Water (legacy – merged into uMngeni-uThukela)"
