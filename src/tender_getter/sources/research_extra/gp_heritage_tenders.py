"""Gauteng Heritage Foundation tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Heritage Foundation Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Heritage Foundation tenders</h1>
        <table>
            <thead>
...
class GpHeritageSource:
    """Tender source plug-in for Gauteng Heritage Foundation."""

    source_id: str = "gp_heritage_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gp-heritage.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Heritage Foundation"
