"""Small Enterprise Development Agency tender source plug-in."""
import logging
import re
...
class SedaSource:
    """Tender source plug-in for Small Enterprise Development Agency."""
    ...
    def __init__(self, url: str = "https://www.seda.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Small Enterprise Development Agency"
