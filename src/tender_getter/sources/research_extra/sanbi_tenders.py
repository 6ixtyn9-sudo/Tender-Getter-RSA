"""South African National Biodiversity Institute (SANBI) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African National Biodiversity Institute (SANBI) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African National Biodiversity Institute (SANBI) tenders</h1>
        <table>
            <thead>
...
class SanbiSource:
    """Tender source plug-in for South African National Biodiversity Institute (SANBI)."""

    source_id: str = "sanbi_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sanbi.org/procurement"):
        self.url = url
        self.issuing_entity = "South African National Biodiversity Institute (SANBI)"
