"""Gauteng Provincial Treasury tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Provincial Treasury Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Provincial Treasury tenders</h1>
        <table>
            <thead>
...
class GautengEtendersSource:
    """Tender source plug-in for Gauteng Provincial Treasury."""
    ...
    def __init__(self, url: str = "https://etenders.gauteng.gov.za"):
        self.url = url
        self.issuing_entity = "Gauteng Provincial Treasury"
