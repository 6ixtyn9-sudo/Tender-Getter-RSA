"""North West Liquor Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Liquor Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Liquor Board tenders</h1>
        <table>
            <thead>
...
class NwLiquorSource:
    """Tender source plug-in for North West Liquor Board."""

    source_id: str = "nw_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nwliquor.co.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Liquor Board"
