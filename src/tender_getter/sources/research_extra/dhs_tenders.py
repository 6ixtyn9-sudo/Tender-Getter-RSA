"""Department of Human Settlements tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Human Settlements Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Human Settlements tenders</h1>
        <table>
            <thead>
...
class DhsSource:
    """Tender source plug-in for Department of Human Settlements."""
    ...
    def __init__(self, url: str = "https://www.dhs.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Human Settlements"
