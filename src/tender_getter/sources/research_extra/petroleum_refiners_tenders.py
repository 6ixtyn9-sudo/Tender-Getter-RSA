"""National Petroleum Refiners (Natref) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Petroleum Refiners (Natref) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Petroleum Refiners (Natref) tenders</h1>
        <table>
            <thead>
...
class PetroleumRefinersSource:
    """Tender source plug-in for National Petroleum Refiners (Natref)."""

    source_id: str = "petroleum_refiners_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.natref.co.za/procurement"):
        self.url = url
        self.issuing_entity = "National Petroleum Refiners (Natref)"
