"""Allied Health Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Allied Health Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Allied Health Council tenders</h1>
        <table>
            <thead>
...
class AlliedHealthCouncilSource:
    """Tender source plug-in for Allied Health Council."""

    source_id: str = "allied_health_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ahpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Allied Health Council"
