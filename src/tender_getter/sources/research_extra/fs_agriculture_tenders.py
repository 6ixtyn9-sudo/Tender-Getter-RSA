"""Free State Agriculture tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Agriculture Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Agriculture tenders</h1>
        <table>
            <thead>
...
class FsAgricultureSource:
    """Tender source plug-in for Free State Agriculture."""

    source_id: str = "fs_agriculture_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fsagriculture.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Agriculture"
