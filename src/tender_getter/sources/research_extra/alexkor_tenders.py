"""Alexkor SOC Ltd tender source plug-in."""
import logging
import re
...
class AlexkorSource:
    """Tender source plug-in for Alexkor SOC Ltd."""
    ...
    def __init__(self, url: str = "https://www.alexkor.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Alexkor SOC Ltd"
