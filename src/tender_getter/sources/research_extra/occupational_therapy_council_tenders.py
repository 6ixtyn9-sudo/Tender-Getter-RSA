"""OT Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>OT Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active OT Council tenders</h1>
        <table>
            <thead>
...
class OccupationalTherapyCouncilSource:
    """Tender source plug-in for OT Council."""

    source_id: str = "occupational_therapy_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.otasa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "OT Council"
