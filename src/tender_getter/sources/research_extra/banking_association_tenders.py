"""Banking Association tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Banking Association Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Banking Association tenders</h1>
        <table>
            <thead>
...
class BankingAssociationSource:
    """Tender source plug-in for Banking Association."""

    source_id: str = "banking_association_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.banking.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Banking Association"
