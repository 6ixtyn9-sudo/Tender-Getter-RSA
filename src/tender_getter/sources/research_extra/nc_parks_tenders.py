"""Northern Cape Parks tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Parks Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Parks tenders</h1>
        <table>
            <thead>
...
class NcParksSource:
    """Tender source plug-in for Northern Cape Parks."""

    source_id: str = "nc_parks_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sanparks.org/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Parks"
