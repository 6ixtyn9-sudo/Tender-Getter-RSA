"""Broadband Infraco tender source plug-in."""
import logging
import re
...
class InfracoSource:
    """Tender source plug-in for Broadband Infraco."""
    ...
    def __init__(self, url: str = "https://www.infraco.co.za/tenders/"):
        self.url = url
        self.issuing_entity = "Broadband Infraco"
