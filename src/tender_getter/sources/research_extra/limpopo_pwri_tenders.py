"""Limpopo Department of Public Works, Roads & Infrastructure tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Department of Public Works, Roads & Infrastructure Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Department of Public Works, Roads & Infrastructure tenders</h1>
        <table>
            <thead>
...
class LimpopoPwriSource:
    """Tender source plug-in for Limpopo Department of Public Works, Roads & Infrastructure."""
    ...
    def __init__(self, url: str = "https://www.ldprr.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Limpopo Department of Public Works, Roads & Infrastructure"
