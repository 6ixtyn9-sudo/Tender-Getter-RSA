"""Playhouse Company tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Playhouse Company Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Playhouse Company tenders</h1>
        <table>
            <thead>
...
class PlayhouseSource:
    """Tender source plug-in for Playhouse Company."""

    source_id: str = "playhouse_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.playhouse.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Playhouse Company"
