"""Gaming Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gaming Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gaming Board tenders</h1>
        <table>
            <thead>
...
class GamingBoardSource:
    """Tender source plug-in for Gaming Board."""

    source_id: str = "gaming_board_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gamingboard.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Gaming Board"
