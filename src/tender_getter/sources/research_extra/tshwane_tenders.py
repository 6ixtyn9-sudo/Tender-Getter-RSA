"""City of Tshwane tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>City of Tshwane Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active City of Tshwane tenders</h1>
        <table>
            <thead>
...
class TshwaneSource:
    """Tender source plug-in for City of Tshwane."""
    ...
    def __init__(self, url: str = "https://www.tshwane.gov.za/?page_id=427"):
        self.url = url
        self.issuing_entity = "City of Tshwane"
