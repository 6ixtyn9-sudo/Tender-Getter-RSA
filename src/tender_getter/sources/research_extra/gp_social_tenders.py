"""Gauteng Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Social Development tenders</h1>
        <table>
            <thead>
...
class GpSocialSource:
    """Tender source plug-in for Gauteng Social Development."""

    source_id: str = "gp_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.socialdev.gpg.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Social Development"
