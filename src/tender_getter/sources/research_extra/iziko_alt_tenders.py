"""Iziko (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Iziko (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Iziko (alt URL) tenders</h1>
        <table>
            <thead>
...
class IzikoAltSource:
    """Tender source plug-in for Iziko (alt URL)."""

    source_id: str = "iziko_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.iziko.org.za/about/procurement"):
        self.url = url
        self.issuing_entity = "Iziko (alt URL)"
