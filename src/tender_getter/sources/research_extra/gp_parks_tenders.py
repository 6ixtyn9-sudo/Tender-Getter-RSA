"""Gauteng Parks tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Parks Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Parks tenders</h1>
        <table>
            <thead>
...
class GpParksSource:
    """Tender source plug-in for Gauteng Parks."""

    source_id: str = "gp_parks_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gautengparks.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Parks"
