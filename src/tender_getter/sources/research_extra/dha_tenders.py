"""Department of Home Affairs tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Home Affairs Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Home Affairs tenders</h1>
        <table>
            <thead>
...
class DhaSource:
    """Tender source plug-in for Department of Home Affairs."""
    ...
    def __init__(self, url: str = "https://www.dha.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Home Affairs"
