"""SA Public Service Association tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SA Public Service Association Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SA Public Service Association tenders</h1>
        <table>
            <thead>
...
class SapsaAdminSource:
    """Tender source plug-in for SA Public Service Association."""

    source_id: str = "sapsa_admin_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sapsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "SA Public Service Association"
