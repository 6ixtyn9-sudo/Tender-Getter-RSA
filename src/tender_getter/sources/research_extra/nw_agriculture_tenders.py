"""North West Agriculture tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Agriculture Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Agriculture tenders</h1>
        <table>
            <thead>
...
class NwAgricultureSource:
    """Tender source plug-in for North West Agriculture."""

    source_id: str = "nw_agriculture_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.dard.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Agriculture"
