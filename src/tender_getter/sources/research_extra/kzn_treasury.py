"""KwaZulu-Natal Treasury tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KwaZulu-Natal Treasury Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KwaZulu-Natal Treasury tenders</h1>
        <table>
            <thead>
...
class KznTreasurySource:
    """Tender source plug-in for KwaZulu-Natal Treasury."""
    ...
    def __init__(self, url: str = "https://www.kzntreasury.gov.za"):
        self.url = url
        self.issuing_entity = "KwaZulu-Natal Treasury"
