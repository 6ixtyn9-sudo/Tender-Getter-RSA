"""Consumer Protection tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Consumer Protection Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Consumer Protection tenders</h1>
        <table>
            <thead>
...
class ConsumerProtectionSource:
    """Tender source plug-in for Consumer Protection."""

    source_id: str = "consumer_protection_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.thencc.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Consumer Protection"
