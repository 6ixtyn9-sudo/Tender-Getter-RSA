"""National Health Laboratory Service tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Health Laboratory Service Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Health Laboratory Service tenders</h1>
        <table>
            <thead>
...
class NhlsSource:
    """Tender source plug-in for National Health Laboratory Service."""
    ...
    def __init__(self, url: str = "https://www.nhls.ac.za/tenders"):
        self.url = url
        self.issuing_entity = "National Health Laboratory Service"
