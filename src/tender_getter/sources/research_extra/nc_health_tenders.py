"""Northern Cape Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Health tenders</h1>
        <table>
            <thead>
...
class NcHealthSource:
    """Tender source plug-in for Northern Cape Health."""

    source_id: str = "nc_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nch.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Health"
