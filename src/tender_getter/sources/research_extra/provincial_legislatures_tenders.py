"""Provincial Legislatures (collective) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Provincial Legislatures (collective) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Provincial Legislatures (collective) tenders</h1>
        <table>
            <thead>
...
class ProvincialLegislaturesSource:
    """Tender source plug-in for Provincial Legislatures (collective)."""

    source_id: str = "provincial_legislatures_tenders"
    live: bool = False

    def __init__(self, url: str = "https://provincial-legislatures.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Provincial Legislatures (collective)"
