"""Western Cape Department of Infrastructure tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Department of Infrastructure Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Department of Infrastructure tenders</h1>
        <table>
            <thead>
...
class WcdiSource:
    """Tender source plug-in for Western Cape Department of Infrastructure."""
    ...
    def __init__(self, url: str = "https://www.westerncape.gov.za/dept/infrastructure/tenders"):
        self.url = url
        self.issuing_entity = "Western Cape Department of Infrastructure"
