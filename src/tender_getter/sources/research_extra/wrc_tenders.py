"""Water Research Commission tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Water Research Commission Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Water Research Commission tenders</h1>
        <table>
            <thead>
...
class WrcSource:
    """Tender source plug-in for Water Research Commission."""
    ...
    def __init__(self, url: str = "https://www.wrc.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Water Research Commission"
