"""Small Enterprise Finance Agency tender source plug-in."""
import logging
import re
...
class SefaSource:
    """Tender source plug-in for Small Enterprise Finance Agency."""
    ...
    def __init__(self, url: str = "https://www.sefa.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Small Enterprise Finance Agency"
