...
<!DOCTYPE html>
<html>
<head><title>SABBSA Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SABBSA tenders</h1>
        <table>
            <thead>
...
class SabbsaSource:
    """Tender source plug-in for SABBSA."""

    source_id: str = "sabbsa_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sabbusiness.org.za/procurement"):
        self.url = url
        self.issuing_entity = "SABBSA"
