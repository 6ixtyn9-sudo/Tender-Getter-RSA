"""eThekwini Solid Waste Unit tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>eThekwini Solid Waste Unit Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active eThekwini Solid Waste Unit tenders</h1>
        <table>
            <thead>
...
class EthekwiniSolidWasteSource:
    """Tender source plug-in for eThekwini Solid Waste Unit."""

    source_id: str = "eThekwini_solid_waste_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.durban.gov.za/SolidWaste/procurement"):
        self.url = url
        self.issuing_entity = "eThekwini Solid Waste Unit"
