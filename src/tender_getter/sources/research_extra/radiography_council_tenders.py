"""Radiography Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Radiography Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Radiography Council tenders</h1>
        <table>
            <thead>
...
class RadiographyCouncilSource:
    """Tender source plug-in for Radiography Council."""

    source_id: str = "radiography_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.rad.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Radiography Council"
