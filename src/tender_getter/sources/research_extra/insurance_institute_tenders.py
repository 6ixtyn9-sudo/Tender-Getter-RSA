"""Insurance Institute tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Insurance Institute Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Insurance Institute tenders</h1>
        <table>
            <thead>
...
class InsuranceInstituteSource:
    """Tender source plug-in for Insurance Institute."""

    source_id: str = "insurance_institute_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.iisa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Insurance Institute"
