"""South African Heritage Resources Agency (SAHRA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Heritage Resources Agency (SAHRA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Heritage Resources Agency (SAHRA) tenders</h1>
        <table>
            <thead>
...
class SahraSource:
    """Tender source plug-in for South African Heritage Resources Agency (SAHRA)."""

    source_id: str = "sahra_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sahra.org.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Heritage Resources Agency (SAHRA)"
