"""Podiatry Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Podiatry Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Podiatry Council tenders</h1>
        <table>
            <thead>
...
class PodiatryCouncilSource:
    """Tender source plug-in for Podiatry Council."""

    source_id: str = "podiatry_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.hpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Podiatry Council"
