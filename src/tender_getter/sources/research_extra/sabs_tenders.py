"""South African Bureau of Standards tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Bureau of Standards Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Bureau of Standards tenders</h1>
        <table>
            <thead>
...
class SabsSource:
    """Tender source plug-in for South African Bureau of Standards."""
    ...
    def __init__(self, url: str = "https://www.sabs.co.za/tenders"):
        self.url = url
        self.issuing_entity = "South African Bureau of Standards"
