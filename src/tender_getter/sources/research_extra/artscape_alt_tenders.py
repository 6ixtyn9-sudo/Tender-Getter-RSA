"""Artscape (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Artscape (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Artscape (alt URL) tenders</h1>
        <table>
            <thead>
...
class ArtscapeAltSource:
    """Tender source plug-in for Artscape (alt URL)."""

    source_id: str = "artscape_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.artscape.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Artscape (alt URL)"
