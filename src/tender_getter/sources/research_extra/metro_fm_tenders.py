"""Metro FM tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Metro FM Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Metro FM tenders</h1>
        <table>
            <thead>
...
class MetroFmSource:
    """Tender source plug-in for Metro FM."""

    source_id: str = "metro_fm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.metrofm.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Metro FM"
