"""Wesgro (Western Cape) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Wesgro (Western Cape) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Wesgro (Western Cape) tenders</h1>
        <table>
            <thead>
...
class WcInvestSource:
    """Tender source plug-in for Wesgro (Western Cape)."""

    source_id: str = "wc_invest_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.wesgro.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Wesgro (Western Cape)"
