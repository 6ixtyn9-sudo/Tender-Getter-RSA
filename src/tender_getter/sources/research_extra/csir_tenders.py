"""Council for Scientific & Industrial Research tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Council for Scientific & Industrial Research Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Council for Scientific & Industrial Research tenders</h1>
        <table>
            <thead>
...
class CsirSource:
    """Tender source plug-in for Council for Scientific & Industrial Research."""
    ...
    def __init__(self, url: str = "https://www.csir.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Council for Scientific & Industrial Research"
