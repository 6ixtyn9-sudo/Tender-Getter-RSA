"""Free State Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Social Development tenders</h1>
        <table>
            <thead>
...
class FsSocialSource:
    """Tender source plug-in for Free State Social Development."""

    source_id: str = "fs_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.socdev.fs.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Social Development"
