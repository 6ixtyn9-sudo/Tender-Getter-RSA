"""LP Treasury (alt 2) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>LP Treasury (alt 2) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active LP Treasury (alt 2) tenders</h1>
        <table>
            <thead>
...
class LimpopoProvincialTreasuryAlt2Source:
    """Tender source plug-in for LP Treasury (alt 2)."""

    source_id: str = "limpopo_provincial_treasury_alt_2_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.limpopo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "LP Treasury (alt 2)"
