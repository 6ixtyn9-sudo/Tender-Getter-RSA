"""AfDB (SA rep) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>AfDB (SA rep) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active AfDB (SA rep) tenders</h1>
        <table>
            <thead>
...
class AfdbSource:
    """Tender source plug-in for AfDB (SA rep)."""

    source_id: str = "afdb_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.afdb.org/procurement"):
        self.url = url
        self.issuing_entity = "AfDB (SA rep)"
