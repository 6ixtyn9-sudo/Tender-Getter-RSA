"""Gauteng Health (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Health (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Health (alt) tenders</h1>
        <table>
            <thead>
...
class GpHealthSource:
    """Tender source plug-in for Gauteng Health (alt)."""

    source_id: str = "gp_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.health.gpg.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Health (alt)"
