"""Limpopo Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Social Development tenders</h1>
        <table>
            <thead>
...
class LpSocialSource:
    """Tender source plug-in for Limpopo Social Development."""

    source_id: str = "lp_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.dsd.limpopo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Social Development"
