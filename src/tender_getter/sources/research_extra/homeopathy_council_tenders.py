"""Homeopathy Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Homeopathy Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Homeopathy Council tenders</h1>
        <table>
            <thead>
...
class HomeopathyCouncilSource:
    """Tender source plug-in for Homeopathy Council."""

    source_id: str = "homeopathy_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ahpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Homeopathy Council"
