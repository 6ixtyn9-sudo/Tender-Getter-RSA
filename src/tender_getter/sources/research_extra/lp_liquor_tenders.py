"""Limpopo Liquor Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Liquor Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Liquor Board tenders</h1>
        <table>
            <thead>
...
class LpLiquorSource:
    """Tender source plug-in for Limpopo Liquor Board."""

    source_id: str = "lp_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.limpopollb.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Liquor Board"
