"""Pension Funds Adjudicator (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Pension Funds Adjudicator (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Pension Funds Adjudicator (alt) tenders</h1>
        <table>
            <thead>
...
class PrpaSource:
    """Tender source plug-in for Pension Funds Adjudicator (alt)."""

    source_id: str = "prpa_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.pfrfa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Pension Funds Adjudicator (alt)"
