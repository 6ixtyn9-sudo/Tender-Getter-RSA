"""Sedibeng District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sedibeng District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sedibeng District Municipality tenders</h1>
        <table>
            <thead>
...
class SedibengDmSource:
    """Tender source plug-in for Sedibeng District Municipality."""
    ...
    def __init__(self, url: str = "https://www.sedibeng.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Sedibeng District Municipality"
