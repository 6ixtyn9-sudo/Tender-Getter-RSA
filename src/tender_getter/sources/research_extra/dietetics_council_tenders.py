"""Dietetics Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Dietetics Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Dietetics Council tenders</h1>
        <table>
            <thead>
...
class DieteticsCouncilSource:
    """Tender source plug-in for Dietetics Council."""

    source_id: str = "dietetics_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.adsa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Dietetics Council"
