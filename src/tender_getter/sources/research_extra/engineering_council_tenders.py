"""ECSA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>ECSA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active ECSA (alt) tenders</h1>
        <table>
            <thead>
...
class EngineeringCouncilSource:
    """Tender source plug-in for ECSA (alt)."""

    source_id: str = "engineering_council_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ecsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "ECSA (alt)"
