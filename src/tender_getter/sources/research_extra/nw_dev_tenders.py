"""North West Development Corporation tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Development Corporation Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Development Corporation tenders</h1>
        <table>
            <thead>
...
class NwDevSource:
    """Tender source plug-in for North West Development Corporation."""

    source_id: str = "nw_dev_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nwdc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Development Corporation"
