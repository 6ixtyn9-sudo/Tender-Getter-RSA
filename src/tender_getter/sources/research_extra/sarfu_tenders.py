"""South African Rugby Football Union (Federation) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Rugby Football Union (Federation) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Rugby Football Union (Federation) tenders</h1>
        <table>
            <thead>
...
class SarfuSource:
    """Tender source plug-in for South African Rugby Football Union (Federation)."""

    source_id: str = "sarfu_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sarugby.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Rugby Football Union (Federation)"
