"""Limpopo Provincial Treasury tender source plug-in."""
import logging
import re
...
class LimpopoSource:
    """Tender source plug-in for Limpopo Provincial Treasury."""
    ...
    def __init__(self, url: str = "https://www.limtreasury.gov.za/lim_admin_trea/pages/sites/tender_documents/index.php"):
        self.url = url
        self.issuing_entity = "Limpopo Provincial Treasury"
