"""Department of Agriculture, Land Reform & Rural Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Agriculture, Land Reform & Rural Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Agriculture, Land Reform & Rural Development tenders</h1>
        <table>
            <thead>
...
class DalrrdSource:
    """Tender source plug-in for Department of Agriculture, Land Reform & Rural Development."""
    ...
    def __init__(self, url: str = "https://www.dalrrd.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Agriculture, Land Reform & Rural Development"
