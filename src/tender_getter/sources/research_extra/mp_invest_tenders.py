"""Mpumalanga Investment tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Investment Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Investment tenders</h1>
        <table>
            <thead>
...
class MpInvestSource:
    """Tender source plug-in for Mpumalanga Investment."""

    source_id: str = "mp_invest_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mpi.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Investment"
