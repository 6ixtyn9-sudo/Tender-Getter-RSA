"""Ehlanzeni District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ehlanzeni District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ehlanzeni District Municipality tenders</h1>
        <table>
            <thead>
...
class EhlanzeniSource:
    """Tender source plug-in for Ehlanzeni District Municipality."""
    ...
    def __init__(self, url: str = "https://www.ehlanzeni.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ehlanzeni District Municipality"
