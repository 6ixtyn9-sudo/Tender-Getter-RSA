"""Gauteng Department of Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Department of Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Department of Health tenders</h1>
        <table>
            <thead>
...
class GdhSource:
    """Tender source plug-in for Gauteng Department of Health."""
    ...
    def __init__(self, url: str = "https://www.health.gpg.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Gauteng Department of Health"
