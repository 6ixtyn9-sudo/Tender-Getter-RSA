...
<!DOCTYPE html>
<html>
<head><title>NRF (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NRF (alt) tenders</h1>
        <table>
            <thead>
...
class NrfAltSource:
    """Tender source plug-in for NRF (alt)."""

    source_id: str = "nrf_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nrf.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "NRF (alt)"
