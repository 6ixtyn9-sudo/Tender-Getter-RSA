"""Provincial Licensing Practitioners tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Provincial Licensing Practitioners Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Provincial Licensing Practitioners tenders</h1>
        <table>
            <thead>
...
class PlpSource:
    """Tender source plug-in for Provincial Licensing Practitioners."""

    source_id: str = "plp_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.plp.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Provincial Licensing Practitioners"
