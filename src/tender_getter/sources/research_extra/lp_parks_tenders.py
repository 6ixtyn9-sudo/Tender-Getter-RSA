"""Limpopo Parks Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Parks Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Parks Board tenders</h1>
        <table>
            <thead>
...
class LpParksSource:
    """Tender source plug-in for Limpopo Parks Board."""

    source_id: str = "lp_parks_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.limpopoparks.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Parks Board"
