"""Eastern Cape Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Social Development tenders</h1>
        <table>
            <thead>
...
class EcSocialSource:
    """Tender source plug-in for Eastern Cape Social Development."""

    source_id: str = "ec_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ecsd.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Social Development"
