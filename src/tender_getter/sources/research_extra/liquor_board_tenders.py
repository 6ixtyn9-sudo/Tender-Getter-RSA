"""Liquor Board (collective) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Liquor Board (collective) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Liquor Board (collective) tenders</h1>
        <table>
            <thead>
...
class LiquorBoardSource:
    """Tender source plug-in for Liquor Board (collective)."""

    source_id: str = "liquor_board_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.liquorboard.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Liquor Board (collective)"
