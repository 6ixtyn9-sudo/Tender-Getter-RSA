"""Fidelity ADT (public procurement) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Fidelity ADT (public procurement) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Fidelity ADT (public procurement) tenders</h1>
        <table>
            <thead>
...
class FidelitySource:
    """Tender source plug-in for Fidelity ADT (public procurement)."""

    source_id: str = "fidelity_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fidelity-adt.com/procurement"):
        self.url = url
        self.issuing_entity = "Fidelity ADT (public procurement)"
