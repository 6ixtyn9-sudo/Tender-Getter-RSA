"""Magalies Water tender source plug-in."""
import logging
import re
...
class MagaliesWaterSource:
    """Tender source plug-in for Magalies Water."""
    ...
    def __init__(self, url: str = "https://www.magalieswater.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Magalies Water"
