...
<!DOCTYPE html>
<html>
<head><title>ICA (SA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active ICA (SA) tenders</h1>
        <table>
            <thead>
...
class IcaSource:
    """Tender source plug-in for ICA (SA)."""

    source_id: str = "ica_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ica.org.za/procurement"):
        self.url = url
        self.issuing_entity = "ICA (SA)"
