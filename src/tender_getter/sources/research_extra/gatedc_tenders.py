"""Gauteng Enterprise Propeller / TIK tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Enterprise Propeller / TIK Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Enterprise Propeller / TIK tenders</h1>
        <table>
            <thead>
...
class GatedcSource:
    """Tender source plug-in for Gauteng Enterprise Propeller / TIK."""

    source_id: str = "gatedc_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.tia.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Enterprise Propeller / TIK"
