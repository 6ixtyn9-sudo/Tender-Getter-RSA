"""KwaZulu-Natal Tourism Authority tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KwaZulu-Natal Tourism Authority Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KwaZulu-Natal Tourism Authority tenders</h1>
        <table>
            <thead>
...
class KznTourismSource:
    """Tender source plug-in for KwaZulu-Natal Tourism Authority."""

    source_id: str = "kzn_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.zulu.org.za/procurement"):
        self.url = url
        self.issuing_entity = "KwaZulu-Natal Tourism Authority"
