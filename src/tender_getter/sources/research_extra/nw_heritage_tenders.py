"""North West Heritage Foundation tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Heritage Foundation Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Heritage Foundation tenders</h1>
        <table>
            <thead>
...
class NwHeritageSource:
    """Tender source plug-in for North West Heritage Foundation."""

    source_id: str = "nw_heritage_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nwhf.co.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Heritage Foundation"
