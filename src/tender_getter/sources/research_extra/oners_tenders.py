"""Office of the Registrar of Agricultural Inputs tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Office of the Registrar of Agricultural Inputs Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Office of the Registrar of Agricultural Inputs tenders</h1>
        <table>
            <thead>
...
class OnersSource:
    """Tender source plug-in for Office of the Registrar of Agricultural Inputs."""

    source_id: str = "oners_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fertilizer-assoc.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Office of the Registrar of Agricultural Inputs"
