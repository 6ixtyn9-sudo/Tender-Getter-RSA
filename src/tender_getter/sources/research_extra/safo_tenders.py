"""SA Federation of Oil Trading Companies tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SA Federation of Oil Trading Companies Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SA Federation of Oil Trading Companies tenders</h1>
        <table>
            <thead>
...
class SafoSource:
    """Tender source plug-in for SA Federation of Oil Trading Companies."""

    source_id: str = "safo_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.safo.co.za/procurement"):
        self.url = url
        self.issuing_entity = "SA Federation of Oil Trading Companies"
