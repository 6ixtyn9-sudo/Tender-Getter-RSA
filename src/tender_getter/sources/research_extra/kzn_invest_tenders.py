"""Trade and Investment KZN (TIK) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Trade and Investment KZN (TIK) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Trade and Investment KZN (TIK) tenders</h1>
        <table>
            <thead>
...
class KznInvestSource:
    """Tender source plug-in for Trade and Investment KZN (TIK)."""

    source_id: str = "kzn_invest_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tikzn.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Trade and Investment KZN (TIK)"
