"""KZN Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Health tenders</h1>
        <table>
            <thead>
...
class KznHealthSource:
    """Tender source plug-in for KZN Health."""

    source_id: str = "kzn_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.kznhealth.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Health"
