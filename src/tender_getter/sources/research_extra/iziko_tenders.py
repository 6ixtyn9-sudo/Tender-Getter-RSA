"""Iziko Museums of South Africa tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Iziko Museums of South Africa Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Iziko Museums of South Africa tenders</h1>
        <table>
            <thead>
...
class IzikoSource:
    """Tender source plug-in for Iziko Museums of South Africa."""

    source_id: str = "iziko_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.iziko.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Iziko Museums of South Africa"
