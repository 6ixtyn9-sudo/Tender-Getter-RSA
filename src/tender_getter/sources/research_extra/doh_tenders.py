"""Department of Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Health tenders</h1>
        <table>
            <thead>
...
class DohSource:
    """Tender source plug-in for Department of Health."""
    ...
    def __init__(self, url: str = "https://www.health.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Health"
