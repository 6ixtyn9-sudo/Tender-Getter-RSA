"""Free State Heritage tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Heritage Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Heritage tenders</h1>
        <table>
            <thead>
...
class FsHeritageSource:
    """Tender source plug-in for Free State Heritage."""

    source_id: str = "fs_heritage_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fsheritage.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Heritage"
