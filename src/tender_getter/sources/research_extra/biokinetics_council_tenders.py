"""Biokinetics Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Biokinetics Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Biokinetics Council tenders</h1>
        <table>
            <thead>
...
class BiokineticsCouncilSource:
    """Tender source plug-in for Biokinetics Council."""

    source_id: str = "biokinetics_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.biokinetics.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Biokinetics Council"
