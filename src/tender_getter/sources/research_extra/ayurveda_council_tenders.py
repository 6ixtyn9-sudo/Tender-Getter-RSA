"""Ayurveda Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ayurveda Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ayurveda Council tenders</h1>
        <table>
            <thead>
...
class AyurvedaCouncilSource:
    """Tender source plug-in for Ayurveda Council."""

    source_id: str = "ayurveda_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ahpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ayurveda Council"
