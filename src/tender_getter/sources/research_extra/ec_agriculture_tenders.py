"""Eastern Cape Agriculture tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Agriculture Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Agriculture tenders</h1>
        <table>
            <thead>
...
class EcAgricultureSource:
    """Tender source plug-in for Eastern Cape Agriculture."""

    source_id: str = "ec_agriculture_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ecagriculture.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Agriculture"
