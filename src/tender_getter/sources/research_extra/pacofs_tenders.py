"""Performing Arts Centre of the Free State (PACOFS) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Performing Arts Centre of the Free State (PACOFS) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Performing Arts Centre of the Free State (PACOFS) tenders</h1>
        <table>
            <thead>
...
class PacofsSource:
    """Tender source plug-in for Performing Arts Centre of the Free State (PACOFS)."""

    source_id: str = "pacofs_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.pacofs.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Performing Arts Centre of the Free State (PACOFS)"
