"""State Information Technology Agency (SITA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>State Information Technology Agency (SITA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active State Information Technology Agency (SITA) tenders</h1>
        <table>
            <thead>
...
class SitaSource:
    """Tender source plug-in for State Information Technology Agency (SITA)."""
    ...
    def __init__(self, url: str = "https://www.sita.co.za/tenders"):
        self.url = url
        self.issuing_entity = "State Information Technology Agency (SITA)"
