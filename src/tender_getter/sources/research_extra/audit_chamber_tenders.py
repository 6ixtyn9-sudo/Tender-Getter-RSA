"""Auditor Chamber tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Auditor Chamber Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Auditor Chamber tenders</h1>
        <table>
            <thead>
...
class AuditChamberSource:
    """Tender source plug-in for Auditor Chamber."""

    source_id: str = "audit_chamber_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.irba.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Auditor Chamber"
