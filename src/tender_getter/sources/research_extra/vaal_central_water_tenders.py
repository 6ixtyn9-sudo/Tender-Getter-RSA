"""Vaal Central Water (merged: Bloem + Sedibeng + Lepelle) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Vaal Central Water (merged: Bloem + Sedibeng + Lepelle) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Vaal Central Water (merged: Bloem + Sedibeng + Lepelle) tenders</h1>
        <table>
            <thead>
...
class VaalCentralWaterSource:
    """Tender source plug-in for Vaal Central Water (merged: Bloem + Sedibeng + Lepelle)."""

    source_id: str = "vaal_central_water_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.vaalcentralwater.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Vaal Central Water (merged: Bloem + Sedibeng + Lepelle)"
