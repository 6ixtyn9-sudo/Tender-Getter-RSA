"""KwaZulu-Natal Department of Transport tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KwaZulu-Natal Department of Transport Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KwaZulu-Natal Department of Transport tenders</h1>
        <table>
            <thead>
...
class KznDotSource:
    """Tender source plug-in for KwaZulu-Natal Department of Transport."""
    ...
    def __init__(self, url: str = "https://www.kzntransport.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "KwaZulu-Natal Department of Transport"
