"""Chiro Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Chiro Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Chiro Council tenders</h1>
        <table>
            <thead>
...
class ChiroPractitionerSource:
    """Tender source plug-in for Chiro Council."""

    source_id: str = "chiro_practitioner_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ahpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Chiro Council"
