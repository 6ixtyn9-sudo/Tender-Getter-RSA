"""Independent Institute of Technology tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Independent Institute of Technology Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Independent Institute of Technology tenders</h1>
        <table>
            <thead>
...
class IitSource:
    """Tender source plug-in for Independent Institute of Technology."""

    source_id: str = "iit_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.iit.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Independent Institute of Technology"
