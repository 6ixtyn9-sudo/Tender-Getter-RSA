"""Eastern Cape Liquor Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Liquor Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Liquor Board tenders</h1>
        <table>
            <thead>
...
class EcLiquorSource:
    """Tender source plug-in for Eastern Cape Liquor Board."""

    source_id: str = "ec_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.eclb.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Liquor Board"
