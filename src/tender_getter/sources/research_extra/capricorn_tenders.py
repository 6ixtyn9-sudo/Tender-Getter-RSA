"""Capricorn District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Capricorn District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Capricorn District Municipality tenders</h1>
        <table>
            <thead>
...
class CapricornSource:
    """Tender source plug-in for Capricorn District Municipality."""
    ...
    def __init__(self, url: str = "https://www.cdm.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Capricorn District Municipality"
