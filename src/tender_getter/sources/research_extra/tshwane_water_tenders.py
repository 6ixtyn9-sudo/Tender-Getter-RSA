"""City of Tshwane Water and Sanitation Division tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>City of Tshwane Water and Sanitation Division Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active City of Tshwane Water and Sanitation Division tenders</h1>
        <table>
            <thead>
...
class TshwaneWaterSource:
    """Tender source plug-in for City of Tshwane Water and Sanitation Division."""

    source_id: str = "tshwane_water_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tshwane.gov.za/water/procurement"):
        self.url = url
        self.issuing_entity = "City of Tshwane Water and Sanitation Division"
