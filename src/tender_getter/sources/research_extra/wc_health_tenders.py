"""Western Cape Department of Health & Wellness tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Department of Health & Wellness Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Department of Health & Wellness tenders</h1>
        <table>
            <thead>
...
class WcHealthSource:
    """Tender source plug-in for Western Cape Department of Health & Wellness."""
    ...
    def __init__(self, url: str = "https://www.westerncape.gov.za/dept/health/tenders"):
        self.url = url
        self.issuing_entity = "Western Cape Department of Health & Wellness"
