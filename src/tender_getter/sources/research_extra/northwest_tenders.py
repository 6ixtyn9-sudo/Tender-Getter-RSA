"""North West Provincial Treasury tender source plug-in."""
import logging
import re
...
class NorthwestSource:
    """Tender source plug-in for North West Provincial Treasury."""
    ...
    def __init__(self, url: str = "http://www.nwpg.gov.za/Treasury/Tenders.asp"):
        self.url = url
        self.issuing_entity = "North West Provincial Treasury"
