"""Eastern Cape Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Health tenders</h1>
        <table>
            <thead>
...
class EcHealthSource:
    """Tender source plug-in for Eastern Cape Health."""

    source_id: str = "ec_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.echealth.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Health"
