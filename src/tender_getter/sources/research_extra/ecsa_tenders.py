...
<!DOCTYPE html>
<html>
<head><title>ECSA Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active ECSA tenders</h1>
        <table>
            <thead>
...
class EcsaSource:
    """Tender source plug-in for ECSA."""

    source_id: str = "ecsa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ecsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "ECSA"
