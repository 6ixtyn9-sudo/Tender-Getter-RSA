"""KFM Radio tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KFM Radio Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KFM Radio tenders</h1>
        <table>
            <thead>
...
class KfmSource:
    """Tender source plug-in for KFM Radio."""

    source_id: str = "kfm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kfm.co.za/procurement"):
        self.url = url
        self.issuing_entity = "KFM Radio"
