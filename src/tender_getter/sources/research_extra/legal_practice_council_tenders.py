"""Legal Practice Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Legal Practice Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Legal Practice Council tenders</h1>
        <table>
            <thead>
...
class LegalPracticeCouncilSource:
    """Tender source plug-in for Legal Practice Council."""

    source_id: str = "legal_practice_council_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.lpc.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Legal Practice Council"
