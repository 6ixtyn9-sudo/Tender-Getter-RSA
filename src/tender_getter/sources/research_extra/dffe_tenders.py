"""Department of Forestry, Fisheries & the Environment tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Forestry, Fisheries & the Environment Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Forestry, Fisheries & the Environment tenders</h1>
        <table>
            <thead>
...
class DffeSource:
    """Tender source plug-in for Department of Forestry, Fisheries & the Environment."""
    ...
    def __init__(self, url: str = "https://www.dffe.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Forestry, Fisheries & the Environment"
