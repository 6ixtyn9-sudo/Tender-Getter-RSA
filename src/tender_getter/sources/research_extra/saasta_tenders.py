"""South African Agency for Science and Technology Advancement (SAASTA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Agency for Science and Technology Advancement (SAASTA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Agency for Science and Technology Advancement (SAASTA) tenders</h1>
        <table>
            <thead>
...
class SaastaSource:
    """Tender source plug-in for South African Agency for Science and Technology Advancement (SAASTA)."""

    source_id: str = "saasta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.saasta.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Agency for Science and Technology Advancement (SAASTA)"
