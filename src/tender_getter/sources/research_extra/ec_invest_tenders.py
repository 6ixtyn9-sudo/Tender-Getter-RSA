"""Eastern Cape Investment Agency tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Investment Agency Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Investment Agency tenders</h1>
        <table>
            <thead>
...
class EcInvestSource:
    """Tender source plug-in for Eastern Cape Investment Agency."""

    source_id: str = "ec_invest_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ecsecc.org/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Investment Agency"
