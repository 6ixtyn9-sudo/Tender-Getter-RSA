"""North West Parks Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Parks Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Parks Board tenders</h1>
        <table>
            <thead>
...
class NwParksSource:
    """Tender source plug-in for North West Parks Board."""

    source_id: str = "nw_parks_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nwparks.org.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Parks Board"
