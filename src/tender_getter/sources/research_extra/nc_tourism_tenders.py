"""Northern Cape Tourism Authority tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Tourism Authority Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Tourism Authority tenders</h1>
        <table>
            <thead>
...
class NcTourismSource:
    """Tender source plug-in for Northern Cape Tourism Authority."""

    source_id: str = "nc_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.experiencenortherncape.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Tourism Authority"
