...
<!DOCTYPE html>
<html>
<head><title>PSP Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active PSP tenders</h1>
        <table>
            <thead>
...
class PspSource:
    """Tender source plug-in for PSP."""

    source_id: str = "psp_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.psp.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "PSP"
