"""Department of Communications & Digital Technologies tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Communications & Digital Technologies Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Communications & Digital Technologies tenders</h1>
        <table>
            <thead>
...
class DcdtSource:
    """Tender source plug-in for Department of Communications & Digital Technologies."""
    ...
    def __init__(self, url: str = "https://www.dcdt.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Communications & Digital Technologies"
