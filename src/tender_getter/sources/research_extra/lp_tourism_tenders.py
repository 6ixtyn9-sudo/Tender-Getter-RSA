"""Limpopo Tourism Authority tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Tourism Authority Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Tourism Authority tenders</h1>
        <table>
            <thead>
...
class LpTourismSource:
    """Tender source plug-in for Limpopo Tourism Authority."""

    source_id: str = "lp_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.golimpopo.com/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Tourism Authority"
