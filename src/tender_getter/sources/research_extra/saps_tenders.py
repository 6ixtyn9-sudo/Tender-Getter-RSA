"""South African Police Service tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Police Service Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Police Service tenders</h1>
        <table>
            <thead>
...
class SapsSource:
    """Tender source plug-in for South African Police Service."""
    ...
    def __init__(self, url: str = "https://www.saps.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "South African Police Service"
