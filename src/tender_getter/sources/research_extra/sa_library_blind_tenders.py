"""South African Library for the Blind tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Library for the Blind Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Library for the Blind tenders</h1>
        <table>
            <thead>
...
class SaLibraryBlindSource:
    """Tender source plug-in for South African Library for the Blind."""

    source_id: str = "sa_library_blind_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.salb.org.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Library for the Blind"
