"""OR Tambo District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>OR Tambo District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active OR Tambo District Municipality tenders</h1>
        <table>
            <thead>
...
class OrTamboSource:
    """Tender source plug-in for OR Tambo District Municipality."""
    ...
    def __init__(self, url: str = "https://www.ortambodm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "OR Tambo District Municipality"
