"""PPRA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>PPRA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active PPRA (alt) tenders</h1>
        <table>
            <thead>
...
class PropertyPractitionersSource:
    """Tender source plug-in for PPRA (alt)."""

    source_id: str = "property_practitioners_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ppra.org.za/procurement"):
        self.url = url
        self.issuing_entity = "PPRA (alt)"
