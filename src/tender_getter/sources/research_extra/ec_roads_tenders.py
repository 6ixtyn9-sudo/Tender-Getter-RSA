"""Eastern Cape Roads Agency tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Roads Agency Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Roads Agency tenders</h1>
        <table>
            <thead>
...
class EcRoadsSource:
    """Tender source plug-in for Eastern Cape Roads Agency."""

    source_id: str = "ec_roads_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ecra.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Roads Agency"
