"""Department of Small Business Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Small Business Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Small Business Development tenders</h1>
        <table>
            <thead>
...
class DsbdSource:
    """Tender source plug-in for Department of Small Business Development."""
    ...
    def __init__(self, url: str = "https://www.dsbd.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Small Business Development"
