"""Robben Island Museum tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Robben Island Museum Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Robben Island Museum tenders</h1>
        <table>
            <thead>
...
class RobbenIslandSource:
    """Tender source plug-in for Robben Island Museum."""

    source_id: str = "robben_island_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.robben-island.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Robben Island Museum"
