...
<!DOCTYPE html>
<html>
<head><title>MPSA Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active MPSA tenders</h1>
        <table>
            <thead>
...
class MpsaSource:
    """Tender source plug-in for MPSA."""

    source_id: str = "mpsa_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mpsa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "MPSA"
