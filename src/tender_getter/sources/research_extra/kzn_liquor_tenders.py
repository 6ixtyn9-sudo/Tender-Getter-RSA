"""KZN Liquor Authority tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Liquor Authority Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Liquor Authority tenders</h1>
        <table>
            <thead>
...
class KznLiquorSource:
    """Tender source plug-in for KZN Liquor Authority."""

    source_id: str = "kzn_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kznliquor.co.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Liquor Authority"
