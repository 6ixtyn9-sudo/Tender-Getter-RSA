"""KZN Agriculture and Rural Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Agriculture and Rural Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Agriculture and Rural Development tenders</h1>
        <table>
            <thead>
...
class KznAgricultureSource:
    """Tender source plug-in for KZN Agriculture and Rural Development."""

    source_id: str = "kzn_agriculture_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.kzndard.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Agriculture and Rural Development"
