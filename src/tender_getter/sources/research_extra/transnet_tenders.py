"""Transnet eTenders tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Transnet eTenders Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Transnet eTenders tenders</h1>
        <table>
            <thead>
...
class TransnetSource:
    """Tender source plug-in for Transnet eTenders."""
    ...
    def __init__(self, url: str = "https://transnetetenders.azurewebsites.net/"):
        self.url = url
        self.issuing_entity = "Transnet eTenders"
