"""Free State Investment tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Investment Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Investment tenders</h1>
        <table>
            <thead>
...
class FsInvestSource:
    """Tender source plug-in for Free State Investment."""

    source_id: str = "fs_invest_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fsinvest.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Investment"
