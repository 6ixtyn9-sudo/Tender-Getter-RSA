"""KwaZulu-Natal Department of Human Settlements tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KwaZulu-Natal Department of Human Settlements Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KwaZulu-Natal Department of Human Settlements tenders</h1>
        <table>
            <thead>
...
class KznHumanSettlementsSource:
    """Tender source plug-in for KwaZulu-Natal Department of Human Settlements."""
    ...
    def __init__(self, url: str = "https://www.kznsethuman.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "KwaZulu-Natal Department of Human Settlements"
