"""Umgeni Water (legacy – merged into uMngeni-uThukela) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Umgeni Water (legacy – merged into uMngeni-uThukela) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Umgeni Water (legacy – merged into uMngeni-uThukela) tenders</h1>
        <table>
            <thead>
...
class UmgeniWaterSource:
    """Tender source plug-in for Umgeni Water (legacy – merged into uMngeni-uThukela)."""
    ...
    def __init__(self, url: str = "https://www.umgeni.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Umgeni Water (legacy – merged into uMngeni-uThukela)"
