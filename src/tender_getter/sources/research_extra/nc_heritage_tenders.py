"""Northern Cape Heritage tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Heritage Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Heritage tenders</h1>
        <table>
            <thead>
...
class NcHeritageSource:
    """Tender source plug-in for Northern Cape Heritage."""

    source_id: str = "nc_heritage_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.noordelike-erfenis.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Heritage"
