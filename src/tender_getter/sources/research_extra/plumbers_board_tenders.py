"""Plumbers Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Plumbers Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Plumbers Board tenders</h1>
        <table>
            <thead>
...
class PlumbersBoardSource:
    """Tender source plug-in for Plumbers Board."""

    source_id: str = "plumbers_board_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.iop.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Plumbers Board"
