"""Mpumalanga Department of Education tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Department of Education Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Department of Education tenders</h1>
        <table>
            <thead>
...
class MpumalangaEducationSource:
    """Tender source plug-in for Mpumalanga Department of Education."""
    ...
    def __init__(self, url: str = "https://www.mpumalanga.gov.za/education/tenders"):
        self.url = url
        self.issuing_entity = "Mpumalanga Department of Education"
