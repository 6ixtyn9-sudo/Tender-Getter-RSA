"""National Treasury eTenders OCDS API tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Treasury eTenders OCDS API Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Treasury eTenders OCDS API tenders</h1>
        <table>
            <thead>
...
class EtendersOcdsSource:
    """Tender source plug-in for National Treasury eTenders OCDS API."""

    source_id: str = "etenders_ocds"
    live: bool = True

    def __init__(self, url: str = "https://ocds-api.etenders.gov.za"):
        self.url = url
        self.issuing_entity = "National Treasury eTenders OCDS API"
