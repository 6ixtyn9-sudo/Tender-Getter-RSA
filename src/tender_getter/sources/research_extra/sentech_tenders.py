"""Sentech SOC Ltd tender source plug-in."""
import logging
import re
...
class SentechSource:
    """Tender source plug-in for Sentech SOC Ltd."""
    ...
    def __init__(self, url: str = "https://www.sentech.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Sentech SOC Ltd"
