"""Cape Winelands District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Cape Winelands District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Cape Winelands District Municipality tenders</h1>
        <table>
            <thead>
...
class CapeWinelandsSource:
    """Tender source plug-in for Cape Winelands District Municipality."""
    ...
    def __init__(self, url: str = "https://www.capewinelands.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Cape Winelands District Municipality"
