...
<!DOCTYPE html>
<html>
<head><title>POPCRU Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active POPCRU tenders</h1>
        <table>
            <thead>
...
class PopcruSource:
    """Tender source plug-in for POPCRU."""

    source_id: str = "popcru_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.popcru.org.za/procurement"):
        self.url = url
        self.issuing_entity = "POPCRU"
