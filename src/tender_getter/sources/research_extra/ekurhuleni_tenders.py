"""Ekurhuleni Metropolitan Municipality tender source plug-in."""
import logging
import re
...
class EkurhuleniSource:
    """Tender source plug-in for Ekurhuleni Metropolitan Municipality."""
