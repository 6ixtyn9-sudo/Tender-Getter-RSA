"""Traditional Healers Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Traditional Healers Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Traditional Healers Council tenders</h1>
        <table>
            <thead>
...
class TraditionalHealersCouncilSource:
    """Tender source plug-in for Traditional Healers Council."""

    source_id: str = "traditional_healers_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.iingsa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Traditional Healers Council"
