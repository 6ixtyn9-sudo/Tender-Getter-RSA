"""Mpumalanga Roads Agency tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Roads Agency Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Roads Agency tenders</h1>
        <table>
            <thead>
...
class MpRoadsSource:
    """Tender source plug-in for Mpumalanga Roads Agency."""

    source_id: str = "mp_roads_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mraa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Roads Agency"
