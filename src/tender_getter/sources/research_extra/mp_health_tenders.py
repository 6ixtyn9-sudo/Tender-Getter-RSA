"""Mpumalanga Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Health tenders</h1>
        <table>
            <thead>
...
class MpHealthSource:
    """Tender source plug-in for Mpumalanga Health."""

    source_id: str = "mp_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mpuhealth.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Health"
