"""Northern Cape Housing tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Housing Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Housing tenders</h1>
        <table>
            <thead>
...
class NcHousingSource:
    """Tender source plug-in for Northern Cape Housing."""

    source_id: str = "nc_housing_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nchousing.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Housing"
