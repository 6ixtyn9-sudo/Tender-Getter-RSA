"""Western Cape Heritage tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Heritage Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Heritage tenders</h1>
        <table>
            <thead>
...
class WcHeritageSource:
    """Tender source plug-in for Western Cape Heritage."""

    source_id: str = "wc_heritage_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.wesgro.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Heritage"
