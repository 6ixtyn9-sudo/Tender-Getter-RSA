"""Electricians Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Electricians Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Electricians Board tenders</h1>
        <table>
            <thead>
...
class ElectriciansBoardSource:
    """Tender source plug-in for Electricians Board."""

    source_id: str = "electricians_board_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ieb.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Electricians Board"
