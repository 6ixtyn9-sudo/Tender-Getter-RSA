"""National Heritage Council (NHC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Heritage Council (NHC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Heritage Council (NHC) tenders</h1>
        <table>
            <thead>
...
class NhcSource:
    """Tender source plug-in for National Heritage Council (NHC)."""

    source_id: str = "nhc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nhc.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Heritage Council (NHC)"
