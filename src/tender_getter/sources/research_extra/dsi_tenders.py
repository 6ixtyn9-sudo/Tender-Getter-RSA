"""Department of Science & Innovation tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Science & Innovation Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Science & Innovation tenders</h1>
        <table>
            <thead>
...
class DsiSource:
    """Tender source plug-in for Department of Science & Innovation."""
    ...
    def __init__(self, url: str = "https://www.dst.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Science & Innovation"
