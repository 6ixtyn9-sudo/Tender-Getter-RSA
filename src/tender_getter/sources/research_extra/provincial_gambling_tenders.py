"""Provincial Gambling tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Provincial Gambling Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Provincial Gambling tenders</h1>
        <table>
            <thead>
...
class ProvincialGamblingSource:
    """Tender source plug-in for Provincial Gambling."""

    source_id: str = "provincial_gambling_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.provgambling.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Provincial Gambling"
