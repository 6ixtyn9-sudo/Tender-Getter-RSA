"""GP Tourism tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>GP Tourism Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active GP Tourism tenders</h1>
        <table>
            <thead>
...
class GpTourismSource:
    """Tender source plug-in for GP Tourism."""

    source_id: str = "gp_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gautengtourism.co.za/procurement"):
        self.url = url
        self.issuing_entity = "GP Tourism"
