"""KZN Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Social Development tenders</h1>
        <table>
            <thead>
...
class KznSocialSource:
    """Tender source plug-in for KZN Social Development."""

    source_id: str = "kzn_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kzndsd.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Social Development"
