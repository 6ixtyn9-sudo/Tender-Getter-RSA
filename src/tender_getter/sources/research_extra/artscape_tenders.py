"""Artscape tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Artscape Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Artscape tenders</h1>
        <table>
            <thead>
...
class ArtscapeSource:
    """Tender source plug-in for Artscape."""

    source_id: str = "artscape_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.artscape.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Artscape"
