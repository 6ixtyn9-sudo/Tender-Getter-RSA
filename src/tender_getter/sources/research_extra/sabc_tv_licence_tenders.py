"""SABC TV Licence tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SABC TV Licence Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SABC TV Licence tenders</h1>
        <table>
            <thead>
...
class SabcTvLicenceSource:
    """Tender source plug-in for SABC TV Licence."""

    source_id: str = "sabc_tv_licence_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.tvlicence.co.za/procurement"):
        self.url = url
        self.issuing_entity = "SABC TV Licence"
