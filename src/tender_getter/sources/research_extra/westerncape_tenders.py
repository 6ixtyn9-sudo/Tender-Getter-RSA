"""Western Cape Government Tenders tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Government Tenders Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Government Tenders tenders</h1>
        <table>
            <thead>
...
class WesterncapeSource:
    """Tender source plug-in for Western Cape Government Tenders."""
    ...
    def __init__(self, url: str = "https://www.westerncape.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Western Cape Government Tenders"
