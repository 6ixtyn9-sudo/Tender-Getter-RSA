"""Northern Cape Provincial Treasury tender source plug-in."""
import logging
import re
...
class NortherncapeSource:
    """Tender source plug-in for Northern Cape Provincial Treasury."""
    ...
    def __init__(self, url: str = "https://nctreasury.ncpg.gov.za/index.php/tenders"):
        self.url = url
        self.issuing_entity = "Northern Cape Provincial Treasury"
