"""City of Cape Town tender source plug-in."""
import logging
import re
...
class CapetownSource:
    """Tender source plug-in for City of Cape Town."""
    ...
    def __init__(self, url: str = "https://web1.capetown.gov.za/web1/TenderPortal/"):
        self.url = url
        self.issuing_entity = "City of Cape Town"
