"""South African National Parks tender source plug-in."""
import logging
import re
...
class SanparksSource:
    """Tender source plug-in for South African National Parks."""
    ...
    def __init__(self, url: str = "https://www.sanparks.org/about/doing_business/tenders"):
        self.url = url
        self.issuing_entity = "South African National Parks"
