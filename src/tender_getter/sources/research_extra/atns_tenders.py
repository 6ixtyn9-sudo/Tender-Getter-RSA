"""Air Traffic & Navigation Services tender source plug-in."""
import logging
import re
...
class AtnsSource:
    """Tender source plug-in for Air Traffic & Navigation Services."""
    ...
    def __init__(self, url: str = "https://www.atns.com/tenders"):
        self.url = url
        self.issuing_entity = "Air Traffic & Navigation Services"
