"""Provincial Lottery tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Provincial Lottery Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Provincial Lottery tenders</h1>
        <table>
            <thead>
...
class ProvincialLotterySource:
    """Tender source plug-in for Provincial Lottery."""

    source_id: str = "provincial_lottery_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.provincial-lottery.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Provincial Lottery"
