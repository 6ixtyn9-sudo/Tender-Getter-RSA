"""Passenger Rail Agency of South Africa (PRASA) tender source plug-in."""
import logging
import re
...
class PrasaSource:
    """Tender source plug-in for Passenger Rail Agency of South Africa (PRASA)."""
    ...
    def __init__(self, url: str = "https://www.prasa.com/tenders"):
        self.url = url
        self.issuing_entity = "Passenger Rail Agency of South Africa (PRASA)"
