"""Department of Basic Education tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Basic Education Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Basic Education tenders</h1>
        <table>
            <thead>
...
class DbeSource:
    """Tender source plug-in for Department of Basic Education."""
    ...
    def __init__(self, url: str = "https://www.education.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Basic Education"
