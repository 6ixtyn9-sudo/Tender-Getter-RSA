"""Council for Geoscience (already in research/) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Council for Geoscience (already in research/) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Council for Geoscience (already in research/) tenders</h1>
        <table>
            <thead>
...
class CgsSource:
    """Tender source plug-in for Council for Geoscience (already in research/)."""

    source_id: str = "cgs_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.geoscience.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Council for Geoscience (already in research/)"
