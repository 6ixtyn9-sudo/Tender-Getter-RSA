"""Osteopathy Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Osteopathy Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Osteopathy Council tenders</h1>
        <table>
            <thead>
...
class OsteopathyCouncilSource:
    """Tender source plug-in for Osteopathy Council."""

    source_id: str = "osteopathy_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ahpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Osteopathy Council"
