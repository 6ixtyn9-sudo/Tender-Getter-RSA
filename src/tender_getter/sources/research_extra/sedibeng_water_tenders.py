"""Sedibeng Water (legacy – merged into Vaal Central) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sedibeng Water (legacy – merged into Vaal Central) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sedibeng Water (legacy – merged into Vaal Central) tenders</h1>
        <table>
            <thead>
...
class SedibengWaterSource:
    """Tender source plug-in for Sedibeng Water (legacy – merged into Vaal Central)."""
    ...
    def __init__(self, url: str = "https://www.sedibengwater.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Sedibeng Water (legacy – merged into Vaal Central)"
