"""Mpumalanga Liquor Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Liquor Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Liquor Board tenders</h1>
        <table>
            <thead>
...
class MpLiquorSource:
    """Tender source plug-in for Mpumalanga Liquor Board."""

    source_id: str = "mp_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mpulb.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Liquor Board"
