"""Onderstepoort Biological Products tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Onderstepoort Biological Products Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Onderstepoort Biological Products tenders</h1>
        <table>
            <thead>
...
class ObpaSource:
    """Tender source plug-in for Onderstepoort Biological Products."""

    source_id: str = "obpa_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.obpvaccines.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Onderstepoort Biological Products"
