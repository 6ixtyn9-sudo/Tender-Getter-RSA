"""ACSA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>ACSA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active ACSA (alt) tenders</h1>
        <table>
            <thead>
...
class AirportsCompanySource:
    """Tender source plug-in for ACSA (alt)."""

    source_id: str = "airports_company_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.acsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "ACSA (alt)"
