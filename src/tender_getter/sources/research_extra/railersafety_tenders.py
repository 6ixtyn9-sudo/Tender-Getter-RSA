"""Rail Safety Regulator (RSR) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Rail Safety Regulator (RSR) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Rail Safety Regulator (RSR) tenders</h1>
        <table>
            <thead>
...
class RailersafetySource:
    """Tender source plug-in for Rail Safety Regulator (RSR)."""

    source_id: str = "railersafety_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.rsr.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Rail Safety Regulator (RSR)"
