"""North West Investment tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Investment Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Investment tenders</h1>
        <table>
            <thead>
...
class NwInvestSource:
    """Tender source plug-in for North West Investment."""

    source_id: str = "nw_invest_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nwipb.co.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Investment"
