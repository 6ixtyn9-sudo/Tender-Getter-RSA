"""Northern Cape Liquor Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Liquor Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Liquor Board tenders</h1>
        <table>
            <thead>
...
class NcLiquorSource:
    """Tender source plug-in for Northern Cape Liquor Board."""

    source_id: str = "nc_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ncliquor.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Liquor Board"
