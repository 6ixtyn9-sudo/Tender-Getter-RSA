"""QS Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>QS Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active QS Council tenders</h1>
        <table>
            <thead>
...
class QuantitySurveyorsCouncilSource:
    """Tender source plug-in for QS Council."""

    source_id: str = "quantity_surveyors_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.saqspa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "QS Council"
