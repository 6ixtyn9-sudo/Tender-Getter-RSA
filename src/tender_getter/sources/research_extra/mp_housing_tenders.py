"""Mpumalanga Housing Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Housing Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Housing Board tenders</h1>
        <table>
            <thead>
...
class MpHousingSource:
    """Tender source plug-in for Mpumalanga Housing Board."""

    source_id: str = "mp_housing_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mphousing.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Housing Board"
