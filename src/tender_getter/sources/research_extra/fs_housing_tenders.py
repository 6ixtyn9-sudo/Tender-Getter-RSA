"""Free State Housing tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Housing Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Housing tenders</h1>
        <table>
            <thead>
...
class FsHousingSource:
    """Tender source plug-in for Free State Housing."""

    source_id: str = "fs_housing_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fshousing.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Housing"
