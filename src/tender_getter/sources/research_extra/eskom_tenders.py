"""Eskom Tender Bulletin tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eskom Tender Bulletin Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eskom Tender Bulletin tenders</h1>
        <table>
            <thead>
...
class EskomSource:
    """Tender source plug-in for Eskom Tender Bulletin."""
    ...
    def __init__(self, url: str = "https://tenderbulletin.eskom.co.za/"):
        self.url = url
        self.issuing_entity = "Eskom Tender Bulletin"
