...
<!DOCTYPE html>
<html>
<head><title>Mintek Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mintek tenders</h1>
        <table>
            <thead>
...
class MintekSource:
    """Tender source plug-in for Mintek."""
