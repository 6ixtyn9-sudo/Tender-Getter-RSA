"""Eastern Cape Housing Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Housing Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Housing Board tenders</h1>
        <table>
            <thead>
...
class EcHousingSource:
    """Tender source plug-in for Eastern Cape Housing Board."""

    source_id: str = "ec_housing_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.echousing.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Housing Board"
