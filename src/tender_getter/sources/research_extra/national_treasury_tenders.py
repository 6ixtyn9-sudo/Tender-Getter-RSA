"""National Treasury tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Treasury Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Treasury tenders</h1>
        <table>
            <thead>
...
class NationalTreasurySource:
    """Tender source plug-in for National Treasury."""
    ...
    def __init__(self, url: str = "https://www.treasury.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "National Treasury"
