"""CapeNature (Western Cape) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>CapeNature (Western Cape) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CapeNature (Western Cape) tenders</h1>
        <table>
            <thead>
...
class CapenatureSource:
    """Tender source plug-in for CapeNature (Western Cape)."""

    source_id: str = "capenature_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.capenature.co.za/procurement"):
        self.url = url
        self.issuing_entity = "CapeNature (Western Cape)"
