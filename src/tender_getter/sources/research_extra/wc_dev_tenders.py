"""Western Cape Development Corporation (Wesgro) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Development Corporation (Wesgro) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Development Corporation (Wesgro) tenders</h1>
        <table>
            <thead>
...
class WcDevSource:
    """Tender source plug-in for Western Cape Development Corporation (Wesgro)."""

    source_id: str = "wc_dev_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.wesgro.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Development Corporation (Wesgro)"
