"""National Skills Development Programme tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Skills Development Programme Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Skills Development Programme tenders</h1>
        <table>
            <thead>
...
class NsdpSource:
    """Tender source plug-in for National Skills Development Programme."""

    source_id: str = "nsdp_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ndp.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "National Skills Development Programme"
