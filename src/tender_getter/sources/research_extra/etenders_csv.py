"""National Treasury eTenders Bulk CSV tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Treasury eTenders Bulk CSV Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Treasury eTenders Bulk CSV tenders</h1>
        <table>
            <thead>
...
class EtendersCsvSource:
    """Tender source plug-in for National Treasury eTenders Bulk CSV."""

    source_id: str = "etenders_csv"
    live: bool = True

    def __init__(self, url: str = "https://data.etenders.gov.za/"):
        self.url = url
        self.issuing_entity = "National Treasury eTenders Bulk CSV"
