"""North West Department of Public Works and Roads tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Department of Public Works and Roads Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Department of Public Works and Roads tenders</h1>
        <table>
            <thead>
...
class NwPublicWorksSource:
    """Tender source plug-in for North West Department of Public Works and Roads."""
    ...
    def __init__(self, url: str = "https://www.nwpg.gov.za/publicworks/tenders"):
        self.url = url
        self.issuing_entity = "North West Department of Public Works and Roads"
