"""Vet Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Vet Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Vet Council tenders</h1>
        <table>
            <thead>
...
class VetCouncilSource:
    """Tender source plug-in for Vet Council."""

    source_id: str = "vet_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.savc.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Vet Council"
