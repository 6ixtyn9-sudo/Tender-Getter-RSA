"""Human Sciences Research Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Human Sciences Research Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Human Sciences Research Council tenders</h1>
        <table>
            <thead>
...
class HsrcSource:
    """Tender source plug-in for Human Sciences Research Council."""
