"""Mpumalanga Agriculture tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Agriculture Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Agriculture tenders</h1>
        <table>
            <thead>
...
class MpAgricultureSource:
    """Tender source plug-in for Mpumalanga Agriculture."""

    source_id: str = "mp_agriculture_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.dardla.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Agriculture"
