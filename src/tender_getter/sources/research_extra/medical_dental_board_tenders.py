"""Medical & Dental Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Medical & Dental Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Medical & Dental Board tenders</h1>
        <table>
            <thead>
...
class MedicalDentalBoardSource:
    """Tender source plug-in for Medical & Dental Board."""

    source_id: str = "medical_dental_board_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.hpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Medical & Dental Board"
