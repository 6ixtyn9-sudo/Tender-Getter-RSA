"""Free State Gambling and Liquor tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Gambling and Liquor Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Gambling and Liquor tenders</h1>
        <table>
            <thead>
...
class FsLiquorSource:
    """Tender source plug-in for Free State Gambling and Liquor."""

    source_id: str = "fs_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fsgla.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Gambling and Liquor"
