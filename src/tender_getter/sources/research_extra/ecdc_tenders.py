"""Eastern Cape Development Corporation (ECDC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Development Corporation (ECDC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Development Corporation (ECDC) tenders</h1>
        <table>
            <thead>
...
class EcdcSource:
    """Tender source plug-in for Eastern Cape Development Corporation (ECDC)."""

    source_id: str = "ecdc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ecdc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Development Corporation (ECDC)"
