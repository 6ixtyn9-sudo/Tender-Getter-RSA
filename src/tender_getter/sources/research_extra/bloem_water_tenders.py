"""Bloem Water (legacy – merged into Vaal Central) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Bloem Water (legacy – merged into Vaal Central) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Bloem Water (legacy – merged into Vaal Central) tenders</h1>
        <table>
            <thead>
...
class BloemWaterSource:
    """Tender source plug-in for Bloem Water (legacy – merged into Vaal Central)."""
    ...
    def __init__(self, url: str = "https://www.bloemwater.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Bloem Water (legacy – merged into Vaal Central)"
