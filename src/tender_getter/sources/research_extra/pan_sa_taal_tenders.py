"""Pan South African Language Board (already in chapter9/) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Pan South African Language Board (already in chapter9/) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Pan South African Language Board (already in chapter9/) tenders</h1>
        <table>
            <thead>
...
class PanSaTaalSource:
    """Tender source plug-in for Pan South African Language Board (already in chapter9/)."""

    source_id: str = "pan_sa_taal_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.pansalb.org/procurement"):
        self.url = url
        self.issuing_entity = "Pan South African Language Board (already in chapter9/)"
