"""City of Johannesburg tender source plug-in."""
import logging
import re
...
class JohannesburgSource:
    """Tender source plug-in for City of Johannesburg."""
    ...
    def __init__(self, url: str = "https://joburg.org.za/work_/Pages/2025-Tenders-and-Quotations/Bid-Opening-Registers.aspx"):
        self.url = url
        self.issuing_entity = "City of Johannesburg"
