"""Limpopo Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Health tenders</h1>
        <table>
            <thead>
...
class LpHealthSource:
    """Tender source plug-in for Limpopo Health."""

    source_id: str = "lp_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ldoh.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Health"
