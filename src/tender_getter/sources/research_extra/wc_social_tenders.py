"""Western Cape Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Social Development tenders</h1>
        <table>
            <thead>
...
class WcSocialSource:
    """Tender source plug-in for Western Cape Social Development."""

    source_id: str = "wc_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.westerncape.gov.za/dept/social-development/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Social Development"
