"""Mpumalanga Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Social Development tenders</h1>
        <table>
            <thead>
...
class MpSocialSource:
    """Tender source plug-in for Mpumalanga Social Development."""

    source_id: str = "mp_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.dsdmp.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Social Development"
