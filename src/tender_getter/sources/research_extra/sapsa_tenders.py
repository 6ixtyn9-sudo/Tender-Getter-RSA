"""South African Police Service Act (admin) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Police Service Act (admin) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Police Service Act (admin) tenders</h1>
        <table>
            <thead>
...
class SapsaSource:
    """Tender source plug-in for South African Police Service Act (admin)."""

    source_id: str = "sapsa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.saps.gov.za/about/admin/procurement"):
        self.url = url
        self.issuing_entity = "South African Police Service Act (admin)"
