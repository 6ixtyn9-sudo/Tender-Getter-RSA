"""Chiropractic Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Chiropractic Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Chiropractic Council tenders</h1>
        <table>
            <thead>
...
class ChiropracticCouncilSource:
    """Tender source plug-in for Chiropractic Council."""

    source_id: str = "chiropractic_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.chiropractic.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Chiropractic Council"
