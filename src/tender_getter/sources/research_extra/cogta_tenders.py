"""Department of Cooperative Governance & Traditional Affairs tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Cooperative Governance & Traditional Affairs Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Cooperative Governance & Traditional Affairs tenders</h1>
        <table>
            <thead>
...
class CogtaSource:
    """Tender source plug-in for Department of Cooperative Governance & Traditional Affairs."""
    ...
    def __init__(self, url: str = "https://www.cogta.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Cooperative Governance & Traditional Affairs"
