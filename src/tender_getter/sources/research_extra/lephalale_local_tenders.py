"""Lephalale Local tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lephalale Local Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lephalale Local tenders</h1>
        <table>
            <thead>
...
class LephalaleLocalSource:
    """Tender source plug-in for Lephalale Local."""

    source_id: str = "lephalale_local_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.lephalale.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Lephalale Local"
