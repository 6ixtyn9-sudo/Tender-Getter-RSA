"""South African Forestry Company tender source plug-in."""
import logging
import re
...
class SafcolSource:
    """Tender source plug-in for South African Forestry Company."""
    ...
    def __init__(self, url: str = "https://www.safcol.co.za/tenders/"):
        self.url = url
        self.issuing_entity = "South African Forestry Company"
