"""North West Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Social Development tenders</h1>
        <table>
            <thead>
...
class NwSocialSource:
    """Tender source plug-in for North West Social Development."""

    source_id: str = "nw_social_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nwsd.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Social Development"
