"""Department of Water and Sanitation tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Water and Sanitation Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Water and Sanitation tenders</h1>
        <table>
            <thead>
...
class DwsSource:
    """Tender source plug-in for Department of Water and Sanitation."""
    ...
    def __init__(self, url: str = "https://www.dws.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Water and Sanitation"
