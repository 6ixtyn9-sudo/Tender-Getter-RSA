"""Free State Tourism tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Tourism Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Tourism tenders</h1>
        <table>
            <thead>
...
class FsTourismSource:
    """Tender source plug-in for Free State Tourism."""

    source_id: str = "fs_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fstourism.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Tourism"
