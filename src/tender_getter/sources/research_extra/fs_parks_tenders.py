"""Free State Parks tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Parks Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Parks tenders</h1>
        <table>
            <thead>
...
class FsParksSource:
    """Tender source plug-in for Free State Parks."""

    source_id: str = "fs_parks_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.freestateparks.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Parks"
