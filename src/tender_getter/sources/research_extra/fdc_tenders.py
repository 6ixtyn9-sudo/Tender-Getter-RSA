"""Free State Development Corporation (FDC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Development Corporation (FDC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Development Corporation (FDC) tenders</h1>
        <table>
            <thead>
...
class FdcSource:
    """Tender source plug-in for Free State Development Corporation (FDC)."""

    source_id: str = "fdc_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fdc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Development Corporation (FDC)"
