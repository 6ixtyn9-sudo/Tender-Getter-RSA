"""Speech Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Speech Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Speech Council tenders</h1>
        <table>
            <thead>
...
class SpeechTherapyCouncilSource:
    """Tender source plug-in for Speech Council."""

    source_id: str = "speech_therapy_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.saslha.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Speech Council"
