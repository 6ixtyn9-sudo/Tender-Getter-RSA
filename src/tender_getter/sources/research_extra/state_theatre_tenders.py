"""South African State Theatre tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African State Theatre Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African State Theatre tenders</h1>
        <table>
            <thead>
...
class StateTheatreSource:
    """Tender source plug-in for South African State Theatre."""

    source_id: str = "state_theatre_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.statetheatre.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South African State Theatre"
