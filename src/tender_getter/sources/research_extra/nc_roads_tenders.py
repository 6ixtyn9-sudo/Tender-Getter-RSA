"""Northern Cape Department of Roads and Public Works tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Department of Roads and Public Works Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Department of Roads and Public Works tenders</h1>
        <table>
            <thead>
...
class NcRoadsSource:
    """Tender source plug-in for Northern Cape Department of Roads and Public Works."""
    ...
    def __init__(self, url: str = "https://ncrpw.ncpg.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Northern Cape Department of Roads and Public Works"
