"""Gauteng Agriculture and Rural Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Agriculture and Rural Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Agriculture and Rural Development tenders</h1>
        <table>
            <thead>
...
class GpAgricultureSource:
    """Tender source plug-in for Gauteng Agriculture and Rural Development."""

    source_id: str = "gp_agriculture_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.gdard.gpg.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Agriculture and Rural Development"
