"""Gauteng Department of Infrastructure Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Department of Infrastructure Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Department of Infrastructure Development tenders</h1>
        <table>
            <thead>
...
class GdidSource:
    """Tender source plug-in for Gauteng Department of Infrastructure Development."""
    ...
    def __init__(self, url: str = "https://www.gdid.gpg.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Gauteng Department of Infrastructure Development"
