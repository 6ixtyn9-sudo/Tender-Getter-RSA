"""Eastern Cape Department of Public Works tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Department of Public Works Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Department of Public Works tenders</h1>
        <table>
            <thead>
...
class EcPublicWorksSource:
    """Tender source plug-in for Eastern Cape Department of Public Works."""
    ...
    def __init__(self, url: str = "https://www.ecdpw.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Eastern Cape Department of Public Works"
