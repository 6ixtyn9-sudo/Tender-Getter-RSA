"""National Union tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Union Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Union tenders</h1>
        <table>
            <thead>
...
class NuSource:
    """Tender source plug-in for National Union."""

    source_id: str = "nu_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nu.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Union"
