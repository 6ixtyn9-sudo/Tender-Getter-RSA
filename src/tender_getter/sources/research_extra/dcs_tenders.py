"""Department of Correctional Services tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Correctional Services Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Correctional Services tenders</h1>
        <table>
            <thead>
...
class DcsSource:
    """Tender source plug-in for Department of Correctional Services."""
    ...
    def __init__(self, url: str = "https://www.dcs.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Correctional Services"
