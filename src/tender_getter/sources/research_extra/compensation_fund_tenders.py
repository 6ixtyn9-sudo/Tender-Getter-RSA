"""Compensation Fund tender source plug-in."""
import logging
import re
...
class CompensationFundSource:
    """Tender source plug-in for Compensation Fund."""
    ...
    def __init__(self, url: str = "https://www.labour.gov.za/compensation-fund-tenders"):
        self.url = url
        self.issuing_entity = "Compensation Fund"
