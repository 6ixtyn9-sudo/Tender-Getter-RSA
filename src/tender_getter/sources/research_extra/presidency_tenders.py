"""The Presidency tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>The Presidency Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active The Presidency tenders</h1>
        <table>
            <thead>
...
class PresidencySource:
    """Tender source plug-in for The Presidency."""
    ...
    def __init__(self, url: str = "https://www.thepresidency.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "The Presidency"
