"""South African National Blood Service (SANBS) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African National Blood Service (SANBS) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African National Blood Service (SANBS) tenders</h1>
        <table>
            <thead>
...
class SanbsSource:
    """Tender source plug-in for South African National Blood Service (SANBS)."""

    source_id: str = "sanbs_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sanbs.org.za/procurement"):
        self.url = url
        self.issuing_entity = "South African National Blood Service (SANBS)"
