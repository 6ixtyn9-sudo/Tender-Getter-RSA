"""Limpopo Economic Development Agency (LEDA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Economic Development Agency (LEDA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Economic Development Agency (LEDA) tenders</h1>
        <table>
            <thead>
...
class LpDevSource:
    """Tender source plug-in for Limpopo Economic Development Agency (LEDA)."""

    source_id: str = "lp_dev_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.leda.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Economic Development Agency (LEDA)"
