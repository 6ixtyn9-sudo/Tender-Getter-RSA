"""Federated Hospitality Association of SA tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Federated Hospitality Association of SA Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Federated Hospitality Association of SA tenders</h1>
        <table>
            <thead>
...
class FedhasaSource:
    """Tender source plug-in for Federated Hospitality Association of SA."""

    source_id: str = "fedhasa_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fedhasa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Federated Hospitality Association of SA"
