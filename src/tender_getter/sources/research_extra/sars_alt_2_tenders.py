"""SARS (alt URL 2) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SARS (alt URL 2) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SARS (alt URL 2) tenders</h1>
        <table>
            <thead>
...
class SarsAlt2Source:
    """Tender source plug-in for SARS (alt URL 2)."""

    source_id: str = "sars_alt_2_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sars.gov.za/procurement/index.html"):
        self.url = url
        self.issuing_entity = "SARS (alt URL 2)"
