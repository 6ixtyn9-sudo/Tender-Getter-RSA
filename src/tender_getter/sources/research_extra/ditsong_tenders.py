"""Ditsong Museums of South Africa tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ditsong Museums of South Africa Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ditsong Museums of South Africa tenders</h1>
        <table>
            <thead>
...
class DitsongSource:
    """Tender source plug-in for Ditsong Museums of South Africa."""

    source_id: str = "ditsong_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ditsong.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Ditsong Museums of South Africa"
