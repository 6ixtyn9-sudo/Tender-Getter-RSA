"""Eastern Cape Department of Education tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Department of Education Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Department of Education tenders</h1>
        <table>
            <thead>
...
class EcEducationSource:
    """Tender source plug-in for Eastern Cape Department of Education."""
    ...
    def __init__(self, url: str = "https://www.ecdoe.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Eastern Cape Department of Education"
