"""Pitso ya Marena tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Pitso ya Marena Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Pitso ya Marena tenders</h1>
        <table>
            <thead>
...
class PitsoSource:
    """Tender source plug-in for Pitso ya Marena."""

    source_id: str = "pitso_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.marenas.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Pitso ya Marena"
