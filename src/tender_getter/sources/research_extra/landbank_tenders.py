"""Land and Agricultural Development Bank tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Land and Agricultural Development Bank Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Land and Agricultural Development Bank tenders</h1>
        <table>
            <thead>
...
class LandbankSource:
    """Tender source plug-in for Land and Agricultural Development Bank."""
    ...
    def __init__(self, url: str = "https://landbank.co.za/Pages/Procurement.aspx"):
        self.url = url
        self.issuing_entity = "Land and Agricultural Development Bank"
