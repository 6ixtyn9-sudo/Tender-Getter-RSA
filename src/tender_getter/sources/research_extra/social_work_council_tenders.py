"""Social Work Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Social Work Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Social Work Council tenders</h1>
        <table>
            <thead>
...
class SocialWorkCouncilSource:
    """Tender source plug-in for Social Work Council."""

    source_id: str = "social_work_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.saswcouncil.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Social Work Council"
