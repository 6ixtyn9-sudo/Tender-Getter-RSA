"""Gauteng Convention Bureau tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Convention Bureau Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Convention Bureau tenders</h1>
        <table>
            <thead>
...
class GcSource:
    """Tender source plug-in for Gauteng Convention Bureau."""

    source_id: str = "gc_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.gconvention.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Gauteng Convention Bureau"
