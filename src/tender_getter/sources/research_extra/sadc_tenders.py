...
<!DOCTYPE html>
<html>
<head><title>SADC Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SADC tenders</h1>
        <table>
            <thead>
...
class SadcSource:
    """Tender source plug-in for SADC."""

    source_id: str = "sadc_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sadc.int/procurement"):
        self.url = url
        self.issuing_entity = "SADC"
