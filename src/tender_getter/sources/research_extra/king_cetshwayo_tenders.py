"""King Cetshwayo District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>King Cetshwayo District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active King Cetshwayo District Municipality tenders</h1>
        <table>
            <thead>
...
class KingCetshwayoSource:
    """Tender source plug-in for King Cetshwayo District Municipality."""
    ...
    def __init__(self, url: str = "https://www.kingcetshwayo.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "King Cetshwayo District Municipality"
