"""Gauteng Department of Roads and Transport tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gauteng Department of Roads and Transport Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gauteng Department of Roads and Transport tenders</h1>
        <table>
            <thead>
...
class GdrtSource:
    """Tender source plug-in for Gauteng Department of Roads and Transport."""
    ...
    def __init__(self, url: str = "https://www.gdrt.gpg.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Gauteng Department of Roads and Transport"
