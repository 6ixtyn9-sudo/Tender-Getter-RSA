"""Buffalo City Metropolitan Municipality tender source plug-in."""
import logging
import re
...
class BuffaloCitySource:
    """Tender source plug-in for Buffalo City Metropolitan Municipality."""
    ...
    def __init__(self, url: str = "https://www.buffalocity.gov.za/tenders.php"):
        self.url = url
        self.issuing_entity = "Buffalo City Metropolitan Municipality"
