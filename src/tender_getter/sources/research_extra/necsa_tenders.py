"""South African Nuclear Energy Corporation tender source plug-in."""
import logging
import re
...
class NecsaSource:
    """Tender source plug-in for South African Nuclear Energy Corporation."""
    ...
    def __init__(self, url: str = "https://www.necsa.co.za/tenders/"):
        self.url = url
        self.issuing_entity = "South African Nuclear Energy Corporation"
