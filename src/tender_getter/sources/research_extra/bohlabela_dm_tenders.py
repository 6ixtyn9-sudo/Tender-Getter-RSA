"""Bohlabela District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Bohlabela District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Bohlabela District Municipality tenders</h1>
        <table>
            <thead>
...
class BohlabelaDmSource:
    """Tender source plug-in for Bohlabela District Municipality."""

    source_id: str = "bohlabela_dm_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.bohlabela.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Bohlabela District Municipality"
