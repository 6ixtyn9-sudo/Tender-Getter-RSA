"""National Research Foundation (NRF) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Research Foundation (NRF) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Research Foundation (NRF) tenders</h1>
        <table>
            <thead>
...
class NrfSource:
    """Tender source plug-in for National Research Foundation (NRF)."""

    source_id: str = "nrf_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nrf.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "National Research Foundation (NRF)"
