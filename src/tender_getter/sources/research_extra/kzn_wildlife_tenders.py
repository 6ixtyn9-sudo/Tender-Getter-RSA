"""Ezemvelo KZN Wildlife tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ezemvelo KZN Wildlife Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ezemvelo KZN Wildlife tenders</h1>
        <table>
            <thead>
...
class KznWildlifeSource:
    """Tender source plug-in for Ezemvelo KZN Wildlife."""

    source_id: str = "kzn_wildlife_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.kznwildlife.com/procurement"):
        self.url = url
        self.issuing_entity = "Ezemvelo KZN Wildlife"
