"""Ephraim Mogale (alt 2) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ephraim Mogale (alt 2) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ephraim Mogale (alt 2) tenders</h1>
        <table>
            <thead>
...
class EphraimMogaleAlt2Source:
    """Tender source plug-in for Ephraim Mogale (alt 2)."""

    source_id: str = "ephraim_mogale_alt_2_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ephraimmogale.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Ephraim Mogale (alt 2)"
