"""Western Cape Liquor Authority tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Liquor Authority Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Liquor Authority tenders</h1>
        <table>
            <thead>
...
class WcLiquorSource:
    """Tender source plug-in for Western Cape Liquor Authority."""

    source_id: str = "wc_liquor_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.wcla.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Liquor Authority"
