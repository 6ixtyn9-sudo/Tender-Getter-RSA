"""Department of Sports, Arts & Culture tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Sports, Arts & Culture Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Sports, Arts & Culture tenders</h1>
        <table>
            <thead>
...
class DsacSource:
    """Tender source plug-in for Department of Sports, Arts & Culture."""
    ...
    def __init__(self, url: str = "https://www.dsac.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Sports, Arts & Culture"
