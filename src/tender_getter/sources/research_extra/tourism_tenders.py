"""Department of Tourism tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Tourism Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Tourism tenders</h1>
        <table>
            <thead>
...
class TourismSource:
    """Tender source plug-in for Department of Tourism."""
    ...
    def __init__(self, url: str = "https://www.tourism.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Tourism"
