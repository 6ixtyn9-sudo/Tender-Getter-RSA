"""Overberg Water tender source plug-in."""
import logging
import re
...
class OverbergWaterSource:
    """Tender source plug-in for Overberg Water."""
    ...
    def __init__(self, url: str = "https://overbergwater.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Overberg Water"
