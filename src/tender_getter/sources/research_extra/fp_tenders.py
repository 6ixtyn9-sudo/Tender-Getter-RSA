"""Film and Publication Board (already in research_extra/) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Film and Publication Board (already in research_extra/) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Film and Publication Board (already in research_extra/) tenders</h1>
        <table>
            <thead>
...
class FpSource:
    """Tender source plug-in for Film and Publication Board (already in research_extra/)."""

    source_id: str = "fp_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.fpb.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Film and Publication Board (already in research_extra/)"
