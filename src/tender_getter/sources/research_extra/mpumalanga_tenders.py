"""Mpumalanga Provincial Treasury tender source plug-in."""
import logging
import re
...
class MpumalangaSource:
    """Tender source plug-in for Mpumalanga Provincial Treasury."""
    ...
    def __init__(self, url: str = "https://www.mpumalanga.gov.za/finance/tenders.htm"):
        self.url = url
        self.issuing_entity = "Mpumalanga Provincial Treasury"
