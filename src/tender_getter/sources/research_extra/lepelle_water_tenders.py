"""Lepelle Northern Water (legacy – merged into Vaal Central) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lepelle Northern Water (legacy – merged into Vaal Central) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lepelle Northern Water (legacy – merged into Vaal Central) tenders</h1>
        <table>
            <thead>
...
class LepelleWaterSource:
    """Tender source plug-in for Lepelle Northern Water (legacy – merged into Vaal Central)."""
    ...
    def __init__(self, url: str = "https://www.lepellewater.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Lepelle Northern Water (legacy – merged into Vaal Central)"
