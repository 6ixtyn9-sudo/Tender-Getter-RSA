"""Department of Transport tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Transport Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Transport tenders</h1>
        <table>
            <thead>
...
class DotSource:
    """Tender source plug-in for Department of Transport."""
    ...
    def __init__(self, url: str = "https://www.transport.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Transport"
