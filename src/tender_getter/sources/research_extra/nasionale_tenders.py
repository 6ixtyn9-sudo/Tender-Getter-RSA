"""Nasionale Pers tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Nasionale Pers Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Nasionale Pers tenders</h1>
        <table>
            <thead>
...
class NasionaleSource:
    """Tender source plug-in for Nasionale Pers."""

    source_id: str = "nasionale_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nasionale.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Nasionale Pers"
