"""Eastern Cape Provincial Treasury tender source plug-in."""
import logging
import re
...
class EasterncapeSource:
    """Tender source plug-in for Eastern Cape Provincial Treasury."""
    ...
    def __init__(self, url: str = "https://www.ecprov.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Eastern Cape Provincial Treasury"
