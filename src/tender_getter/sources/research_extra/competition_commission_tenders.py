"""Competition Commission tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Competition Commission Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Competition Commission tenders</h1>
        <table>
            <thead>
...
class CompetitionCommissionSource:
    """Tender source plug-in for Competition Commission."""

    source_id: str = "competition_commission_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.compcom.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Competition Commission"
