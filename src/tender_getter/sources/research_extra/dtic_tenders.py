"""Department of Trade, Industry & Competition tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Trade, Industry & Competition Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Trade, Industry & Competition tenders</h1>
        <table>
            <thead>
...
class DticSource:
    """Tender source plug-in for Department of Trade, Industry & Competition."""
    ...
    def __init__(self, url: str = "https://www.thedtic.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Trade, Industry & Competition"
