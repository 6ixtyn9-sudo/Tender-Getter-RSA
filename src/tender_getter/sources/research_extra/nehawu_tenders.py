...
<!DOCTYPE html>
<html>
<head><title>NEHAWU Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NEHAWU tenders</h1>
        <table>
            <thead>
...
class NehawuSource:
    """Tender source plug-in for NEHAWU."""

    source_id: str = "nehawu_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nehawu.org.za/procurement"):
        self.url = url
        self.issuing_entity = "NEHAWU"
