"""Industrial Development Corporation tender source plug-in."""
import logging
import re
...
class IdcSource:
    """Tender source plug-in for Industrial Development Corporation."""
    ...
    def __init__(self, url: str = "https://www.idc.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Industrial Development Corporation"
