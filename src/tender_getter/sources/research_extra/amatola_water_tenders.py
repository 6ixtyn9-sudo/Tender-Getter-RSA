"""Amatola Water tender source plug-in."""
import logging
import re
...
class AmatolaWaterSource:
    """Tender source plug-in for Amatola Water."""
    ...
    def __init__(self, url: str = "https://www.amatolawater.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Amatola Water"
