"""Department of Higher Education & Training tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Higher Education & Training Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Higher Education & Training tenders</h1>
        <table>
            <thead>
...
class DhetSource:
    """Tender source plug-in for Department of Higher Education & Training."""
    ...
    def __init__(self, url: str = "https://www.dhet.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Higher Education & Training"
