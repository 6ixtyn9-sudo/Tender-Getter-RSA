"""KZN Arts and Culture Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Arts and Culture Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Arts and Culture Council tenders</h1>
        <table>
            <thead>
...
class KznArtsSource:
    """Tender source plug-in for KZN Arts and Culture Council."""

    source_id: str = "kzn_arts_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.kznartscouncil.co.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Arts and Culture Council"
