"""Free State Department of Police, Roads & Transport tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Department of Police, Roads & Transport Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Department of Police, Roads & Transport tenders</h1>
        <table>
            <thead>
...
class FsPoliceRoadsSource:
    """Tender source plug-in for Free State Department of Police, Roads & Transport."""
    ...
    def __init__(self, url: str = "https://www.pret.fs.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Free State Department of Police, Roads & Transport"
