"""National Digital Platform tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Digital Platform Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Digital Platform tenders</h1>
        <table>
            <thead>
...
class NdpSource:
    """Tender source plug-in for National Digital Platform."""

    source_id: str = "ndp_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ndp.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "National Digital Platform"
