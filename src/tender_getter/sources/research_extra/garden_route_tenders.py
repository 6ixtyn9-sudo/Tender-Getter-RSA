"""Garden Route District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Garden Route District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Garden Route District Municipality tenders</h1>
        <table>
            <thead>
...
class GardenRouteSource:
    """Tender source plug-in for Garden Route District Municipality."""
    ...
    def __init__(self, url: str = "https://www.gardenroute.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Garden Route District Municipality"
