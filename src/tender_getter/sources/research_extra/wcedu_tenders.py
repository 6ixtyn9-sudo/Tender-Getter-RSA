"""Western Cape Education Department (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Education Department (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Education Department (alt) tenders</h1>
        <table>
            <thead>
...
class WceduSource:
    """Tender source plug-in for Western Cape Education Department (alt)."""

    source_id: str = "wcedu_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.wcedonline.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Education Department (alt)"
