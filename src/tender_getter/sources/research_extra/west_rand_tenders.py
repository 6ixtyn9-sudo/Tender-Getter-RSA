"""West Rand District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>West Rand District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active West Rand District Municipality tenders</h1>
        <table>
            <thead>
...
class WestRandSource:
    """Tender source plug-in for West Rand District Municipality."""
    ...
    def __init__(self, url: str = "https://www.wrdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "West Rand District Municipality"
