"""Free State Roads tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Free State Roads Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Free State Roads tenders</h1>
        <table>
            <thead>
...
class FsRoadsSource:
    """Tender source plug-in for Free State Roads."""

    source_id: str = "fs_roads_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fsroads.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Free State Roads"
