"""Eastern Cape Tourism tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Tourism Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Tourism tenders</h1>
        <table>
            <thead>
...
class EcTourismSource:
    """Tender source plug-in for Eastern Cape Tourism."""

    source_id: str = "ec_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ectourism.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Tourism"
