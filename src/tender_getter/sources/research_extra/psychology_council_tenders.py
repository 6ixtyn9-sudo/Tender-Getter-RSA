"""Psych Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Psych Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Psych Council tenders</h1>
        <table>
            <thead>
...
class PsychologyCouncilSource:
    """Tender source plug-in for Psych Council."""

    source_id: str = "psychology_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.hpssa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Psych Council"
