"""Northern Cape Investment tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Investment Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Investment tenders</h1>
        <table>
            <thead>
...
class NcInvestSource:
    """Tender source plug-in for Northern Cape Investment."""

    source_id: str = "nc_invest_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ncinvest.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Investment"
