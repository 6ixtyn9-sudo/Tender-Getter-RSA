"""South African National Space Agency tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African National Space Agency Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African National Space Agency tenders</h1>
        <table>
            <thead>
...
class SansaSource:
    """Tender source plug-in for South African National Space Agency."""
    ...
    def __init__(self, url: str = "https://www.sansa.org.za/tenders"):
        self.url = url
        self.issuing_entity = "South African National Space Agency"
