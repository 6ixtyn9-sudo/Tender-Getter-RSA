"""Western Cape Agriculture (Elsenburg) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Agriculture (Elsenburg) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Agriculture (Elsenburg) tenders</h1>
        <table>
            <thead>
...
class WcAgricultureSource:
    """Tender source plug-in for Western Cape Agriculture (Elsenburg)."""

    source_id: str = "wc_agriculture_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.elsenburg.com/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Agriculture (Elsenburg)"
