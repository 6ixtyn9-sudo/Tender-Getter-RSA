"""Film and Publication Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Film and Publication Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Film and Publication Board tenders</h1>
        <table>
            <thead>
...
class FilmPubBoardSource:
    """Tender source plug-in for Film and Publication Board."""

    source_id: str = "film_pub_board_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.fpb.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Film and Publication Board"
