"""North West Health tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Health Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Health tenders</h1>
        <table>
            <thead>
...
class NwHealthSource:
    """Tender source plug-in for North West Health."""

    source_id: str = "nw_health_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nwhealth.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Health"
