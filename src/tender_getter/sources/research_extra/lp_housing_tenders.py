"""Limpopo Housing tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Housing Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Housing tenders</h1>
        <table>
            <thead>
...
class LpHousingSource:
    """Tender source plug-in for Limpopo Housing."""

    source_id: str = "lp_housing_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.limpopohousing.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Housing"
