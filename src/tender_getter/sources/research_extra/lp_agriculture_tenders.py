"""Limpopo Agriculture tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Agriculture Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Agriculture tenders</h1>
        <table>
            <thead>
...
class LpAgricultureSource:
    """Tender source plug-in for Limpopo Agriculture."""

    source_id: str = "lp_agriculture_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.lda.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Agriculture"
