"""Free State Provincial Treasury tender source plug-in."""
import logging
import re
...
class FreestateSource:
    """Tender source plug-in for Free State Provincial Treasury."""
    ...
    def __init__(self, url: str = "http://www.treasury.fs.gov.za/tenders/"):
        self.url = url
        self.issuing_entity = "Free State Provincial Treasury"
