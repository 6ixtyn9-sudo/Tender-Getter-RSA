"""North West Tourism Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Tourism Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Tourism Board tenders</h1>
        <table>
            <thead>
...
class NwTourismSource:
    """Tender source plug-in for North West Tourism Board."""

    source_id: str = "nw_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.northwestprovince.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Tourism Board"
