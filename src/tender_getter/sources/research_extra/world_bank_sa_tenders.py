"""World Bank SA tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>World Bank SA Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active World Bank SA tenders</h1>
        <table>
            <thead>
...
class WorldBankSaSource:
    """Tender source plug-in for World Bank SA."""

    source_id: str = "world_bank_sa_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.worldbank.org/procurement"):
        self.url = url
        self.issuing_entity = "World Bank SA"
