"""Dental Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Dental Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Dental Council tenders</h1>
        <table>
            <thead>
...
class DentalCouncilSource:
    """Tender source plug-in for Dental Council."""

    source_id: str = "dental_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sadentalcouncil.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Dental Council"
