"""Western Cape Housing tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Housing Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Housing tenders</h1>
        <table>
            <thead>
...
class WcHousingSource:
    """Tender source plug-in for Western Cape Housing."""

    source_id: str = "wc_housing_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.wchousing.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Housing"
