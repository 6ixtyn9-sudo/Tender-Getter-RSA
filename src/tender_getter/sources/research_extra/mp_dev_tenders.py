"""Mpumalanga Economic Growth Agency (MEGA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Economic Growth Agency (MEGA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Economic Growth Agency (MEGA) tenders</h1>
        <table>
            <thead>
...
class MpDevSource:
    """Tender source plug-in for Mpumalanga Economic Growth Agency (MEGA)."""

    source_id: str = "mp_dev_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mega.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Economic Growth Agency (MEGA)"
