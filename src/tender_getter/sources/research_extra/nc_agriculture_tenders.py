"""Northern Cape Agriculture tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Northern Cape Agriculture Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Northern Cape Agriculture tenders</h1>
        <table>
            <thead>
...
class NcAgricultureSource:
    """Tender source plug-in for Northern Cape Agriculture."""

    source_id: str = "nc_agriculture_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ncad.agric.za/procurement"):
        self.url = url
        self.issuing_entity = "Northern Cape Agriculture"
