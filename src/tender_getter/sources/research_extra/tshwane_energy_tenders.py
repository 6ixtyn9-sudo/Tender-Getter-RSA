"""City of Tshwane Energy and Electricity Division tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>City of Tshwane Energy and Electricity Division Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active City of Tshwane Energy and Electricity Division tenders</h1>
        <table>
            <thead>
...
class TshwaneEnergySource:
    """Tender source plug-in for City of Tshwane Energy and Electricity Division."""

    source_id: str = "tshwane_energy_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tshwane.gov.za/energy/procurement"):
        self.url = url
        self.issuing_entity = "City of Tshwane Energy and Electricity Division"
