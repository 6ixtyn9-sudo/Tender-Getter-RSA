"""Department of Employment and Labour tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Employment and Labour Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Employment and Labour tenders</h1>
        <table>
            <thead>
...
class DoelSource:
    """Tender source plug-in for Department of Employment and Labour."""
    ...
    def __init__(self, url: str = "https://www.labour.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Employment and Labour"
