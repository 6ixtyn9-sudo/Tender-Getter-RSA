"""Naturopathy Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Naturopathy Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Naturopathy Council tenders</h1>
        <table>
            <thead>
...
class NaturopathyCouncilSource:
    """Tender source plug-in for Naturopathy Council."""

    source_id: str = "naturopathy_council_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ahpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Naturopathy Council"
