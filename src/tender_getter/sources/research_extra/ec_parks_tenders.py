"""Eastern Cape Parks Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Parks Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Parks Board tenders</h1>
        <table>
            <thead>
...
class EcParksSource:
    """Tender source plug-in for Eastern Cape Parks Board."""

    source_id: str = "ec_parks_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ecpb.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Parks Board"
