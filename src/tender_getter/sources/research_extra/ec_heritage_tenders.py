"""Eastern Cape Heritage Council tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Heritage Council Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eastern Cape Heritage Council tenders</h1>
        <table>
            <thead>
...
class EcHeritageSource:
    """Tender source plug-in for Eastern Cape Heritage Council."""

    source_id: str = "ec_heritage_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.echeritage.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eastern Cape Heritage Council"
