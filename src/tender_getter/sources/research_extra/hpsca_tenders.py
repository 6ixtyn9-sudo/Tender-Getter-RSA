"""Health Professions Council (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Health Professions Council (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Health Professions Council (alt) tenders</h1>
        <table>
            <thead>
...
class HpscaSource:
    """Tender source plug-in for Health Professions Council (alt)."""

    source_id: str = "hpsca_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.hpsca.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Health Professions Council (alt)"
