"""Western Cape Tourism tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Tourism Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Tourism tenders</h1>
        <table>
            <thead>
...
class WcTourismSource:
    """Tender source plug-in for Western Cape Tourism."""

    source_id: str = "wc_tourism_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.wesgro.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Tourism"
