"""uMngeni-uThukela Water (merged: Umgeni + Mhlathuze) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMngeni-uThukela Water (merged: Umgeni + Mhlathuze) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMngeni-uThukela Water (merged: Umgeni + Mhlathuze) tenders</h1>
        <table>
            <thead>
...
class UmngeniUthukelaWaterSource:
    """Tender source plug-in for uMngeni-uThukela Water (merged: Umgeni + Mhlathuze)."""

    source_id: str = "umngeni_uthukela_water_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.umngeni-uthukela.co.za/tenders"):
        self.url = url
        self.issuing_entity = "uMngeni-uThukela Water (merged: Umgeni + Mhlathuze)"
