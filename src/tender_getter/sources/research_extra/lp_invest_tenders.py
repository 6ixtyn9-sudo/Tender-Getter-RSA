"""Limpopo Investment tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Investment Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Limpopo Investment tenders</h1>
        <table>
            <thead>
...
class LpInvestSource:
    """Tender source plug-in for Limpopo Investment."""

    source_id: str = "lp_invest_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.limpopo-investment.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Limpopo Investment"
