"""Department of Public Works & Infrastructure tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Public Works & Infrastructure Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Public Works & Infrastructure tenders</h1>
        <table>
            <thead>
...
class DpwiSource:
    """Tender source plug-in for Department of Public Works & Infrastructure."""
    ...
    def __init__(self, url: str = "https://www.publicworks.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Department of Public Works & Infrastructure"
