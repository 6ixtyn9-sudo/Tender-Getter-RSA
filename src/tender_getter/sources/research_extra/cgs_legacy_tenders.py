"""Council for Geoscience (legacy URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Council for Geoscience (legacy URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Council for Geoscience (legacy URL) tenders</h1>
        <table>
            <thead>
...
class CgsLegacySource:
    """Tender source plug-in for Council for Geoscience (legacy URL)."""

    source_id: str = "cgs_legacy_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.geoscience.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Council for Geoscience (legacy URL)"
