"""North West Housing Board tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Housing Board Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active North West Housing Board tenders</h1>
        <table>
            <thead>
...
class NwHousingSource:
    """Tender source plug-in for North West Housing Board."""

    source_id: str = "nw_housing_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.nwhousing.co.za/procurement"):
        self.url = url
        self.issuing_entity = "North West Housing Board"
