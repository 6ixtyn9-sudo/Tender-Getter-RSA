...
<!DOCTYPE html>
<html>
<head><title>SAQA Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SAQA tenders</h1>
        <table>
            <thead>
...
class SaqaSource:
    """Tender source plug-in for SAQA."""

    source_id: str = "saqa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.saqa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "SAQA"
