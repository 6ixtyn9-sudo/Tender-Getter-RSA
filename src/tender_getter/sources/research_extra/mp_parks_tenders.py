"""Mpumalanga Parks Board (MTPA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Parks Board (MTPA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mpumalanga Parks Board (MTPA) tenders</h1>
        <table>
            <thead>
...
class MpParksSource:
    """Tender source plug-in for Mpumalanga Parks Board (MTPA)."""

    source_id: str = "mp_parks_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mpumalanga.com/procurement"):
        self.url = url
        self.issuing_entity = "Mpumalanga Parks Board (MTPA)"
