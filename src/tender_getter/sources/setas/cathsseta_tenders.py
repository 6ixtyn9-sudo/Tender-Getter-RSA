"""Culture, Arts, Tourism, Hospitality and Sport SETA (CATHSSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Culture, Arts, Tourism, Hospitality and Sport SETA (CATHSSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Culture, Arts, Tourism, Hospitality and Sport SETA (CATHSSETA) tenders</h1>
        <table>
            <thead>
...
class CathssetaSource:
    """Tender source plug-in for Culture, Arts, Tourism, Hospitality and Sport SETA (CATHSSETA)."""

    source_id: str = "cathsseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cathsseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Culture, Arts, Tourism, Hospitality and Sport SETA (CATHSSETA)"
