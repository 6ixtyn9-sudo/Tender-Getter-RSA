"""Energy and Water Sector Education and Training Authority (EWSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Energy and Water Sector Education and Training Authority (EWSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Energy and Water Sector Education and Training Authority (EWSETA) tenders</h1>
        <table>
            <thead>
...
class EwsetaSource:
    """Tender source plug-in for Energy and Water Sector Education and Training Authority (EWSETA)."""

    source_id: str = "ewseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.eseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Energy and Water Sector Education and Training Authority (EWSETA)"
