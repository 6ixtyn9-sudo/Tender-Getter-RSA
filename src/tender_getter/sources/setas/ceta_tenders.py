"""Construction Education and Training Authority (CETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Construction Education and Training Authority (CETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Construction Education and Training Authority (CETA) tenders</h1>
        <table>
            <thead>
...
class CetaSource:
    """Tender source plug-in for Construction Education and Training Authority (CETA)."""

    source_id: str = "ceta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ceta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Construction Education and Training Authority (CETA)"
