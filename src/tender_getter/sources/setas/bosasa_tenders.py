"""Mining Qualifications Authority (already in setas/) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mining Qualifications Authority (already in setas/) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mining Qualifications Authority (already in setas/) tenders</h1>
        <table>
            <thead>
...
class BosasaSource:
    """Tender source plug-in for Mining Qualifications Authority (already in setas/)."""

    source_id: str = "bosasa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mqa.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Mining Qualifications Authority (already in setas/)"
