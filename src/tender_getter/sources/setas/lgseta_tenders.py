"""Local Government Sector Education and Training Authority (LGSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Local Government Sector Education and Training Authority (LGSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Local Government Sector Education and Training Authority (LGSETA) tenders</h1>
        <table>
            <thead>
...
class LgsetaSource:
    """Tender source plug-in for Local Government Sector Education and Training Authority (LGSETA)."""

    source_id: str = "lgseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.lgseta.co.za/tenders/"):
        self.url = url
        self.issuing_entity = "Local Government Sector Education and Training Authority (LGSETA)"
