"""Agricultural Sector Education and Training Authority (AgriSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Agricultural Sector Education and Training Authority (AgriSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Agricultural Sector Education and Training Authority (AgriSETA) tenders</h1>
        <table>
            <thead>
...
class AgrisetaSource:
    """Tender source plug-in for Agricultural Sector Education and Training Authority (AgriSETA)."""

    source_id: str = "agriseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.agriseta.co.za/?page_id=11000"):
        self.url = url
        self.issuing_entity = "Agricultural Sector Education and Training Authority (AgriSETA)"
