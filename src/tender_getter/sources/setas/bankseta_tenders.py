"""Banking Sector Education and Training Authority (BANKSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Banking Sector Education and Training Authority (BANKSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Banking Sector Education and Training Authority (BANKSETA) tenders</h1>
        <table>
            <thead>
...
class BanksetaSource:
    """Tender source plug-in for Banking Sector Education and Training Authority (BANKSETA)."""

    source_id: str = "bankseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.bankseta.org.za/tenders.php"):
        self.url = url
        self.issuing_entity = "Banking Sector Education and Training Authority (BANKSETA)"
