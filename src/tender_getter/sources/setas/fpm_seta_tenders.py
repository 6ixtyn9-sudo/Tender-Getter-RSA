"""Fibre Processing and Manufacturing SETA (FP&M SETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Fibre Processing and Manufacturing SETA (FP&M SETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Fibre Processing and Manufacturing SETA (FP&M SETA) tenders</h1>
        <table>
            <thead>
...
class FpmSetaSource:
    """Tender source plug-in for Fibre Processing and Manufacturing SETA (FP&M SETA)."""

    source_id: str = "fpm_seta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.fpmseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Fibre Processing and Manufacturing SETA (FP&M SETA)"
