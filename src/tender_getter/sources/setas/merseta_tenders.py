"""Manufacturing, Engineering and Related Services SETA (merSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Manufacturing, Engineering and Related Services SETA (merSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Manufacturing, Engineering and Related Services SETA (merSETA) tenders</h1>
        <table>
            <thead>
...
class MersetaSource:
    """Tender source plug-in for Manufacturing, Engineering and Related Services SETA (merSETA)."""

    source_id: str = "merseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.merseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Manufacturing, Engineering and Related Services SETA (merSETA)"
