"""Transport Education Training Authority (TETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Transport Education Training Authority (TETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Transport Education Training Authority (TETA) tenders</h1>
        <table>
            <thead>
...
class TetaSource:
    """Tender source plug-in for Transport Education Training Authority (TETA)."""

    source_id: str = "teta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.teta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Transport Education Training Authority (TETA)"
