...
<!DOCTYPE html>
<html>
<head><title>Services Sector Education and Training Authority (Services SETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Services Sector Education and Training Authority (Services SETA) tenders</h1>
        <table>
            <thead>
...
class ServicesSetaSource:
    """Tender source plug-in for Services Sector Education and Training Authority (Services SETA)."""

    source_id: str = "services_seta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.serviceseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Services Sector Education and Training Authority (Services SETA)"
