"""Safety and Security Sector Education and Training Authority (SASSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Safety and Security Sector Education and Training Authority (SASSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Safety and Security Sector Education and Training Authority (SASSETA) tenders</h1>
        <table>
            <thead>
...
class SassetaSource:
    """Tender source plug-in for Safety and Security Sector Education and Training Authority (SASSETA)."""

    source_id: str = "sasseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sasseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Safety and Security Sector Education and Training Authority (SASSETA)"
