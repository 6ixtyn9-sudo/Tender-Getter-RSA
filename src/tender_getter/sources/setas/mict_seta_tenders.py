"""Media, Information and Communication Technologies SETA (MICT SETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Media, Information and Communication Technologies SETA (MICT SETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Media, Information and Communication Technologies SETA (MICT SETA) tenders</h1>
        <table>
            <thead>
...
class MictSetaSource:
    """Tender source plug-in for Media, Information and Communication Technologies SETA (MICT SETA)."""

    source_id: str = "mict_seta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mict.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Media, Information and Communication Technologies SETA (MICT SETA)"
