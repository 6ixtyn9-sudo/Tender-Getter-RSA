...
<!DOCTYPE html>
<html>
<head><title>Chemical Industries Education and Training Authority (CHIETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Chemical Industries Education and Training Authority (CHIETA) tenders</h1>
        <table>
            <thead>
...
class ChietaSource:
    ...
    source_id: str = "chieta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.chieta.org.za/tenders/"):
        self.url = url
