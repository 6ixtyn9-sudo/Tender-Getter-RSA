"""Food and Beverage Manufacturing SETA (FoodBev) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Food and Beverage Manufacturing SETA (FoodBev) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Food and Beverage Manufacturing SETA (FoodBev) tenders</h1>
        <table>
            <thead>
...
class FoodbevSource:
    """Tender source plug-in for Food and Beverage Manufacturing SETA (FoodBev)."""

    source_id: str = "foodbev_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.foodbev.co.za/tenders/"):
        self.url = url
        self.issuing_entity = "Food and Beverage Manufacturing SETA (FoodBev)"
