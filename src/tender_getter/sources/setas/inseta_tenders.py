"""Insurance Sector Education and Training Authority (INSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Insurance Sector Education and Training Authority (INSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Insurance Sector Education and Training Authority (INSETA) tenders</h1>
        <table>
            <thead>
...
class InsetaSource:
    """Tender source plug-in for Insurance Sector Education and Training Authority (INSETA)."""

    source_id: str = "inseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.inseta.org.za/pages/tenders"):
        self.url = url
        self.issuing_entity = "Insurance Sector Education and Training Authority (INSETA)"
