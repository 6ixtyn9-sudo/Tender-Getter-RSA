"""Wholesale and Retail Sector Education and Training Authority (W&RSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Wholesale and Retail Sector Education and Training Authority (W&RSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Wholesale and Retail Sector Education and Training Authority (W&RSETA) tenders</h1>
        <table>
            <thead>
...
class WrsetaSource:
    """Tender source plug-in for Wholesale and Retail Sector Education and Training Authority (W&RSETA)."""

    source_id: str = "wrseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.wrseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Wholesale and Retail Sector Education and Training Authority (W&RSETA)"
