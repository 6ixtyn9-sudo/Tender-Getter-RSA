"""Mining Qualifications Authority (MQA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mining Qualifications Authority (MQA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mining Qualifications Authority (MQA) tenders</h1>
        <table>
            <thead>
...
class MqaSource:
    """Tender source plug-in for Mining Qualifications Authority (MQA)."""

    source_id: str = "mqa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mqa.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Mining Qualifications Authority (MQA)"
