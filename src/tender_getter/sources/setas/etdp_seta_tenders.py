"""Education, Training and Development Practices SETA (ETDP SETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Education, Training and Development Practices SETA (ETDP SETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Education, Training and Development Practices SETA (ETDP SETA) tenders</h1>
        <table>
            <thead>
...
class EtdpSetaSource:
    """Tender source plug-in for Education, Training and Development Practices SETA (ETDP SETA)."""

    source_id: str = "etdp_seta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.etdpseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Education, Training and Development Practices SETA (ETDP SETA)"
