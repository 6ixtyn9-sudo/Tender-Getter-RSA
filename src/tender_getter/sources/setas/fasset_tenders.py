"""Finance and Accounting Services SETA (FASSET) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Finance and Accounting Services SETA (FASSET) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Finance and Accounting Services SETA (FASSET) tenders</h1>
        <table>
            <thead>
...
class FassetSource:
    """Tender source plug-in for Finance and Accounting Services SETA (FASSET)."""

    source_id: str = "fasset_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.fasset.org.za/Pages/Tenders"):
        self.url = url
        self.issuing_entity = "Finance and Accounting Services SETA (FASSET)"
