"""Health and Welfare Sector Education and Training Authority (HWSETA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Health and Welfare Sector Education and Training Authority (HWSETA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Health and Welfare Sector Education and Training Authority (HWSETA) tenders</h1>
        <table>
            <thead>
...
class HwsetaSource:
    """Tender source plug-in for Health and Welfare Sector Education and Training Authority (HWSETA)."""

    source_id: str = "hwseta_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.hwseta.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Health and Welfare Sector Education and Training Authority (HWSETA)"
