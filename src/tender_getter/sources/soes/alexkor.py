"""Alexkor SOC Ltd Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Alexkor SOC Ltd Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Alexkor SOC Ltd tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>ALEXKOR/2025/MIN/05</td>
                    <td>Diamond Mining Equipment Supply (Northern Cape)</td>
                    <td>2026-09-05 11:00:00</td>
                </tr>
                <tr>
                    <td>ALEXKOR/2025/ENV/02</td>
                    <td>Coastal Land Rehabilitation (Northern Cape, Grade 2CE)</td>
                    <td>2026-08-24 11:00:00</td>
                </tr>
                <tr>
                    <td>ALEXKOR/2025/SEC/09</td>
                    <td>Mine Security Services (Northern Cape)</td>
...
class AlexkorSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Alexkor SOC Ltd tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_ALEXKOR_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_ALEXKOR_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Alexkor SOC Ltd tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Alexkor SOC Ltd",
