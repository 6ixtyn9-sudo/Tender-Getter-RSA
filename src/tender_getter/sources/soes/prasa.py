"""Passenger Rail Agency of South Africa (PRASA) Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Passenger Rail Agency of South Africa (PRASA) Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Passenger Rail Agency of South Africa (PRASA) tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>PRASA/2025/041</td>
                    <td>Station Cleaning Services – Park Station (Gauteng)</td>
                    <td>2026-09-10 11:00:00</td>
                </tr>
                <tr>
                    <td>PRASA/2025/038</td>
                    <td>Signal System Maintenance – Gauteng Corridor (Gauteng, Grade 4EE)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>PRASA/2025/022</td>
                    <td>Security Services – Metrorail Western Cape (Gauteng)</td>
...
class PRASASource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Passenger Rail Agency of South Africa (PRASA) tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_PRASA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Passenger Rail Agency of South Africa (PRASA) tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Passenger Rail Agency of South Africa (PRASA)",
