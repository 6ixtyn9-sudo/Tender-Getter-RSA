"""South African Broadcasting Corporation Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Broadcasting Corporation Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active South African Broadcasting Corporation tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>SABC/TV/2025/14</td>
                    <td>Studio Camera System Upgrade (Gauteng)</td>
                    <td>2026-09-08 11:00:00</td>
                </tr>
                <tr>
                    <td>SABC/RADIO/2025/06</td>
                    <td>FM Transmitter Maintenance (Gauteng, Grade 3EE)</td>
                    <td>2026-08-27 11:00:00</td>
                </tr>
                <tr>
                    <td>SABC/ICT/2025/09</td>
                    <td>Media Asset Management Software (Gauteng)</td>
...
class SABCSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active South African Broadcasting Corporation tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SABC_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses South African Broadcasting Corporation tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="South African Broadcasting Corporation",
