...
<!DOCTYPE html>
<html>
<head><title>PetroSA Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active PetroSA tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>PETROSA/2025/OFF/14</td>
                    <td>Offshore Gas Platform Maintenance (Western Cape, Grade 7ME)</td>
                    <td>2026-09-16 11:00:00</td>
                </tr>
                <tr>
                    <td>PETROSA/2025/REF/08</td>
                    <td>Refinery Turnaround Services – Mossel Bay (Western Cape, Grade 6ME)</td>
                    <td>2026-09-03 11:00:00</td>
                </tr>
                <tr>
                    <td>PETROSA/2025/PIPE/05</td>
                    <td>Coastal Pipeline Inspection (Western Cape, Grade 4CE)</td>
...
class PetroSASource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active PetroSA tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_PETROSA_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_PETROSA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses PetroSA tenders table/list from HTML using standard Python regex.
        """
        tenders = []
