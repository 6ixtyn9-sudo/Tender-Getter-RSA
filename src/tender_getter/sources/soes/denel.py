"""Denel SOC Ltd Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Denel SOC Ltd Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Denel SOC Ltd tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>DENEL/2025/MFG/12</td>
                    <td>Precision Component Fabrication (Gauteng, Grade 4ME)</td>
                    <td>2026-09-11 11:00:00</td>
                </tr>
                <tr>
                    <td>DENEL/2025/ICT/04</td>
                    <td>Aeronautical Simulation Software (Gauteng)</td>
                    <td>2026-08-26 11:00:00</td>
                </tr>
                <tr>
                    <td>DENEL/2025/FAC/08</td>
                    <td>Facility Security Upgrade (Gauteng)</td>
...
class DenelSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Denel SOC Ltd tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DENEL_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Denel SOC Ltd tenders table/list from HTML using standard Python regex.
        """
        tenders = []
