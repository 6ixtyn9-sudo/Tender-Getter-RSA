"""Land and Agricultural Development Bank of South Africa Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Land and Agricultural Development Bank of South Africa Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Land and Agricultural Development Bank of South Africa tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>LB/2025/ICT/07</td>
                    <td>Core Banking Software Upgrade (National)</td>
                    <td>2026-09-12 11:00:00</td>
                </tr>
                <tr>
                    <td>LB/2025/AUDIT/03</td>
                    <td>External Audit Services Panel (National)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>LB/2025/CONS/11</td>
                    <td>Agricultural Advisory Services (National)</td>
...
class LandbankSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Land and Agricultural Development Bank of South Africa tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_LANDBANK_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_LANDBANK_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Land and Agricultural Development Bank of South Africa tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Land and Agricultural Development Bank of South Africa",
