"""Sentech SOC Ltd Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sentech SOC Ltd Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Sentech SOC Ltd tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>SENTECH/2025/RF/09</td>
                    <td>Signal Tower Maintenance – National (National, Grade 3EE)</td>
                    <td>2026-09-09 11:00:00</td>
                </tr>
                <tr>
                    <td>SENTECH/2025/ICT/15</td>
                    <td>Digital Terrestrial TV Platform (National)</td>
                    <td>2026-09-14 11:00:00</td>
                </tr>
                <tr>
                    <td>SENTECH/2025/TOWER/02</td>
                    <td>Mast Structural Audit (National, Grade 2CE)</td>
...
class SentechSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Sentech SOC Ltd tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_SENTECH_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SENTECH_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Sentech SOC Ltd tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Sentech SOC Ltd",
