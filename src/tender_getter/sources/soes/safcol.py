"""South African Forestry Company Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Forestry Company Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active South African Forestry Company tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>SAFCOL/2025/EQ/07</td>
                    <td>Forest Harvesting Equipment (Mpumalanga)</td>
                    <td>2026-09-04 11:00:00</td>
                </tr>
                <tr>
                    <td>SAFCOL/2025/ENV/03</td>
                    <td>Environmental Rehabilitation – Komatiland (Mpumalanga)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>SAFCOL/2025/TRANS/11</td>
                    <td>Timber Transport Services (Mpumalanga)</td>
...
class SAFCOLSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active South African Forestry Company tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SAFCOL_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses South African Forestry Company tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="South African Forestry Company",
