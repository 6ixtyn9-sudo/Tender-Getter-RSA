"""Air Traffic & Navigation Services Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Air Traffic & Navigation Services Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Air Traffic & Navigation Services tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>ATNS/2025/RADAR/07</td>
                    <td>Radar System Maintenance (Gauteng, Grade 4EE)</td>
                    <td>2026-09-08 11:00:00</td>
                </tr>
                <tr>
                    <td>ATNS/2025/ATC/12</td>
                    <td>Air Traffic Control Software Upgrade (Gauteng)</td>
                    <td>2026-09-19 11:00:00</td>
                </tr>
                <tr>
                    <td>ATNS/2025/NAV/03</td>
                    <td>Navigation Aid Calibration (Gauteng)</td>
...
class ATNSSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Air Traffic & Navigation Services tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_ATNS_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Air Traffic & Navigation Services tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Air Traffic & Navigation Services",
