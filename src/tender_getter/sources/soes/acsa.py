"""Airports Company South Africa Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Airports Company South Africa Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Airports Company South Africa tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>ACSA/ORT/2025/33</td>
                    <td>Runway Resurfacing – OR Tambo (National, Grade 7CE)</td>
                    <td>2026-09-20 11:00:00</td>
                </tr>
                <tr>
                    <td>ACSA/CT/2025/18</td>
                    <td>Baggage Handling System Maintenance (National, Grade 4ME)</td>
                    <td>2026-09-02 11:00:00</td>
                </tr>
                <tr>
                    <td>ACSA/KSIA/2025/05</td>
                    <td>Terminal Building Upgrade – King Shaka (National, Grade 5GB)</td>
...
class ACSASource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Airports Company South Africa tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_ACSA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Airports Company South Africa tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Airports Company South Africa",
