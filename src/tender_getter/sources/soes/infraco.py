"""Broadband Infraco Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Broadband Infraco Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Broadband Infraco tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>INFRA/2025/FIBRE/21</td>
                    <td>National Fibre Backhaul – Phase 3 (National, Grade 5EE)</td>
                    <td>2026-09-13 11:00:00</td>
                </tr>
                <tr>
                    <td>INFRA/2025/ICT/09</td>
                    <td>Network Management Software (National)</td>
                    <td>2026-08-27 11:00:00</td>
                </tr>
                <tr>
                    <td>INFRA/2025/MAINT/04</td>
                    <td>Fibre Route Maintenance – Free State (National, Grade 3EE)</td>
...
class BroadbandInfracoSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Broadband Infraco tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_INFRACO_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_INFRACO_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Broadband Infraco tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Broadband Infraco",
