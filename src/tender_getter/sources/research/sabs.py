"""South African Bureau of Standards Tender Source Plugin"""
import logging
import re
...
MOCK_SABS_HTML = """
<!DOCTYPE html><html><head><title>South African Bureau of Standards Tenders</title></head><body><div class="wrapper"><h1>Active South African Bureau of Standards tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>SABS/2025/LAB/10</td>
                    <td>Testing Laboratory Equipment (Gauteng)</td>
                    <td>2026-09-08 11:00:00</td>
                </tr>
                <tr>
                    <td>SABS/2025/ICT/04</td>
                    <td>Standards Compliance Software (Gauteng)</td>
                    <td>2026-08-29 11:00:00</td>
                </tr>
                <tr>
                    <td>SABS/2025/CONS/06</td>
                    <td>Certification Audit Services (Gauteng)</td>
...
class SABSSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active South African Bureau of Standards tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SABS_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses South African Bureau of Standards tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="South African Bureau of Standards",
