...
MOCK_MINTEK_HTML = """
<!DOCTYPE html><html><head><title>Mintek Tenders</title></head><body><div class="wrapper"><h1>Active Mintek tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>MINTEK/2025/LAB/08</td>
                    <td>Metallurgical Lab Supplies (Gauteng)</td>
                    <td>2026-09-07 11:00:00</td>
                </tr>
                <tr>
                    <td>MINTEK/2025/CONS/04</td>
                    <td>Minerals Research Consultancy (Gauteng)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>MINTEK/2025/EQ/12</td>
                    <td>Analytical Instrumentation (Gauteng)</td>
...
class MintekSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Mintek tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_MINTEK_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Mintek tenders table/list from HTML using standard Python regex.
        """
        tenders = []
