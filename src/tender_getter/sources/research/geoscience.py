"""Council for Geoscience Tender Source Plugin"""
import logging
import re
...
MOCK_GEOSCIENCE_HTML = """
<!DOCTYPE html><html><head><title>Council for Geoscience Tenders</title></head><body><div class="wrapper"><h1>Active Council for Geoscience tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>CGS/2025/SEIS/06</td>
                    <td>Seismic Mapping Services (Gauteng)</td>
                    <td>2026-09-10 11:00:00</td>
                </tr>
                <tr>
                    <td>CGS/2025/DRILL/02</td>
                    <td>Deep Core Drilling Contract (Gauteng, Grade 3CE)</td>
                    <td>2026-08-27 11:00:00</td>
                </tr>
                <tr>
                    <td>CGS/2025/CONS/13</td>
                    <td>Geophysics Consultancy (Gauteng)</td>
...
class GeoscienceSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Council for Geoscience tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_GEOSCIENCE_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_GEOSCIENCE_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Council for Geoscience tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Council for Geoscience",
