"""Human Sciences Research Council Tender Source Plugin"""
import logging
import re
...
MOCK_HSRC_HTML = """
<!DOCTYPE html><html><head><title>Human Sciences Research Council Tenders</title></head><body><div class="wrapper"><h1>Active Human Sciences Research Council tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>HSRC/2025/SURV/15</td>
                    <td>Socio-Economic Survey Services (Gauteng)</td>
                    <td>2026-09-13 11:00:00</td>
                </tr>
                <tr>
                    <td>HSRC/2025/ICT/05</td>
                    <td>Census Data Software (Gauteng)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>HSRC/2025/CONS/09</td>
                    <td>Policy Research Consultancy (Gauteng)</td>
...
class HSRCSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Human Sciences Research Council tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_HSRC_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Human Sciences Research Council tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Human Sciences Research Council",
