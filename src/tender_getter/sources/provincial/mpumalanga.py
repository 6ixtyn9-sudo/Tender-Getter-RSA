"""Mpumalanga Provincial Treasury Tender Source Plugin"""
import logging
import re
...
MOCK_MPUMALANGA_HTML = """
<!DOCTYPE html>
<html>
<head><title>Mpumalanga Provincial Treasury Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Mpumalanga Provincial Treasury tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>MPT/CE/2025/27</td>
                    <td>Road Resurfacing – Ehlanzeni (Mpumalanga, Grade 6CE)</td>
                    <td>2026-09-16 11:00:00</td>
                </tr>
                <tr>
                    <td>MPT/EE/2025/14</td>
                    <td>Substation Upgrade – Nkangala (Mpumalanga, Grade 4EE)</td>
                    <td>2026-09-03 11:00:00</td>
                </tr>
                <tr>
                    <td>MPT/GB/2025/06</td>
                    <td>Office Building Maintenance – Mbombela (Mpumalanga, Grade 2GB)</td>
...
class MpumalangaSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Mpumalanga Provincial Treasury tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_MPUMALANGA_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_MPUMALANGA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Mpumalanga Provincial Treasury tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Mpumalanga Provincial Treasury",
