"""Limpopo Provincial Treasury Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Limpopo Provincial Treasury Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Limpopo Provincial Treasury tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>LPT/CE/2025/18</td>
                    <td>Water Reticulation – Capricorn (Limpopo, Grade 5CE)</td>
                    <td>2026-09-11 11:00:00</td>
                </tr>
                <tr>
                    <td>LPT/GB/2025/04</td>
                    <td>School Classroom Blocks – Vhembe (Limpopo, Grade 3GB)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>LPT/EE/2025/09</td>
                    <td>Solar Street Lights – Polokwane (Limpopo, Grade 2EE)</td>
...
class LimpopoSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Limpopo Provincial Treasury tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_LIMPOPO_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_LIMPOPO_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Limpopo Provincial Treasury tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Limpopo Provincial Treasury",
