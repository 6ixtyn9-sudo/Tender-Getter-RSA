"""North West Provincial Treasury Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>North West Provincial Treasury Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active North West Provincial Treasury tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>NWPT/CE/2025/19</td>
                    <td>Stormwater Drainage – Bojanala (North West, Grade 4CE)</td>
                    <td>2026-09-07 11:00:00</td>
                </tr>
                <tr>
                    <td>NWPT/EE/2025/08</td>
                    <td>Clinic Electrical Compliance – Dr Kenneth Kaunda (North West, Grade 2EE)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>NWPT/SERV/2025/03</td>
                    <td>Security Services Panel – Mahikeng (North West)</td>
...
class NorthWestSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active North West Provincial Treasury tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_NORTHWEST_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_NORTHWEST_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses North West Provincial Treasury tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="North West Provincial Treasury",
