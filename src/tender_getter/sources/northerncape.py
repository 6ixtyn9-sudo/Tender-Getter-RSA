"""Northern Cape Provincial Treasury Tender Source Plugin"""
import logging
import re
...
MOCK_NORTHERNCAPE_HTML = """
<!DOCTYPE html>
<html>
<head><title>Northern Cape Provincial Treasury Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Northern Cape Provincial Treasury tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>NCPT/CE/2025/15</td>
                    <td>Desert Road Maintenance – Namakwa (Northern Cape, Grade 3CE)</td>
                    <td>2026-09-13 11:00:00</td>
                </tr>
                <tr>
                    <td>NCPT/EE/2025/05</td>
                    <td>Solar PV Installation – Pixley ka Seme (Northern Cape, Grade 2EE)</td>
                    <td>2026-08-31 11:00:00</td>
                </tr>
                <tr>
                    <td>NCPT/GB/2025/02</td>
                    <td>Government Office Refurbishment – Kimberley (Northern Cape, Grade 2GB)</td>
...
class NorthernCapeSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Northern Cape Provincial Treasury tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_NORTHERNCAPE_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_NORTHERNCAPE_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Northern Cape Provincial Treasury tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Northern Cape Provincial Treasury",
