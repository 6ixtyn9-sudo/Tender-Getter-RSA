"""National Youth Development Agency (NYDA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Youth Development Agency (NYDA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Youth Development Agency (NYDA) tenders</h1>
        <table>
            <thead>
...
class NydaSource:
    """Tender source plug-in for National Youth Development Agency (NYDA)."""

    source_id: str = "nyda_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nyda.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "National Youth Development Agency (NYDA)"
