"""South African Civil Aviation Authority (SACAA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Civil Aviation Authority (SACAA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Civil Aviation Authority (SACAA) tenders</h1>
        <table>
            <thead>
...
class SacaaSource:
    """Tender source plug-in for South African Civil Aviation Authority (SACAA)."""

    source_id: str = "sacaa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.caa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Civil Aviation Authority (SACAA)"
