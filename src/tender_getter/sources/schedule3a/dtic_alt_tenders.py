"""DTIC (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>DTIC (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DTIC (alt URL) tenders</h1>
        <table>
            <thead>
...
class DticAltSource:
    """Tender source plug-in for DTIC (alt URL)."""

    source_id: str = "dtic_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.thedtic.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "DTIC (alt URL)"
