"""Western Cape Health (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Western Cape Health (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Western Cape Health (alt URL) tenders</h1>
        <table>
            <thead>
...
class WcHealthAltSource:
    """Tender source plug-in for Western Cape Health (alt URL)."""

    source_id: str = "wc_health_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.westerncape.gov.za/dept/health/procurement"):
        self.url = url
        self.issuing_entity = "Western Cape Health (alt URL)"
