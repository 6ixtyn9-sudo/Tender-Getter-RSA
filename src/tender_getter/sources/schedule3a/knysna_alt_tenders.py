"""Knysna (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Knysna (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Knysna (alt) tenders</h1>
        <table>
            <thead>
...
class KnysnaAltSource:
    """Tender source plug-in for Knysna (alt)."""

    source_id: str = "knysna_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.knysna.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Knysna (alt)"
