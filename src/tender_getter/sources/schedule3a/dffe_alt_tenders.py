"""DFFE (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>DFFE (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DFFE (alt) tenders</h1>
        <table>
            <thead>
...
class DffeAltSource:
    """Tender source plug-in for DFFE (alt)."""

    source_id: str = "dffe_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dffe.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "DFFE (alt)"
