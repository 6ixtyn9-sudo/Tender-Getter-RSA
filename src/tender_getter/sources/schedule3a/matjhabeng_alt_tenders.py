"""Matjhabeng (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Matjhabeng (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Matjhabeng (alt) tenders</h1>
        <table>
            <thead>
...
class MatjhabengAltSource:
    """Tender source plug-in for Matjhabeng (alt)."""

    source_id: str = "matjhabeng_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.matjhabeng.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Matjhabeng (alt)"
