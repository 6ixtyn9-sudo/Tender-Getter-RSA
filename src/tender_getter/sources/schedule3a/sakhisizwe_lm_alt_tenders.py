"""Sakhisizwe (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sakhisizwe (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sakhisizwe (alt) tenders</h1>
        <table>
            <thead>
...
class SakhisizweLmAltSource:
    """Tender source plug-in for Sakhisizwe (alt)."""

    source_id: str = "sakhisizwe_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sakhisizwe.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Sakhisizwe (alt)"
