"""South African Nursing Council (SANC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Nursing Council (SANC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Nursing Council (SANC) tenders</h1>
        <table>
            <thead>
...
class SancSource:
    """Tender source plug-in for South African Nursing Council (SANC)."""

    source_id: str = "sanc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sanc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Nursing Council (SANC)"
