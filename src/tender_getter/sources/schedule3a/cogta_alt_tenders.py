"""COGTA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>COGTA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active COGTA (alt) tenders</h1>
        <table>
            <thead>
...
class CogtaAltSource:
    """Tender source plug-in for COGTA (alt)."""

    source_id: str = "cogta_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cogta.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "COGTA (alt)"
