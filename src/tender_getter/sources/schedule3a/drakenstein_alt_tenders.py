"""Drakenstein (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Drakenstein (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Drakenstein (alt) tenders</h1>
        <table>
            <thead>
...
class DrakensteinAltSource:
    """Tender source plug-in for Drakenstein (alt)."""

    source_id: str = "drakenstein_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.drakenstein.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Drakenstein (alt)"
