"""SANRAL (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SANRAL (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SANRAL (alt) tenders</h1>
        <table>
            <thead>
...
class SanralAltSource:
    """Tender source plug-in for SANRAL (alt)."""

    source_id: str = "sanral_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nra.co.za/procurement"):
        self.url = url
        self.issuing_entity = "SANRAL (alt)"
