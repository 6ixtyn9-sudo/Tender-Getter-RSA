"""NYDA (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>NYDA (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NYDA (alt URL) tenders</h1>
        <table>
            <thead>
...
class NydaAltSource:
    """Tender source plug-in for NYDA (alt URL)."""

    source_id: str = "nyda_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nyda.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "NYDA (alt URL)"
