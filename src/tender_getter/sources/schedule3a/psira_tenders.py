"""Private Security Industry Regulatory Authority (PSIRA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Private Security Industry Regulatory Authority (PSIRA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Private Security Industry Regulatory Authority (PSIRA) tenders</h1>
        <table>
            <thead>
...
class PsiraSource:
    """Tender source plug-in for Private Security Industry Regulatory Authority (PSIRA)."""

    source_id: str = "psira_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.psira.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Private Security Industry Regulatory Authority (PSIRA)"
