"""South African Tourism tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Tourism Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Tourism tenders</h1>
        <table>
            <thead>
...
class SatSource:
    """Tender source plug-in for South African Tourism."""

    source_id: str = "sat_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.southafrica.net/procurement"):
        self.url = url
        self.issuing_entity = "South African Tourism"
