"""Saldanha Bay (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Saldanha Bay (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Saldanha Bay (alt) tenders</h1>
        <table>
            <thead>
...
class SaldanhaBayAltSource:
    """Tender source plug-in for Saldanha Bay (alt)."""

    source_id: str = "saldanha_bay_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.saldanhabay.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Saldanha Bay (alt)"
