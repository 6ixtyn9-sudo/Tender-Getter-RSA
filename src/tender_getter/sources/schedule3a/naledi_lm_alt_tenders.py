"""Naledi (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Naledi (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Naledi (alt) tenders</h1>
        <table>
            <thead>
...
class NalediLmAltSource:
    """Tender source plug-in for Naledi (alt)."""

    source_id: str = "naledi_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.naledi.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Naledi (alt)"
