"""Compensation Fund (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Compensation Fund (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Compensation Fund (alt) tenders</h1>
        <table>
            <thead>
...
class CompensationFundAltSource:
    """Tender source plug-in for Compensation Fund (alt)."""

    source_id: str = "compensation_fund_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.labour.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Compensation Fund (alt)"
