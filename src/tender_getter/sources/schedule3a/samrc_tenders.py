"""South African Medical Research Council (SAMRC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Medical Research Council (SAMRC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Medical Research Council (SAMRC) tenders</h1>
        <table>
            <thead>
...
class SamrcSource:
    """Tender source plug-in for South African Medical Research Council (SAMRC)."""

    source_id: str = "samrc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.samrc.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Medical Research Council (SAMRC)"
