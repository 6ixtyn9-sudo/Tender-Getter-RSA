"""DPSA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>DPSA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DPSA (alt) tenders</h1>
        <table>
            <thead>
...
class DpsacAltSource:
    """Tender source plug-in for DPSA (alt)."""

    source_id: str = "dpsac_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dpsa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "DPSA (alt)"
