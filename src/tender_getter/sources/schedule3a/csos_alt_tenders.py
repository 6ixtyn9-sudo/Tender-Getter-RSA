"""CSOS (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>CSOS (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CSOS (alt) tenders</h1>
        <table>
            <thead>
...
class CsosAltSource:
    """Tender source plug-in for CSOS (alt)."""

    source_id: str = "csos_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.csos.org.za/procurement"):
        self.url = url
        self.issuing_entity = "CSOS (alt)"
