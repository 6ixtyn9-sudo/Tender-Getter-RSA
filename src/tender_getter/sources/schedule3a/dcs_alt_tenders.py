"""Department of Correctional Services (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Correctional Services (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Correctional Services (alt URL) tenders</h1>
        <table>
            <thead>
...
class DcsAltSource:
    """Tender source plug-in for Department of Correctional Services (alt URL)."""

    source_id: str = "dcs_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dcs.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Department of Correctional Services (alt URL)"
