"""National Gambling Board (NGB) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Gambling Board (NGB) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Gambling Board (NGB) tenders</h1>
        <table>
            <thead>
...
class NgbSource:
    """Tender source plug-in for National Gambling Board (NGB)."""

    source_id: str = "ngb_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ngb.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Gambling Board (NGB)"
