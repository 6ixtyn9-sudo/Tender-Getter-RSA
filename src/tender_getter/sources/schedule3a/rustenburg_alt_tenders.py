"""Rustenburg (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Rustenburg (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Rustenburg (alt) tenders</h1>
        <table>
            <thead>
...
class RustenburgAltSource:
    """Tender source plug-in for Rustenburg (alt)."""

    source_id: str = "rustenburg_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.rustenburg.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Rustenburg (alt)"
