...
<!DOCTYPE html>
<html>
<head><title>RAF (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active RAF (alt) tenders</h1>
        <table>
            <thead>
...
class RafAltSource:
    """Tender source plug-in for RAF (alt)."""

    source_id: str = "raf_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.raf.co.za/procurement"):
        self.url = url
        self.issuing_entity = "RAF (alt)"
