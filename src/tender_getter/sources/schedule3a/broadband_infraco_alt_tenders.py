"""Infraco (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Infraco (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Infraco (alt) tenders</h1>
        <table>
            <thead>
...
class BroadbandInfracoAltSource:
    """Tender source plug-in for Infraco (alt)."""

    source_id: str = "broadband_infraco_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.infraco.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Infraco (alt)"
