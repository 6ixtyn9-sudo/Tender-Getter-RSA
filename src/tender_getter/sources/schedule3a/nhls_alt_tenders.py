"""NHLS (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>NHLS (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NHLS (alt URL) tenders</h1>
        <table>
            <thead>
...
class NhlsAltSource:
    """Tender source plug-in for NHLS (alt URL)."""

    source_id: str = "nhls_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nhls.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "NHLS (alt URL)"
