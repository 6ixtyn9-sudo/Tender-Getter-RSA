"""Garden Route (DM alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Garden Route (DM alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Garden Route (DM alt URL) tenders</h1>
        <table>
            <thead>
...
class GardenRouteDmAltSource:
    """Tender source plug-in for Garden Route (DM alt URL)."""

    source_id: str = "garden_route_dm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.grdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Garden Route (DM alt URL)"
