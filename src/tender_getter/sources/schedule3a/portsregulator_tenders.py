"""Ports Regulator of South Africa tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ports Regulator of South Africa Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ports Regulator of South Africa tenders</h1>
        <table>
            <thead>
...
class PortsregulatorSource:
    """Tender source plug-in for Ports Regulator of South Africa."""

    source_id: str = "portsregulator_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.portsregulator.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ports Regulator of South Africa"
