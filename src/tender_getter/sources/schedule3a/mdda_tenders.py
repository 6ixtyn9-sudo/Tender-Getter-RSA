"""Media Development and Diversity Agency (MDDA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Media Development and Diversity Agency (MDDA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Media Development and Diversity Agency (MDDA) tenders</h1>
        <table>
            <thead>
...
class MddaSource:
    """Tender source plug-in for Media Development and Diversity Agency (MDDA)."""

    source_id: str = "mdda_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mdda.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Media Development and Diversity Agency (MDDA)"
