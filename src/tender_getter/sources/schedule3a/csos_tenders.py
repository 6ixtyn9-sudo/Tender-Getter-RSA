"""Community Schemes Ombud Service (CSOS) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Community Schemes Ombud Service (CSOS) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Community Schemes Ombud Service (CSOS) tenders</h1>
        <table>
            <thead>
...
class CsosSource:
    """Tender source plug-in for Community Schemes Ombud Service (CSOS)."""

    source_id: str = "csos_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.csos.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Community Schemes Ombud Service (CSOS)"
