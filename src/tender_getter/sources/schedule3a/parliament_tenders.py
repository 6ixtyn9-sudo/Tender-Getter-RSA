"""Parliament of South Africa tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Parliament of South Africa Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Parliament of South Africa tenders</h1>
        <table>
            <thead>
...
class ParliamentSource:
    """Tender source plug-in for Parliament of South Africa."""

    source_id: str = "parliament_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.parliament.gov.za/storage/app/media/Tenders/index.html"):
        self.url = url
        self.issuing_entity = "Parliament of South Africa"
