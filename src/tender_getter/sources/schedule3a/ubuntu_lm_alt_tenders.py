"""Ubuntu (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ubuntu (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ubuntu (alt) tenders</h1>
        <table>
            <thead>
...
class UbuntuLmAltSource:
    """Tender source plug-in for Ubuntu (alt)."""

    source_id: str = "ubuntu_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ubuntu.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ubuntu (alt)"
