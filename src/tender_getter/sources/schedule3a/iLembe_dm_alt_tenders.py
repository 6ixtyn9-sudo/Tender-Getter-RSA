"""iLembe (DM legacy URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>iLembe (DM legacy URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active iLembe (DM legacy URL) tenders</h1>
        <table>
            <thead>
...
class IlembeDmAltSource:
    """Tender source plug-in for iLembe (DM legacy URL)."""

    source_id: str = "iLembe_dm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ilembeboard.co.za/tenders"):
        self.url = url
        self.issuing_entity = "iLembe (DM legacy URL)"
