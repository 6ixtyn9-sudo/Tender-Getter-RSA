"""Ehlanzeni (DM alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ehlanzeni (DM alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ehlanzeni (DM alt URL) tenders</h1>
        <table>
            <thead>
...
class EhlanzeniDmAltSource:
    """Tender source plug-in for Ehlanzeni (DM alt URL)."""

    source_id: str = "ehlanzeni_dm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ehlanzenidm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ehlanzeni (DM alt URL)"
