"""Agricultural Research Council (ARC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Agricultural Research Council (ARC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Agricultural Research Council (ARC) tenders</h1>
        <table>
            <thead>
...
class ArcSource:
    """Tender source plug-in for Agricultural Research Council (ARC)."""

    source_id: str = "arc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.arc.agric.za/procurement"):
        self.url = url
        self.issuing_entity = "Agricultural Research Council (ARC)"
