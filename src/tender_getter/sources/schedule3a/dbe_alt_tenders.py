"""Department of Basic Education (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Basic Education (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Basic Education (alt URL) tenders</h1>
        <table>
            <thead>
...
class DbeAltSource:
    """Tender source plug-in for Department of Basic Education (alt URL)."""

    source_id: str = "dbe_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.education.gov.za/Tenders.aspx"):
        self.url = url
        self.issuing_entity = "Department of Basic Education (alt URL)"
