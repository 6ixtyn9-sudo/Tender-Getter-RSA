"""Department of Justice and Constitutional Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Justice and Constitutional Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Justice and Constitutional Development tenders</h1>
        <table>
            <thead>
...
class DojcdSource:
    """Tender source plug-in for Department of Justice and Constitutional Development."""

    source_id: str = "dojcd_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.justice.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Department of Justice and Constitutional Development"
