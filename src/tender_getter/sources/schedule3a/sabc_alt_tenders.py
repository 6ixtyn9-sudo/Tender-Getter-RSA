"""SABC (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SABC (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SABC (alt URL) tenders</h1>
        <table>
            <thead>
...
class SabcAltSource:
    """Tender source plug-in for SABC (alt URL)."""

    source_id: str = "sabc_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sabc.co.za/sabc/tenders"):
        self.url = url
        self.issuing_entity = "SABC (alt URL)"
