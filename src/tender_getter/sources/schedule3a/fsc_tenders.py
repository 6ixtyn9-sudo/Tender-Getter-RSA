"""Financial Sector Conduct Authority (FSCA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Financial Sector Conduct Authority (FSCA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Financial Sector Conduct Authority (FSCA) tenders</h1>
        <table>
            <thead>
...
class FscSource:
    """Tender source plug-in for Financial Sector Conduct Authority (FSCA)."""

    source_id: str = "fsc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.fsca.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Financial Sector Conduct Authority (FSCA)"
