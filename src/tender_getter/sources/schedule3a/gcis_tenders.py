"""Government Communication and Information System (GCIS) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Government Communication and Information System (GCIS) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Government Communication and Information System (GCIS) tenders</h1>
        <table>
            <thead>
...
class GcisSource:
    """Tender source plug-in for Government Communication and Information System (GCIS)."""

    source_id: str = "gcis_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.gcis.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Government Communication and Information System (GCIS)"
