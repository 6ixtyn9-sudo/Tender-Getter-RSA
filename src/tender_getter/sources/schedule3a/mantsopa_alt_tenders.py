"""Mantsopa (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mantsopa (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mantsopa (alt) tenders</h1>
        <table>
            <thead>
...
class MantsopaAltSource:
    """Tender source plug-in for Mantsopa (alt)."""

    source_id: str = "mantsopa_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.mantsopa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mantsopa (alt)"
