"""Pensions Fund Adjudicator tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Pensions Fund Adjudicator Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Pensions Fund Adjudicator tenders</h1>
        <table>
            <thead>
...
class PfAdjudicatorSource:
    """Tender source plug-in for Pensions Fund Adjudicator."""

    source_id: str = "pf_adjudicator_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.pfa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Pensions Fund Adjudicator"
