"""Legal Aid SA (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Legal Aid SA (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Legal Aid SA (alt URL) tenders</h1>
        <table>
            <thead>
...
class LegalAidAltSource:
    """Tender source plug-in for Legal Aid SA (alt URL)."""

    source_id: str = "legal_aid_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.legal-aid.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Legal Aid SA (alt URL)"
