"""Brand South Africa tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Brand South Africa Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Brand South Africa tenders</h1>
        <table>
            <thead>
...
class BrandSaSource:
    """Tender source plug-in for Brand South Africa."""

    source_id: str = "brand_sa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.brandsouthafrica.com/procurement"):
        self.url = url
        self.issuing_entity = "Brand South Africa"
