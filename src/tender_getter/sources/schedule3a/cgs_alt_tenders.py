...
<!DOCTYPE html>
<html>
<head><title>CGS (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active CGS (alt) tenders</h1>
        <table>
            <thead>
...
class CgsAltSource:
    """Tender source plug-in for CGS (alt)."""

    source_id: str = "cgs_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cgs.co.za/procurement"):
        self.url = url
        self.issuing_entity = "CGS (alt)"
