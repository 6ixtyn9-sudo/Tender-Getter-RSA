...
<!DOCTYPE html>
<html>
<head><title>UIF (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UIF (alt) tenders</h1>
        <table>
            <thead>
...
class UifAltSource:
    """Tender source plug-in for UIF (alt)."""

    source_id: str = "uif_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.labour.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "UIF (alt)"
