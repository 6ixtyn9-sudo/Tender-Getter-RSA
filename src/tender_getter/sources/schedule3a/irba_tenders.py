"""Independent Regulatory Board for Auditors (IRBA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Independent Regulatory Board for Auditors (IRBA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Independent Regulatory Board for Auditors (IRBA) tenders</h1>
        <table>
            <thead>
...
class IrbaSource:
    """Tender source plug-in for Independent Regulatory Board for Auditors (IRBA)."""

    source_id: str = "irba_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.irba.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Independent Regulatory Board for Auditors (IRBA)"
