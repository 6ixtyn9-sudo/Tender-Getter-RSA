"""Land Bank (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Land Bank (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Land Bank (alt) tenders</h1>
        <table>
            <thead>
...
class LandbankAltSource:
    """Tender source plug-in for Land Bank (alt)."""

    source_id: str = "landbank_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://landbank.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Land Bank (alt)"
