"""Financial Intelligence Centre (FIC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Financial Intelligence Centre (FIC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Financial Intelligence Centre (FIC) tenders</h1>
        <table>
            <thead>
...
class FinancialIntelCentreSource:
    """Tender source plug-in for Financial Intelligence Centre (FIC)."""

    source_id: str = "financial_intel_centre_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.fic.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Financial Intelligence Centre (FIC)"
