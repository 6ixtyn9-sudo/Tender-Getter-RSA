"""National Student Financial Aid Scheme (NSFAS) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Student Financial Aid Scheme (NSFAS) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Student Financial Aid Scheme (NSFAS) tenders</h1>
        <table>
            <thead>
...
class NsfasSource:
    """Tender source plug-in for National Student Financial Aid Scheme (NSFAS)."""

    source_id: str = "nsfas_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nsfas.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Student Financial Aid Scheme (NSFAS)"
