"""SARS (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SARS (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SARS (alt URL) tenders</h1>
        <table>
            <thead>
...
class SarsAltSource:
    """Tender source plug-in for SARS (alt URL)."""

    source_id: str = "sars_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sars.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "SARS (alt URL)"
