"""Perishable Products Export Control Board (PPECB) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Perishable Products Export Control Board (PPECB) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Perishable Products Export Control Board (PPECB) tenders</h1>
        <table>
            <thead>
...
class PpecbSource:
    """Tender source plug-in for Perishable Products Export Control Board (PPECB)."""

    source_id: str = "ppecb_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ppecb.com/procurement"):
        self.url = url
        self.issuing_entity = "Perishable Products Export Control Board (PPECB)"
