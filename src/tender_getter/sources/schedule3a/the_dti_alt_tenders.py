"""DTIC (legacy) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>DTIC (legacy) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DTIC (legacy) tenders</h1>
        <table>
            <thead>
...
class TheDtiAltSource:
    """Tender source plug-in for DTIC (legacy)."""

    source_id: str = "the_dti_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.thedti.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "DTIC (legacy)"
