"""Sentech (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sentech (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sentech (alt URL) tenders</h1>
        <table>
            <thead>
...
class SentechAltSource:
    """Tender source plug-in for Sentech (alt URL)."""

    source_id: str = "sentech_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sentech.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Sentech (alt URL)"
