"""Khai-Ma (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Khai-Ma (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Khai-Ma (alt) tenders</h1>
        <table>
            <thead>
...
class KharaHaisLmAltSource:
    """Tender source plug-in for Khai-Ma (alt)."""

    source_id: str = "khara_hais_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.khara-hais.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Khai-Ma (alt)"
