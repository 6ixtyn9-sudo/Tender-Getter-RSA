"""Alexkor (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Alexkor (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Alexkor (alt) tenders</h1>
        <table>
            <thead>
...
class AlexkorAltSource:
    """Tender source plug-in for Alexkor (alt)."""

    source_id: str = "alexkor_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.alexkor.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Alexkor (alt)"
