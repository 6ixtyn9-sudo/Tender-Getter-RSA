"""Health Professions Council of South Africa (HPCSA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Health Professions Council of South Africa (HPCSA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Health Professions Council of South Africa (HPCSA) tenders</h1>
        <table>
            <thead>
...
class HcpsaSource:
    """Tender source plug-in for Health Professions Council of South Africa (HPCSA)."""

    source_id: str = "hcpsa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.hpcsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Health Professions Council of South Africa (HPCSA)"
