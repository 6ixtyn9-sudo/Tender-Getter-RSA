"""National Energy Regulator of South Africa (NERSA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Energy Regulator of South Africa (NERSA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Energy Regulator of South Africa (NERSA) tenders</h1>
        <table>
            <thead>
...
class NersaSource:
    """Tender source plug-in for National Energy Regulator of South Africa (NERSA)."""

    source_id: str = "nersa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nersa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Energy Regulator of South Africa (NERSA)"
