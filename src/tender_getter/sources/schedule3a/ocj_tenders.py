"""Office of the Chief Justice (OCJ) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Office of the Chief Justice (OCJ) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Office of the Chief Justice (OCJ) tenders</h1>
        <table>
            <thead>
...
class OcjSource:
    """Tender source plug-in for Office of the Chief Justice (OCJ)."""

    source_id: str = "ocj_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.judiciary.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Office of the Chief Justice (OCJ)"
