"""South African National Accreditation System (SANAS) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African National Accreditation System (SANAS) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African National Accreditation System (SANAS) tenders</h1>
        <table>
            <thead>
...
class SanasSource:
    """Tender source plug-in for South African National Accreditation System (SANAS)."""

    source_id: str = "sanas_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sanas.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South African National Accreditation System (SANAS)"
