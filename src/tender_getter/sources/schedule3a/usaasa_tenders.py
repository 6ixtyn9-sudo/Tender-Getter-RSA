"""Universal Service and Access Agency of South Africa (USAASA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Universal Service and Access Agency of South Africa (USAASA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Universal Service and Access Agency of South Africa (USAASA) tenders</h1>
        <table>
            <thead>
...
class UsaasaSource:
    """Tender source plug-in for Universal Service and Access Agency of South Africa (USAASA)."""

    source_id: str = "usaasa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.usaasa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Universal Service and Access Agency of South Africa (USAASA)"
