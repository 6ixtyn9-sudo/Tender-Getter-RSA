"""SANParks (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SANParks (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SANParks (alt) tenders</h1>
        <table>
            <thead>
...
class SanparksAltSource:
    """Tender source plug-in for SANParks (alt)."""

    source_id: str = "sanparks_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sanparks.org/procurement"):
        self.url = url
        self.issuing_entity = "SANParks (alt)"
