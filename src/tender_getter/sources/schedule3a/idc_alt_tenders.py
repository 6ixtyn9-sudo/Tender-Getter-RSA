...
<!DOCTYPE html>
<html>
<head><title>IDC (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active IDC (alt) tenders</h1>
        <table>
            <thead>
...
class IdcAltSource:
    """Tender source plug-in for IDC (alt)."""

    source_id: str = "idc_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.idc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "IDC (alt)"
