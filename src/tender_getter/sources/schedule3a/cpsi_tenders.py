"""Centre for Public Service Innovation (CPSI) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Centre for Public Service Innovation (CPSI) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Centre for Public Service Innovation (CPSI) tenders</h1>
        <table>
            <thead>
...
class CpsiSource:
    """Tender source plug-in for Centre for Public Service Innovation (CPSI)."""

    source_id: str = "cpsi_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cpsi.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Centre for Public Service Innovation (CPSI)"
