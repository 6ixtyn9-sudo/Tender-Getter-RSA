"""Fetakgomo (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Fetakgomo (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Fetakgomo (alt) tenders</h1>
        <table>
            <thead>
...
class FetakgomoAltSource:
    """Tender source plug-in for Fetakgomo (alt)."""

    source_id: str = "fetakgomo_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.fetakgomo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Fetakgomo (alt)"
