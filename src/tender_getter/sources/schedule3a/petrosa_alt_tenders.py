"""PetroSA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>PetroSA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active PetroSA (alt) tenders</h1>
        <table>
            <thead>
...
class PetrosaAltSource:
    """Tender source plug-in for PetroSA (alt)."""

    source_id: str = "petrosa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.petrosa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "PetroSA (alt)"
