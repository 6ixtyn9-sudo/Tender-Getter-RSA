"""NHBRC (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>NHBRC (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NHBRC (alt) tenders</h1>
        <table>
            <thead>
...
class NhbrcAltSource:
    """Tender source plug-in for NHBRC (alt)."""

    source_id: str = "nhbrc_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nhbrc.org.za/procurement"):
        self.url = url
        self.issuing_entity = "NHBRC (alt)"
