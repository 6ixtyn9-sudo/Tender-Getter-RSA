"""Department of Social Development tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Social Development Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Social Development tenders</h1>
        <table>
            <thead>
...
class DsdSource:
    """Tender source plug-in for Department of Social Development."""

    source_id: str = "dsd_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dsd.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Department of Social Development"
