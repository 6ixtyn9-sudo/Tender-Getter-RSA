"""Ombudsman for Banking Services tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ombudsman for Banking Services Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ombudsman for Banking Services tenders</h1>
        <table>
            <thead>
...
class BankingOmbudSource:
    """Tender source plug-in for Ombudsman for Banking Services."""

    source_id: str = "banking_ombud_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.obssa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ombudsman for Banking Services"
