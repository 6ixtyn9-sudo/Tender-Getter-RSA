"""Ntabankulu (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ntabankulu (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ntabankulu (alt) tenders</h1>
        <table>
            <thead>
...
class NtabankuluLmAltSource:
    """Tender source plug-in for Ntabankulu (alt)."""

    source_id: str = "ntabankulu_lm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.ntabankulu.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ntabankulu (alt)"
