"""LP Treasury (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>LP Treasury (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active LP Treasury (alt) tenders</h1>
        <table>
            <thead>
...
class LimpopoProvincialTreasuryAltSource:
    """Tender source plug-in for LP Treasury (alt)."""

    source_id: str = "limpopo_provincial_treasury_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.treasury.limpopo.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "LP Treasury (alt)"
