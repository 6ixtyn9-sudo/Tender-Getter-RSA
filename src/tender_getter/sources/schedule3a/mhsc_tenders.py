"""Mine Health and Safety Council (MHSC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mine Health and Safety Council (MHSC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mine Health and Safety Council (MHSC) tenders</h1>
        <table>
            <thead>
...
class MhscSource:
    """Tender source plug-in for Mine Health and Safety Council (MHSC)."""

    source_id: str = "mhsc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mhsc.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Mine Health and Safety Council (MHSC)"
