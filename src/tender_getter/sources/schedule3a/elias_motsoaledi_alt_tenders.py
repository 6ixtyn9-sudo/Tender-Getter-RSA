"""Elias Motsoaledi (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Elias Motsoaledi (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Elias Motsoaledi (alt) tenders</h1>
        <table>
            <thead>
...
class EliasMotsoalediAltSource:
    """Tender source plug-in for Elias Motsoaledi (alt)."""

    source_id: str = "elias_motsoaledi_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.eliasmotsoaledi.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Elias Motsoaledi (alt)"
