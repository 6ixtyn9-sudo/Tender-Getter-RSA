"""EC Treasury (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>EC Treasury (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active EC Treasury (alt URL) tenders</h1>
        <table>
            <thead>
...
class EcTreasuryAltSource:
    """Tender source plug-in for EC Treasury (alt URL)."""

    source_id: str = "ec_treasury_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ecprov.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "EC Treasury (alt URL)"
