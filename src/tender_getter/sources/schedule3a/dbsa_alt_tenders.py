"""DBSA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>DBSA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DBSA (alt) tenders</h1>
        <table>
            <thead>
...
class DbsaAltSource:
    """Tender source plug-in for DBSA (alt)."""

    source_id: str = "dbsa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dbsa.org/procurement"):
        self.url = url
        self.issuing_entity = "DBSA (alt)"
