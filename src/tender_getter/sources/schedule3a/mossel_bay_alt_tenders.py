"""Mossel Bay (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Mossel Bay (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Mossel Bay (alt) tenders</h1>
        <table>
            <thead>
...
class MosselBayAltSource:
    """Tender source plug-in for Mossel Bay (alt)."""

    source_id: str = "mossel_bay_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.mosselbay.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Mossel Bay (alt)"
