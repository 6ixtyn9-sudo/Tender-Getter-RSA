"""Property Practitioners Regulatory Authority (PPRA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Property Practitioners Regulatory Authority (PPRA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Property Practitioners Regulatory Authority (PPRA) tenders</h1>
        <table>
            <thead>
...
class PpraSource:
    """Tender source plug-in for Property Practitioners Regulatory Authority (PPRA)."""

    source_id: str = "ppra_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ppra.org.za/procurement"):
        self.url = url
        self.issuing_entity = "Property Practitioners Regulatory Authority (PPRA)"
