"""DPME (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>DPME (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DPME (alt URL) tenders</h1>
        <table>
            <thead>
...
class DpmEAltSource:
    """Tender source plug-in for DPME (alt URL)."""

    source_id: str = "dpm_e_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dpme.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "DPME (alt URL)"
