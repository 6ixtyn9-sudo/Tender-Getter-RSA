"""Ombudsman for Long-Term Insurance tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ombudsman for Long-Term Insurance Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ombudsman for Long-Term Insurance tenders</h1>
        <table>
            <thead>
...
class LongtermInsOmbudSource:
    """Tender source plug-in for Ombudsman for Long-Term Insurance."""

    source_id: str = "longterm_ins_ombud_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.oltinsurance.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ombudsman for Long-Term Insurance"
