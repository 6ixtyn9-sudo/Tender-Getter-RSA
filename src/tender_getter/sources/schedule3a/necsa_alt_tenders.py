"""NECSA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>NECSA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NECSA (alt) tenders</h1>
        <table>
            <thead>
...
class NecsaAltSource:
    """Tender source plug-in for NECSA (alt)."""

    source_id: str = "necsa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.necsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "NECSA (alt)"
