"""National Credit Regulator (NCR) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Credit Regulator (NCR) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Credit Regulator (NCR) tenders</h1>
        <table>
            <thead>
...
class NcrSource:
    """Tender source plug-in for National Credit Regulator (NCR)."""

    source_id: str = "ncr_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ncr.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Credit Regulator (NCR)"
