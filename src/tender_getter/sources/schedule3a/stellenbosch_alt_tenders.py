...
class StellenboschAltSource:
    """Tender source plug-in for Stellenbosch (alt)."""

    source_id: str = "stellenbosch_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sun.ac.za/procurement"):
        self.url = url
