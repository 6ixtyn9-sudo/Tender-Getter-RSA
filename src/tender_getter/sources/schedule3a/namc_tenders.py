"""National Agricultural Marketing Council (NAMC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Agricultural Marketing Council (NAMC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Agricultural Marketing Council (NAMC) tenders</h1>
        <table>
            <thead>
...
class NamcSource:
    """Tender source plug-in for National Agricultural Marketing Council (NAMC)."""

    source_id: str = "namc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.namc.co.za/procurement"):
        self.url = url
        self.issuing_entity = "National Agricultural Marketing Council (NAMC)"
