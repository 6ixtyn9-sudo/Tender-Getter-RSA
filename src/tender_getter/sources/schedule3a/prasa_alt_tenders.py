"""PRASA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>PRASA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active PRASA (alt) tenders</h1>
        <table>
            <thead>
...
class PrasaAltSource:
    """Tender source plug-in for PRASA (alt)."""

    source_id: str = "prasa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.prasa.com/procurement"):
        self.url = url
        self.issuing_entity = "PRASA (alt)"
