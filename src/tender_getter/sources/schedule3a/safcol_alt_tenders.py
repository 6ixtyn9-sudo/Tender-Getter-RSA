"""SAFCOL (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SAFCOL (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SAFCOL (alt) tenders</h1>
        <table>
            <thead>
...
class SafcolAltSource:
    """Tender source plug-in for SAFCOL (alt)."""

    source_id: str = "safcol_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.safcol.co.za/procurement"):
        self.url = url
        self.issuing_entity = "SAFCOL (alt)"
