"""sefa (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>sefa (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active sefa (alt) tenders</h1>
        <table>
            <thead>
...
class SefaAltSource:
    """Tender source plug-in for sefa (alt)."""

    source_id: str = "sefa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sefa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "sefa (alt)"
