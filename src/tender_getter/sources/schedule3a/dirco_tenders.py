"""Department of International Relations and Cooperation (DIRCO) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of International Relations and Cooperation (DIRCO) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of International Relations and Cooperation (DIRCO) tenders</h1>
        <table>
            <thead>
...
class DircoSource:
    """Tender source plug-in for Department of International Relations and Cooperation (DIRCO)."""

    source_id: str = "dirco_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dirco.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Department of International Relations and Cooperation (DIRCO)"
