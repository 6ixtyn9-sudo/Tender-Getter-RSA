"""Ombudsman for Short-Term Insurance tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ombudsman for Short-Term Insurance Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ombudsman for Short-Term Insurance tenders</h1>
        <table>
            <thead>
...
class InsuranceOmbudSource:
    """Tender source plug-in for Ombudsman for Short-Term Insurance."""

    source_id: str = "insurance_ombud_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.osti.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Ombudsman for Short-Term Insurance"
