"""South African National Energy Development Institute (SANEDI) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African National Energy Development Institute (SANEDI) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African National Energy Development Institute (SANEDI) tenders</h1>
        <table>
            <thead>
...
class SanediSource:
    """Tender source plug-in for South African National Energy Development Institute (SANEDI)."""

    source_id: str = "sanedi_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sanedi.org.za/procurement"):
        self.url = url
        self.issuing_entity = "South African National Energy Development Institute (SANEDI)"
