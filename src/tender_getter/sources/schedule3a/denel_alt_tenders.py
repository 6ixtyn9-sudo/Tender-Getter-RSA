"""Denel (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Denel (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Denel (alt) tenders</h1>
        <table>
            <thead>
...
class DenelAltSource:
    """Tender source plug-in for Denel (alt)."""

    source_id: str = "denel_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.denel.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Denel (alt)"
