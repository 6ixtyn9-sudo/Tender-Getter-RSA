"""National Consumer Commission tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Consumer Commission Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Consumer Commission tenders</h1>
        <table>
            <thead>
...
class NcaSource:
    """Tender source plug-in for National Consumer Commission."""

    source_id: str = "nca_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.thencc.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "National Consumer Commission"
