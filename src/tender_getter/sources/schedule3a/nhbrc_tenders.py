"""National Home Builders Registration Council (NHBRC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Home Builders Registration Council (NHBRC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Home Builders Registration Council (NHBRC) tenders</h1>
        <table>
            <thead>
...
class NhbrcSource:
    """Tender source plug-in for National Home Builders Registration Council (NHBRC)."""

    source_id: str = "nhbrc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nhbrc.org.za/procurement"):
        self.url = url
        self.issuing_entity = "National Home Builders Registration Council (NHBRC)"
