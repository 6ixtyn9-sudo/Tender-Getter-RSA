"""DIRCO (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>DIRCO (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DIRCO (alt) tenders</h1>
        <table>
            <thead>
...
class DircoAltSource:
    """Tender source plug-in for DIRCO (alt)."""

    source_id: str = "dirco_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dirco.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "DIRCO (alt)"
