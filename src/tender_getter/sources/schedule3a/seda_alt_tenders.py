"""SEDA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SEDA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SEDA (alt) tenders</h1>
        <table>
            <thead>
...
class SedaAltSource:
    """Tender source plug-in for SEDA (alt)."""

    source_id: str = "seda_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.seda.org.za/procurement"):
        self.url = url
        self.issuing_entity = "SEDA (alt)"
