...
<!DOCTYPE html>
<html>
<head><title>UL (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active UL (alt) tenders</h1>
        <table>
            <thead>
...
class UlAltSource:
    """Tender source plug-in for UL (alt)."""

    source_id: str = "ul_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ul.ac.za/procurement"):
        self.url = url
        self.issuing_entity = "UL (alt)"
