"""Statistics South Africa tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Statistics South Africa Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Statistics South Africa tenders</h1>
        <table>
            <thead>
...
class StatsSaSource:
    """Tender source plug-in for Statistics South Africa."""

    source_id: str = "stats_sa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.statssa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Statistics South Africa"
