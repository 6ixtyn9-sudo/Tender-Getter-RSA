"""National School of Government (NSG) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National School of Government (NSG) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National School of Government (NSG) tenders</h1>
        <table>
            <thead>
...
class NsgSource:
    """Tender source plug-in for National School of Government (NSG)."""

    source_id: str = "nsg_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.thensg.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "National School of Government (NSG)"
