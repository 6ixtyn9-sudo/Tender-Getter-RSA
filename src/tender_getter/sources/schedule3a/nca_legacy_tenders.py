"""National Consumer Agency (legacy) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Consumer Agency (legacy) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Consumer Agency (legacy) tenders</h1>
        <table>
            <thead>
...
class NcaLegacySource:
    """Tender source plug-in for National Consumer Agency (legacy)."""

    source_id: str = "nca_legacy_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.thenca.co.za/procurement"):
        self.url = url
        self.issuing_entity = "National Consumer Agency (legacy)"
