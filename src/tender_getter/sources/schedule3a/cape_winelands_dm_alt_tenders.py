"""Cape Winelands (DM alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Cape Winelands (DM alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Cape Winelands (DM alt URL) tenders</h1>
        <table>
            <thead>
...
class CapeWinelandsDmAltSource:
    """Tender source plug-in for Cape Winelands (DM alt URL)."""

    source_id: str = "cape_winelands_dm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.cwdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Cape Winelands (DM alt URL)"
