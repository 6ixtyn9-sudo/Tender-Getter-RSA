"""Department of Women, Youth and Persons with Disabilities tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Women, Youth and Persons with Disabilities Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Women, Youth and Persons with Disabilities tenders</h1>
        <table>
            <thead>
...
class DwypdSource:
    """Tender source plug-in for Department of Women, Youth and Persons with Disabilities."""

    source_id: str = "dwypd_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dwypd.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Department of Women, Youth and Persons with Disabilities"
