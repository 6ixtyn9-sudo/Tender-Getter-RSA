"""KZN Treasury (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Treasury (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Treasury (alt URL) tenders</h1>
        <table>
            <thead>
...
class KznTreasuryAltSource:
    """Tender source plug-in for KZN Treasury (alt URL)."""

    source_id: str = "kzn_treasury_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.kzntreasury.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Treasury (alt URL)"
