"""Transnet (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Transnet (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Transnet (alt) tenders</h1>
        <table>
            <thead>
...
class TransnetAltSource:
    """Tender source plug-in for Transnet (alt)."""

    source_id: str = "transnet_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.transnet.net/procurement"):
        self.url = url
        self.issuing_entity = "Transnet (alt)"
