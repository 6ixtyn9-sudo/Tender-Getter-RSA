"""ATNS (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>ATNS (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active ATNS (alt) tenders</h1>
        <table>
            <thead>
...
class AtnsAltSource:
    """Tender source plug-in for ATNS (alt)."""

    source_id: str = "atns_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.atns.com/procurement"):
        self.url = url
        self.issuing_entity = "ATNS (alt)"
