"""SAMSA (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SAMSA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SAMSA (alt) tenders</h1>
        <table>
            <thead>
...
class SamsaAltSource:
    """Tender source plug-in for SAMSA (alt)."""

    source_id: str = "samsa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.samsa.org.za/procurement"):
        self.url = url
        self.issuing_entity = "SAMSA (alt)"
