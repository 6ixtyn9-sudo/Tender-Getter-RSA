"""Sedibeng District Municipality (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sedibeng District Municipality (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sedibeng District Municipality (alt URL) tenders</h1>
        <table>
            <thead>
...
class SedibengDmAltSource:
    """Tender source plug-in for Sedibeng District Municipality (alt URL)."""

    source_id: str = "sedibeng_dm_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.sedibengdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Sedibeng District Municipality (alt URL)"
