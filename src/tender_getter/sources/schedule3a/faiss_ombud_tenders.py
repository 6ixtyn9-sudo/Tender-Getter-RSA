"""Office of the Ombud for Financial Services Providers tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Office of the Ombud for Financial Services Providers Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Office of the Ombud for Financial Services Providers tenders</h1>
        <table>
            <thead>
...
class FaissOmbudSource:
    """Tender source plug-in for Office of the Ombud for Financial Services Providers."""

    source_id: str = "faiss_ombud_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.faissombud.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Office of the Ombud for Financial Services Providers"
