"""National Nuclear Regulator (NNR) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>National Nuclear Regulator (NNR) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active National Nuclear Regulator (NNR) tenders</h1>
        <table>
            <thead>
...
class NnrSource:
    """Tender source plug-in for National Nuclear Regulator (NNR)."""

    source_id: str = "nnr_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nnr.co.za/procurement"):
        self.url = url
        self.issuing_entity = "National Nuclear Regulator (NNR)"
