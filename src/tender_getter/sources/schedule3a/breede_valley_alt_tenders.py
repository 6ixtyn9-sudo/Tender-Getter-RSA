"""Breede Valley (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Breede Valley (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Breede Valley (alt) tenders</h1>
        <table>
            <thead>
...
class BreedeValleyAltSource:
    """Tender source plug-in for Breede Valley (alt)."""

    source_id: str = "breede_valley_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.bvmun.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Breede Valley (alt)"
