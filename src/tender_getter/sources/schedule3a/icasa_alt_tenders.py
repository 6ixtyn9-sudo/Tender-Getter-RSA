"""ICASA (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>ICASA (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active ICASA (alt URL) tenders</h1>
        <table>
            <thead>
...
class IcasaAltSource:
    """Tender source plug-in for ICASA (alt URL)."""

    source_id: str = "icasa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.icasa.org.za/tenders"):
        self.url = url
        self.issuing_entity = "ICASA (alt URL)"
