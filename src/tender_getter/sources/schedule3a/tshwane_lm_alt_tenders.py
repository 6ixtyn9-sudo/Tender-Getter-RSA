"""Tshwane (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Tshwane (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Tshwane (alt) tenders</h1>
        <table>
            <thead>
...
class TshwaneLmAltSource:
    """Tender source plug-in for Tshwane (alt)."""

    source_id: str = "tshwane_lm_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tshwane.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Tshwane (alt)"
