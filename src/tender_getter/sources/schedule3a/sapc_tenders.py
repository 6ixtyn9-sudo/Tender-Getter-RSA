"""South African Pharmacy Council (SAPC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Pharmacy Council (SAPC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Pharmacy Council (SAPC) tenders</h1>
        <table>
            <thead>
...
class SapcSource:
    """Tender source plug-in for South African Pharmacy Council (SAPC)."""

    source_id: str = "sapc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.pharmcouncil.co.za/procurement"):
        self.url = url
        self.issuing_entity = "South African Pharmacy Council (SAPC)"
