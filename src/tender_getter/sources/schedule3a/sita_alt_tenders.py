"""SITA (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>SITA (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active SITA (alt URL) tenders</h1>
        <table>
            <thead>
...
class SitaAltSource:
    """Tender source plug-in for SITA (alt URL)."""

    source_id: str = "sita_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sita.co.za/tenders"):
        self.url = url
        self.issuing_entity = "SITA (alt URL)"
