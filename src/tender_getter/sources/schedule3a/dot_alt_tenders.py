...
<!DOCTYPE html>
<html>
<head><title>DoT (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active DoT (alt) tenders</h1>
        <table>
            <thead>
...
class DotAltSource:
    """Tender source plug-in for DoT (alt)."""

    source_id: str = "dot_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.transport.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "DoT (alt)"
