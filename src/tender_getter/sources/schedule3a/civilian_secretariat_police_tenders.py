"""Civilian Secretariat for Police Service tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Civilian Secretariat for Police Service Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Civilian Secretariat for Police Service tenders</h1>
        <table>
            <thead>
...
class CivilianSecretariatPoliceSource:
    """Tender source plug-in for Civilian Secretariat for Police Service."""

    source_id: str = "civilian_secretariat_police_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.policesecretariat.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Civilian Secretariat for Police Service"
