"""ZA Domain Name Authority (ZADNA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>ZA Domain Name Authority (ZADNA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active ZA Domain Name Authority (ZADNA) tenders</h1>
        <table>
            <thead>
...
class ZadnaSource:
    """Tender source plug-in for ZA Domain Name Authority (ZADNA)."""

    source_id: str = "zadna_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.zadna.org.za/procurement"):
        self.url = url
        self.issuing_entity = "ZA Domain Name Authority (ZADNA)"
