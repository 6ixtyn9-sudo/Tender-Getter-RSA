"""uMhlathuze (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMhlathuze (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMhlathuze (alt) tenders</h1>
        <table>
            <thead>
...
class MhlatuzeLmAltSource:
    """Tender source plug-in for uMhlathuze (alt)."""

    source_id: str = "mhlatuze_lm_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.umhlathuze.co.za/procurement"):
        self.url = url
        self.issuing_entity = "uMhlathuze (alt)"
