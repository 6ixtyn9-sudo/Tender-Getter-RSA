"""Department of Higher Education and Training (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Higher Education and Training (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Higher Education and Training (alt URL) tenders</h1>
        <table>
            <thead>
...
class DhetAltSource:
    """Tender source plug-in for Department of Higher Education and Training (alt URL)."""

    source_id: str = "dhet_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dhet.gov.za/Tenders"):
        self.url = url
        self.issuing_entity = "Department of Higher Education and Training (alt URL)"
