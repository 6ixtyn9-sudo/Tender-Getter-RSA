"""Dipaleseng (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Dipaleseng (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Dipaleseng (alt) tenders</h1>
        <table>
            <thead>
...
class DipalesengAltSource:
    """Tender source plug-in for Dipaleseng (alt)."""

    source_id: str = "dipaleseng_alt_tenders"
    live: bool = False

    def __init__(self, url: str = "https://www.dipaleseng.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Dipaleseng (alt)"
