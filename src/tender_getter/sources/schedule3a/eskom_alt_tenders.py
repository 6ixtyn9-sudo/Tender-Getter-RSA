"""Eskom (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Eskom (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Eskom (alt) tenders</h1>
        <table>
            <thead>
...
class EskomAltSource:
    """Tender source plug-in for Eskom (alt)."""

    source_id: str = "eskom_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.eskom.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Eskom (alt)"
