...
<!DOCTYPE html>
<html>
<head><title>NPA (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active NPA (alt) tenders</h1>
        <table>
            <thead>
...
class NpaAltSource:
    """Tender source plug-in for NPA (alt)."""

    source_id: str = "npa_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.npa.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "NPA (alt)"
