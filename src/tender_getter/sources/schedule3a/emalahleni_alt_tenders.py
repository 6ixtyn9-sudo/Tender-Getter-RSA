"""Emalahleni (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Emalahleni (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Emalahleni (alt) tenders</h1>
        <table>
            <thead>
...
class EmalahleniAltSource:
    """Tender source plug-in for Emalahleni (alt)."""

    source_id: str = "emalahleni_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.emalahleni.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Emalahleni (alt)"
