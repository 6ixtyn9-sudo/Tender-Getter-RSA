"""KZN Housing (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>KZN Housing (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active KZN Housing (alt) tenders</h1>
        <table>
            <thead>
...
class KznHousingAltSource:
    """Tender source plug-in for KZN Housing (alt)."""

    source_id: str = "kzn_housing_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.kznhs.org.za/procurement"):
        self.url = url
        self.issuing_entity = "KZN Housing (alt)"
