"""Emfuleni (alt) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Emfuleni (alt) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Emfuleni (alt) tenders</h1>
        <table>
            <thead>
...
class EmfuleniAltSource:
    """Tender source plug-in for Emfuleni (alt)."""

    source_id: str = "emfuleni_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.emfuleni.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Emfuleni (alt)"
