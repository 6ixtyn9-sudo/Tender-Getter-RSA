"""Department of Military Veterans tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Military Veterans Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Military Veterans tenders</h1>
        <table>
            <thead>
...
class DmvSource:
    """Tender source plug-in for Department of Military Veterans."""

    source_id: str = "dmv_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dmv.gov.za/procurement"):
        self.url = url
        self.issuing_entity = "Department of Military Veterans"
