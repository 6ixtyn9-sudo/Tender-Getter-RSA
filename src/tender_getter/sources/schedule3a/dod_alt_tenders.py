"""Department of Defence (alt URL) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Department of Defence (alt URL) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Department of Defence (alt URL) tenders</h1>
        <table>
            <thead>
...
class DodAltSource:
    """Tender source plug-in for Department of Defence (alt URL)."""

    source_id: str = "dod_alt_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dod.mil.za/procurement"):
        self.url = url
        self.issuing_entity = "Department of Defence (alt URL)"
