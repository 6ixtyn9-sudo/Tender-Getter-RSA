"""Department of Human Settlements Tender Source Plugin"""
import logging
import re
...
MOCK_DHS_HTML = """
<!DOCTYPE html><html><head><title>Department of Human Settlements Tenders</title></head><body><div class="wrapper"><h1>Active Department of Human Settlements tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DHS/2025/001</td>
                    <td>Professional Services – Settlements (National)</td>
...
class DHSSource:
    source_id: str = "dhs_tenders"

    def __init__(self, url: str = "https://www.dhs.gov.za/tenders"):
        self.url = url

    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Human Settlements tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DHS_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Human Settlements tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Human Settlements",
