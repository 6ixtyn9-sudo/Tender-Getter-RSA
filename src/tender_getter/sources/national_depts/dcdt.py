"""Department of Communications & Digital Technologies Tender Source Plugin"""
import logging
import re
...
MOCK_DCDT_HTML = """
<!DOCTYPE html><html><head><title>Department of Communications & Digital Technologies Tenders</title></head><body><div class="wrapper"><h1>Active Department of Communications & Digital Technologies tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DCDT/2025/001</td>
                    <td>Professional Services – Technologies (National)</td>
...
class DCDTSource:
    source_id: str = "dcdt_tenders"

    def __init__(self, url: str = "https://www.dcdt.gov.za/tenders"):
        self.url = url

    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Communications & Digital Technologies tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DCDT_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Communications & Digital Technologies tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Communications & Digital Technologies",
