"""Department of Basic Education Tender Source Plugin"""
import logging
import re
...
MOCK_DBE_HTML = """
<!DOCTYPE html><html><head><title>Department of Basic Education Tenders</title></head><body><div class="wrapper"><h1>Active Department of Basic Education tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DBE/2025/001</td>
                    <td>Professional Services – Education (National)</td>
...
class DBESource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Basic Education tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DBE_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Basic Education tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Basic Education",
