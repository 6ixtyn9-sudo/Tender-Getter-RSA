...
MOCK_DOH_HTML = """
<!DOCTYPE html><html><head><title>Department of Health Tenders</title></head><body><div class="wrapper"><h1>Active Department of Health tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DOH/2025/001</td>
                    <td>Professional Services – Health (National)</td>
...
class DoHSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Health tenders.
    ...
    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Health tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Health",
