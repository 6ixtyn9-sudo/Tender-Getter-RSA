...
MOCK_DFFE_HTML = """
<!DOCTYPE html><html><head><title>Department of Forestry, Fisheries & the Environment Tenders</title></head><body><div class="wrapper"><h1>Active Department of Forestry, Fisheries & the Environment tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DFFE/2025/001</td>
                    <td>Professional Services – Environment (National)</td>
...
class DFFESource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Forestry, Fisheries & the Environment tenders.
    ...
    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Forestry, Fisheries & the Environment tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Forestry, Fisheries & the Environment",
