"""South African Police Service Tender Source Plugin"""
import logging
import re
...
MOCK_SAPS_HTML = """
<!DOCTYPE html><html><head><title>South African Police Service Tenders</title></head><body><div class="wrapper"><h1>Active South African Police Service tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>SAPS/2025/001</td>
                    <td>Professional Services – Service (National)</td>
...
class SAPSSource:
    source_id: str = "saps_tenders"

    def __init__(self, url: str = "https://www.saps.gov.za/tenders"):
        self.url = url

    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active South African Police Service tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SAPS_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses South African Police Service tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="South African Police Service",
