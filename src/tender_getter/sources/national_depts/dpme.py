"""Department of Planning, Monitoring & Evaluation Tender Source Plugin"""
import logging
import re
...
MOCK_DPME_HTML = """
<!DOCTYPE html><html><head><title>Department of Planning, Monitoring & Evaluation Tenders</title></head><body><div class="wrapper"><h1>Active Department of Planning, Monitoring & Evaluation tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DPME/2025/001</td>
                    <td>Professional Services – Evaluation (National)</td>
...
class DPMESource:
    source_id: str = "dpme_tenders"

    def __init__(self, url: str = "https://www.dpme.gov.za/tenders"):
        self.url = url

    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Planning, Monitoring & Evaluation tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DPME_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Planning, Monitoring & Evaluation tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Planning, Monitoring & Evaluation",
