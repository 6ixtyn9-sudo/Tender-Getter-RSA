"""Department of Mineral Resources & Energy Tender Source Plugin"""
import logging
import re
...
MOCK_DMRE_HTML = """
<!DOCTYPE html><html><head><title>Department of Mineral Resources & Energy Tenders</title></head><body><div class="wrapper"><h1>Active Department of Mineral Resources & Energy tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DMRE/2025/001</td>
                    <td>Professional Services – Energy (National)</td>
...
class DMRESource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Mineral Resources & Energy tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DMRE_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Mineral Resources & Energy tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Mineral Resources & Energy",
