"""Department of Tourism Tender Source Plugin"""
import logging
import re
...
MOCK_TOURISM_HTML = """
<!DOCTYPE html><html><head><title>Department of Tourism Tenders</title></head><body><div class="wrapper"><h1>Active Department of Tourism tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>TOUR/2025/001</td>
                    <td>Professional Services – Tourism (National)</td>
...
class TourismSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Tourism tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_TOURISM_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_TOURISM_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Tourism tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Tourism",
