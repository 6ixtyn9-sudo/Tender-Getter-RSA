"""Department of Public Service & Administration Tender Source Plugin"""
import logging
import re
...
MOCK_DPSA_HTML = """
<!DOCTYPE html><html><head><title>Department of Public Service & Administration Tenders</title></head><body><div class="wrapper"><h1>Active Department of Public Service & Administration tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DPSA/2025/001</td>
                    <td>Professional Services – Administration (National)</td>
...
class DPSASource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Public Service & Administration tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DPSA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Public Service & Administration tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Public Service & Administration",
