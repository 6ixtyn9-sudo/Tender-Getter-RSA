"""Department of Water and Sanitation Tender Source Plugin"""
import logging
import re
...
MOCK_DWS_HTML = """
<!DOCTYPE html><html><head><title>Department of Water and Sanitation Tenders</title></head><body><div class="wrapper"><h1>Active Department of Water and Sanitation tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>DWS/2025/001</td>
                    <td>Professional Services – Sanitation (National)</td>
...
class DWSSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Water and Sanitation tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DWS_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Water and Sanitation tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Water and Sanitation",
