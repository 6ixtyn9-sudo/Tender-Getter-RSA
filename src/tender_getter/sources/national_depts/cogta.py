"""Department of Cooperative Governance & Traditional Affairs Tender Source Plugin"""
import logging
import re
...
MOCK_COGTA_HTML = """
<!DOCTYPE html><html><head><title>Department of Cooperative Governance & Traditional Affairs Tenders</title></head><body><div class="wrapper"><h1>Active Department of Cooperative Governance & Traditional Affairs tenders</h1><table><thead><tr><th>Bid Number</th><th>Bid Description</th><th>Closing Date</th></tr></thead><tbody>
                <tr>
                    <td>COGT/2025/001</td>
                    <td>Professional Services – Affairs (National)</td>
...
class COGTASource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Department of Cooperative Governance & Traditional Affairs tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_COGTA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Department of Cooperative Governance & Traditional Affairs tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Department of Cooperative Governance & Traditional Affairs",
