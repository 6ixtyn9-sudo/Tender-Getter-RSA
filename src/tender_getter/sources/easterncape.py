"""Eastern Cape Provincial Treasury Tender Source Plugin"""
import logging
import re
...
MOCK_EASTERNCAPE_HTML = """
<!DOCTYPE html>
<html>
<head><title>Eastern Cape Provincial Treasury Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Eastern Cape Provincial Treasury tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>ECPT/EE/2025/11</td>
                    <td>School Electrification Programme – OR Tambo (Eastern Cape, Grade 3EE)</td>
                    <td>2026-09-06 11:00:00</td>
                </tr>
                <tr>
                    <td>ECPT/CE/2025/22</td>
                    <td>Rural Road Gravel to Tar – Amathole (Eastern Cape, Grade 5CE)</td>
                    <td>2026-09-14 11:00:00</td>
                </tr>
                <tr>
                    <td>ECPT/GB/2025/07</td>
                    <td>Clinic Renovation – Chris Hani (Eastern Cape, Grade 2GB)</td>
...
class EasternCapeSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Eastern Cape Provincial Treasury tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_EASTERNCAPE_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_EASTERNCAPE_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Eastern Cape Provincial Treasury tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Eastern Cape Provincial Treasury",
