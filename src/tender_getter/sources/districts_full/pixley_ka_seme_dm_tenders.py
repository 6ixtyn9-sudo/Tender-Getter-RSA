"""Pixley Ka Seme District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Pixley Ka Seme District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Pixley Ka Seme District Municipality tenders</h1>
        <table>
            <thead>
...
class PixleyKaSemeDmSource:
    """Tender source plug-in for Pixley Ka Seme District Municipality."""

    source_id: str = "pixley_ka_seme_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.pksdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Pixley Ka Seme District Municipality"
