"""Bojanala District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Bojanala District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Bojanala District Municipality tenders</h1>
        <table>
            <thead>
...
class BojanalaDmSource:
    """Tender source plug-in for Bojanala District Municipality."""

    source_id: str = "bojanala_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.bojanala.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Bojanala District Municipality"
