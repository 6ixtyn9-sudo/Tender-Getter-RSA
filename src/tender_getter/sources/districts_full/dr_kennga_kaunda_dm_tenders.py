"""Dr Kenneth Kaunda District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Dr Kenneth Kaunda District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Dr Kenneth Kaunda District Municipality tenders</h1>
        <table>
            <thead>
...
class DrKenngaKaundaDmSource:
    """Tender source plug-in for Dr Kenneth Kaunda District Municipality."""

    source_id: str = "dr_kennga_kaunda_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.dkkdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Dr Kenneth Kaunda District Municipality"
