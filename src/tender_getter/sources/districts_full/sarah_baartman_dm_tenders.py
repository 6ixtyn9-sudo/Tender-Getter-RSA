"""Sarah Baartman District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sarah Baartman District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sarah Baartman District Municipality tenders</h1>
        <table>
            <thead>
...
class SarahBaartmanDmSource:
    """Tender source plug-in for Sarah Baartman District Municipality."""

    source_id: str = "sarah_baartman_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sbdm.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Sarah Baartman District Municipality"
