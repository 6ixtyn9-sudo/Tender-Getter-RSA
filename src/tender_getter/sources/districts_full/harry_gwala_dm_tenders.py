"""Harry Gwala District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Harry Gwala District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Harry Gwala District Municipality tenders</h1>
        <table>
            <thead>
...
class HarryGwalaDmSource:
    """Tender source plug-in for Harry Gwala District Municipality."""

    source_id: str = "harry_gwala_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.harrygwaladm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Harry Gwala District Municipality"
