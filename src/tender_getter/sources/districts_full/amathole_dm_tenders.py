"""Amathole District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Amathole District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Amathole District Municipality tenders</h1>
        <table>
            <thead>
...
class AmatholeDmSource:
    """Tender source plug-in for Amathole District Municipality."""

    source_id: str = "amathole_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.amathole.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Amathole District Municipality"
