"""Fezile Dabi District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Fezile Dabi District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Fezile Dabi District Municipality tenders</h1>
        <table>
            <thead>
...
class FezileDabiDmSource:
    """Tender source plug-in for Fezile Dabi District Municipality."""

    source_id: str = "fezile_dabi_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.feziledabi.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Fezile Dabi District Municipality"
