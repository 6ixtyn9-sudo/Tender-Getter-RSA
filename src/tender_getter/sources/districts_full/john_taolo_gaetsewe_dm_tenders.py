"""John Taolo Gaetsewe District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>John Taolo Gaetsewe District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active John Taolo Gaetsewe District Municipality tenders</h1>
        <table>
            <thead>
...
class JohnTaoloGaetseweDmSource:
    """Tender source plug-in for John Taolo Gaetsewe District Municipality."""

    source_id: str = "john_taolo_gaetsewe_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.jtgdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "John Taolo Gaetsewe District Municipality"
