"""Zululand District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Zululand District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Zululand District Municipality tenders</h1>
        <table>
            <thead>
...
class ZululandDmSource:
    """Tender source plug-in for Zululand District Municipality."""

    source_id: str = "zululand_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.zululand.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Zululand District Municipality"
