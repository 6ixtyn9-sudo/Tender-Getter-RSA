"""Sekhukhune District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Sekhukhune District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Sekhukhune District Municipality tenders</h1>
        <table>
            <thead>
...
class SekhukhuneDmSource:
    """Tender source plug-in for Sekhukhune District Municipality."""

    source_id: str = "sekhukhune_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sekhukhunedm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Sekhukhune District Municipality"
