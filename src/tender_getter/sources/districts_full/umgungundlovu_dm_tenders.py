"""uMgungundlovu District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMgungundlovu District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMgungundlovu District Municipality tenders</h1>
        <table>
            <thead>
...
class UmgungundlovuDmSource:
    """Tender source plug-in for uMgungundlovu District Municipality."""

    source_id: str = "umgungundlovu_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.umdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "uMgungundlovu District Municipality"
