"""uMkhanyakude District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMkhanyakude District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMkhanyakude District Municipality tenders</h1>
        <table>
            <thead>
...
class UmkhanyakudeDmSource:
    """Tender source plug-in for uMkhanyakude District Municipality."""

    source_id: str = "umkhanyakude_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.umdm.co.za/tenders"):
        self.url = url
        self.issuing_entity = "uMkhanyakude District Municipality"
