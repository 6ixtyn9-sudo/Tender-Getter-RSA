"""Amajuba District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Amajuba District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Amajuba District Municipality tenders</h1>
        <table>
            <thead>
...
class AmajubaDmSource:
    """Tender source plug-in for Amajuba District Municipality."""

    source_id: str = "amajuba_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.amajuba.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Amajuba District Municipality"
