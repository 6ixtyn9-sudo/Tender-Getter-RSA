...
<body>
    <div class="tenders-wrapper">
        <h1>Active Namakwa District Municipality tenders</h1>
        <table>
            <thead>
...
class NamakwaDmSource:
    ...
    source_id: str = "namakwa_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.namakwa-dm.gov.za/tenders"):
        self.url = url
