"""Xhariep District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Xhariep District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Xhariep District Municipality tenders</h1>
        <table>
            <thead>
...
class XhariepDmSource:
    """Tender source plug-in for Xhariep District Municipality."""

    source_id: str = "xhariep_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.xhariep.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Xhariep District Municipality"
