"""Thabo Mofutsanyana District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Thabo Mofutsanyana District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Thabo Mofutsanyana District Municipality tenders</h1>
        <table>
            <thead>
...
class ThaboMofutsanyanaDmSource:
    """Tender source plug-in for Thabo Mofutsanyana District Municipality."""

    source_id: str = "thabo_mofutsanyana_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.tmsoa.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Thabo Mofutsanyana District Municipality"
