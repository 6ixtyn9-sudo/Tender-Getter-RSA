"""Chris Hani District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Chris Hani District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Chris Hani District Municipality tenders</h1>
        <table>
            <thead>
...
class ChrisHaniDmSource:
    """Tender source plug-in for Chris Hani District Municipality."""

    source_id: str = "chris_hani_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.chrishanidm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Chris Hani District Municipality"
