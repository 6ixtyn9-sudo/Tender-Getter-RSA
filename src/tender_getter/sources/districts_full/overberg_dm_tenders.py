"""Overberg District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Overberg District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Overberg District Municipality tenders</h1>
        <table>
            <thead>
...
class OverbergDmSource:
    """Tender source plug-in for Overberg District Municipality."""

    source_id: str = "overberg_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.odm.org.za/tenders"):
        self.url = url
        self.issuing_entity = "Overberg District Municipality"
