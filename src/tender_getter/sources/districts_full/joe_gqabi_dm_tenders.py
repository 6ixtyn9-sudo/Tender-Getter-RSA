"""Joe Gqabi District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Joe Gqabi District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Joe Gqabi District Municipality tenders</h1>
        <table>
            <thead>
...
class JoeGqabiDmSource:
    """Tender source plug-in for Joe Gqabi District Municipality."""

    source_id: str = "joe_gqabi_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.jgdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Joe Gqabi District Municipality"
