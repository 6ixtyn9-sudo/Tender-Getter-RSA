"""Gert Sibande District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Gert Sibande District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Gert Sibande District Municipality tenders</h1>
        <table>
            <thead>
...
class GertSibandeDmSource:
    """Tender source plug-in for Gert Sibande District Municipality."""

    source_id: str = "gert_sibande_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.gsibande.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Gert Sibande District Municipality"
