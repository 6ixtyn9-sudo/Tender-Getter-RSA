"""Vhembe District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Vhembe District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Vhembe District Municipality tenders</h1>
        <table>
            <thead>
...
class VhembeDmSource:
    """Tender source plug-in for Vhembe District Municipality."""

    source_id: str = "vhembe_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.vhembe.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Vhembe District Municipality"
