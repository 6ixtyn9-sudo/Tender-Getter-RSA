"""Lejweleputswa District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Lejweleputswa District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Lejweleputswa District Municipality tenders</h1>
        <table>
            <thead>
...
class LejweleputswaDmSource:
    """Tender source plug-in for Lejweleputswa District Municipality."""

    source_id: str = "lejweleputswa_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.lejwe.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Lejweleputswa District Municipality"
