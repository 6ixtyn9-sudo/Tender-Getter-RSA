"""Francis Baard District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Francis Baard District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Francis Baard District Municipality tenders</h1>
        <table>
            <thead>
...
class FrancisBaardDmSource:
    """Tender source plug-in for Francis Baard District Municipality."""

    source_id: str = "francis_baard_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.francisbaard.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Francis Baard District Municipality"
