"""Waterberg District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Waterberg District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Waterberg District Municipality tenders</h1>
        <table>
            <thead>
...
class WaterbergDmSource:
    """Tender source plug-in for Waterberg District Municipality."""

    source_id: str = "waterberg_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.waterberg.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Waterberg District Municipality"
