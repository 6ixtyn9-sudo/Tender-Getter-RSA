"""Alfred Nzo District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Alfred Nzo District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Alfred Nzo District Municipality tenders</h1>
        <table>
            <thead>
...
class AlfredNzoDmSource:
    """Tender source plug-in for Alfred Nzo District Municipality."""

    source_id: str = "alfred_nzo_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.andm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Alfred Nzo District Municipality"
