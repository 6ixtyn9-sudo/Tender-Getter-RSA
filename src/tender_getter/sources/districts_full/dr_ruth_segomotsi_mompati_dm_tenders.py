"""Dr Ruth Segomotsi Mompati District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Dr Ruth Segomotsi Mompati District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Dr Ruth Segomotsi Mompati District Municipality tenders</h1>
        <table>
            <thead>
...
class DrRuthSegomotsiMompatiDmSource:
    """Tender source plug-in for Dr Ruth Segomotsi Mompati District Municipality."""

    source_id: str = "dr_ruth_segomotsi_mompati_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.rsmdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Dr Ruth Segomotsi Mompati District Municipality"
