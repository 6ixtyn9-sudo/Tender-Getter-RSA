"""Central Karoo District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Central Karoo District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Central Karoo District Municipality tenders</h1>
        <table>
            <thead>
...
class CentralKarooDmSource:
    """Tender source plug-in for Central Karoo District Municipality."""

    source_id: str = "central_karoo_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ckdm.co.za/tenders"):
        self.url = url
        self.issuing_entity = "Central Karoo District Municipality"
