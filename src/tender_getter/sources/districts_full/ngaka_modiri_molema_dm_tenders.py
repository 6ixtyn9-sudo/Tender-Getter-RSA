"""Ngaka Modiri Molema District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Ngaka Modiri Molema District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Ngaka Modiri Molema District Municipality tenders</h1>
        <table>
            <thead>
...
class NgakaModiriMolemaDmSource:
    """Tender source plug-in for Ngaka Modiri Molema District Municipality."""

    source_id: str = "ngaka_modiri_molema_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.nmmdm.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "Ngaka Modiri Molema District Municipality"
