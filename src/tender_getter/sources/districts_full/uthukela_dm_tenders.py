"""uThukela District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uThukela District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uThukela District Municipality tenders</h1>
        <table>
            <thead>
...
class UthukelaDmSource:
    """Tender source plug-in for uThukela District Municipality."""

    source_id: str = "uthukela_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.uthukela.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "uThukela District Municipality"
