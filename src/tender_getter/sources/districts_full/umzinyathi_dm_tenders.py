"""uMzinyathi District Municipality tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>uMzinyathi District Municipality Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active uMzinyathi District Municipality tenders</h1>
        <table>
            <thead>
...
class UmzinyathiDmSource:
    """Tender source plug-in for uMzinyathi District Municipality."""

    source_id: str = "umzinyathi_dm_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.umzinyathi.gov.za/tenders"):
        self.url = url
        self.issuing_entity = "uMzinyathi District Municipality"
