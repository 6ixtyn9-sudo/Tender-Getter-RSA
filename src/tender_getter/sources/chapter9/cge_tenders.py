"""Commission for Gender Equality (CGE) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Commission for Gender Equality (CGE) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Commission for Gender Equality (CGE) tenders</h1>
        <table>
            <thead>
...
class CgeSource:
    """Tender source plug-in for Commission for Gender Equality (CGE)."""

    source_id: str = "cge_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.cge.org.za/tenders/"):
        self.url = url
        self.issuing_entity = "Commission for Gender Equality (CGE)"
