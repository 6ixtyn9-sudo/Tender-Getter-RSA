"""Independent Police Investigative Directorate (IPID) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Independent Police Investigative Directorate (IPID) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Independent Police Investigative Directorate (IPID) tenders</h1>
        <table>
            <thead>
...
class IpidSource:
    """Tender source plug-in for Independent Police Investigative Directorate (IPID)."""

    source_id: str = "ipid_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ipid.gov.za/tenders/"):
        self.url = url
        self.issuing_entity = "Independent Police Investigative Directorate (IPID)"
