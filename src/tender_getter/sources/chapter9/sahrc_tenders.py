"""South African Human Rights Commission (SAHRC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Human Rights Commission (SAHRC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active South African Human Rights Commission (SAHRC) tenders</h1>
        <table>
            <thead>
...
class SahrcSource:
    """Tender source plug-in for South African Human Rights Commission (SAHRC)."""

    source_id: str = "sahrc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.sahrc.org.za/index.php/procurement"):
        self.url = url
        self.issuing_entity = "South African Human Rights Commission (SAHRC)"
