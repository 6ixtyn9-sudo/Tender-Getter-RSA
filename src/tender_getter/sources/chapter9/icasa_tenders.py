"""Independent Communications Authority of South Africa (ICASA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Independent Communications Authority of South Africa (ICASA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Independent Communications Authority of South Africa (ICASA) tenders</h1>
        <table>
            <thead>
...
class IcasaSource:
    """Tender source plug-in for Independent Communications Authority of South Africa (ICASA)."""

    source_id: str = "icasa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.icasa.org.za/pages/tenders"):
        self.url = url
        self.issuing_entity = "Independent Communications Authority of South Africa (ICASA)"
