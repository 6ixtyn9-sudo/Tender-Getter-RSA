"""Auditor-General South Africa (AGSA) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Auditor-General South Africa (AGSA) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Auditor-General South Africa (AGSA) tenders</h1>
        <table>
            <thead>
...
class AgsaSource:
    """Tender source plug-in for Auditor-General South Africa (AGSA)."""

    source_id: str = "agsa_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.agsa.co.za/procurement"):
        self.url = url
        self.issuing_entity = "Auditor-General South Africa (AGSA)"
