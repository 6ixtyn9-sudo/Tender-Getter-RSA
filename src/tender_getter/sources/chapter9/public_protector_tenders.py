"""Office of the Public Protector tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Office of the Public Protector Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Office of the Public Protector tenders</h1>
        <table>
            <thead>
...
class PublicProtectorSource:
    """Tender source plug-in for Office of the Public Protector."""

    source_id: str = "public_protector_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.publicprotector.org/tenders/"):
        self.url = url
        self.issuing_entity = "Office of the Public Protector"
