"""Financial and Fiscal Commission (FFC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Financial and Fiscal Commission (FFC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Financial and Fiscal Commission (FFC) tenders</h1>
        <table>
            <thead>
...
class FfcSource:
    """Tender source plug-in for Financial and Fiscal Commission (FFC)."""

    source_id: str = "ffc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.ffc.co.za/tenders/"):
        self.url = url
        self.issuing_entity = "Financial and Fiscal Commission (FFC)"
