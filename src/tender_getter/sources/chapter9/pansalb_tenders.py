"""Pan South African Language Board (PanSALB) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Pan South African Language Board (PanSALB) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Pan South African Language Board (PanSALB) tenders</h1>
        <table>
            <thead>
...
class PansalbSource:
    """Tender source plug-in for Pan South African Language Board (PanSALB)."""

    source_id: str = "pansalb_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.pansalb.org/tenders/"):
        self.url = url
        self.issuing_entity = "Pan South African Language Board (PanSALB)"
