"""Public Service Commission (PSC) tender source plug-in."""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Public Service Commission (PSC) Tenders</title></head>
<body>
    <div class="tenders-wrapper">
        <h1>Active Public Service Commission (PSC) tenders</h1>
        <table>
            <thead>
...
class PscSource:
    """Tender source plug-in for Public Service Commission (PSC)."""

    source_id: str = "psc_tenders"
    live: bool = True

    def __init__(self, url: str = "https://www.psc.gov.za/tenders/"):
        self.url = url
        self.issuing_entity = "Public Service Commission (PSC)"
