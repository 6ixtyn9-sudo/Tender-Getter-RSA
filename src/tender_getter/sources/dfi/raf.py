"""Road Accident Fund Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Road Accident Fund Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Road Accident Fund tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>RAF/2025/LEGAL/19</td>
                    <td>Legal Panel Services (Gauteng)</td>
                    <td>2026-09-16 11:00:00</td>
                </tr>
                <tr>
                    <td>RAF/2025/MED/07</td>
                    <td>Medical Assessment Panels (Gauteng)</td>
                    <td>2026-08-29 11:00:00</td>
                </tr>
                <tr>
                    <td>RAF/2025/ICT/12</td>
                    <td>Cloud Database Operations (Gauteng)</td>
...
class RAFSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Road Accident Fund tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_RAF_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Road Accident Fund tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Road Accident Fund",
