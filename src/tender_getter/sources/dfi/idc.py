"""Industrial Development Corporation Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Industrial Development Corporation Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Industrial Development Corporation tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>IDC/2025/SME/09</td>
                    <td>SMME Development Platform (Gauteng)</td>
                    <td>2026-09-12 11:00:00</td>
                </tr>
                <tr>
                    <td>IDC/2025/FIN/04</td>
                    <td>Credit Scoring System (Gauteng)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>IDC/2025/CONS/11</td>
                    <td>Economic Feasibility Studies (Gauteng)</td>
...
class IDCSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Industrial Development Corporation tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_IDC_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Industrial Development Corporation tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Industrial Development Corporation",
