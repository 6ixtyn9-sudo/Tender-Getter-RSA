"""Small Enterprise Development Agency Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Small Enterprise Development Agency Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Small Enterprise Development Agency tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>SEDA/2025/TRAIN/15</td>
                    <td>Entrepreneurship Training Programme (National)</td>
                    <td>2026-09-14 11:00:00</td>
                </tr>
                <tr>
                    <td>SEDA/2025/ICT/06</td>
                    <td>Incubation Management Software (National)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>SEDA/2025/MARK/03</td>
                    <td>SMME Marketing Consulting (National)</td>
...
class SEDASource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Small Enterprise Development Agency tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SEDA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Small Enterprise Development Agency tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Small Enterprise Development Agency",
