"""Small Enterprise Finance Agency Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>Small Enterprise Finance Agency Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Small Enterprise Finance Agency tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>sefa/2025/ICT/08</td>
                    <td>Loan Management Platform (Gauteng)</td>
                    <td>2026-09-11 11:00:00</td>
                </tr>
                <tr>
                    <td>sefa/2025/FIN/02</td>
                    <td>Credit Scoring System (Gauteng)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>sefa/2025/AUDIT/05</td>
                    <td>Financial Auditing Services (Gauteng)</td>
...
class SefaSource:
    source_id: str = "sefa_tenders"

    def __init__(self, url: str = "https://www.sefa.org.za/tenders"):
        self.url = url

    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Small Enterprise Finance Agency tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SEFA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Small Enterprise Finance Agency tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Small Enterprise Finance Agency",
