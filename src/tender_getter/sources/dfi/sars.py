"""South African Revenue Service Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African Revenue Service Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active South African Revenue Service tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>SARS/2025/ICT/22</td>
                    <td>Customs Inspection Hardware (National)</td>
                    <td>2026-09-15 11:00:00</td>
                </tr>
                <tr>
                    <td>SARS/2025/TECH/08</td>
                    <td>Border Scanner Maintenance (National, Grade 3EE)</td>
                    <td>2026-08-31 11:00:00</td>
                </tr>
                <tr>
                    <td>SARS/2025/SOFT/14</td>
                    <td>Enterprise Tax System Upgrade (National)</td>
...
class SARSSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active South African Revenue Service tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SARS_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses South African Revenue Service tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="South African Revenue Service",
