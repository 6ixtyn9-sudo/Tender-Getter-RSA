"""Compensation Fund Tender Source Plugin"""
import logging
import re
...
MOCK_COMPENSATION_FUND_HTML = """
<!DOCTYPE html>
<html>
<head><title>Compensation Fund Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Compensation Fund tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>CF/2025/ICT/06</td>
                    <td>Injury Claim Management System (National)</td>
                    <td>2026-09-09 11:00:00</td>
                </tr>
                <tr>
                    <td>CF/2025/MED/03</td>
                    <td>Rehabilitation Consulting Services (National)</td>
                    <td>2026-08-26 11:00:00</td>
                </tr>
                <tr>
                    <td>CF/2025/EQ/11</td>
                    <td>Medical Scanning Equipment (National)</td>
...
class CompensationFundSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Compensation Fund tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_COMPENSATION_FUND_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_COMPENSATION_FUND_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Compensation Fund tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Compensation Fund",
