"""South African National Parks Tender Source Plugin"""
import logging
import re
...
<!DOCTYPE html>
<html>
<head><title>South African National Parks Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active South African National Parks tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>SANPARKS/2025/CE/11</td>
                    <td>Game Reserve Fencing – Kruger (National, Grade 2CE)</td>
                    <td>2026-09-10 11:00:00</td>
                </tr>
                <tr>
                    <td>SANPARKS/2025/ROAD/04</td>
                    <td>Tourist Road Paving (National, Grade 3CE)</td>
                    <td>2026-08-29 11:00:00</td>
                </tr>
                <tr>
                    <td>SANPARKS/2025/MAINT/07</td>
                    <td>Lodge Maintenance Services (National, Grade 2GB)</td>
...
class SANParksSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active South African National Parks tenders.
        ...
        if html_content is None:
            try:
                ...
                html_content = MOCK_SANPARKS_HTML
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_SANPARKS_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses South African National Parks tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="South African National Parks",
