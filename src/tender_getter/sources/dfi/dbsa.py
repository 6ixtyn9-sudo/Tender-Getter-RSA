...
<!DOCTYPE html>
<html>
<head><title>Development Bank of Southern Africa Tenders</title></head>
<body>
    <div class="wrapper">
        <h1>Active Development Bank of Southern Africa tenders</h1>
        <table>
            <thead>
                <tr>
                    <th>Bid Number</th>
            ...
            <tbody>
                <tr>
                    <td>DBSA/2025/CONS/14</td>
                    <td>Municipal Infrastructure Design Consultancy (Gauteng)</td>
                    <td>2026-09-18 11:00:00</td>
                </tr>
                <tr>
                    <td>DBSA/2025/ICT/06</td>
                    <td>Project Monitoring Software (Gauteng)</td>
                    <td>2026-08-30 11:00:00</td>
                </tr>
                <tr>
                    <td>DBSA/2025/AUDIT/03</td>
                    <td>Mega-Project Audit Services (Gauteng)</td>
...
class DBSASource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Development Bank of Southern Africa tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_DBSA_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Development Bank of Southern Africa tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Development Bank of Southern Africa",
