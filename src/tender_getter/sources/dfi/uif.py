"""Unemployment Insurance Fund Tender Source Plugin"""
import logging
import re
...
<body>
    <div class="wrapper">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>UIF/2025/ICT/14</td>
                    <td>Fraud Prevention System (National)</td>
                    <td>2026-09-13 11:00:00</td>
                </tr>
                <tr>
                    <td>UIF/2025/SOFT/05</td>
                    <td>Payout Processing Software (National)</td>
                    <td>2026-08-28 11:00:00</td>
                </tr>
                <tr>
                    <td>UIF/2025/AUDIT/09</td>
                    <td>Financial Auditing Services (National)</td>
...
class UIFSource:
    ...
    def fetch(self, limit: Optional[int] = None, html_content: Optional[str] = None) -> List[TenderOpportunity]:
        """
        Fetches and parses active Unemployment Insurance Fund tenders.
        ...
        if not tenders and not engaged_fallback:
            ...
            tenders = self.parse_html(MOCK_UIF_HTML, limit)

        return tenders

    def parse_html(self, html: str, limit: Optional[int] = None) -> List[TenderOpportunity]:
        """
        Parses Unemployment Insurance Fund tenders table/list from HTML using standard Python regex.
        """
        tenders = []
        ...
        for row_html in rows:
            ...
            opportunity = TenderOpportunity(
                ...
                issuing_entity="Unemployment Insurance Fund",
