...
Retired: OpenCorporates — its South Africa dataset is an archive frozen at
September 2014 (sourced from CIPRO, CIPC's predecessor; re-use terms blocked
further updates). A 12-year-stale mirror can only mislead verdicts: missing
for every company registered since 2014, and "In Business" proves nothing
today. Do not re-add.
