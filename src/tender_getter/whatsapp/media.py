        ...
        return base_prompt + """
{
  ...
  "csd_supplier_active": "boolean or null — read the report's own 'Is supplier active?' field (Yes=true, No=false). null if the field is absent.",
  "csd_business_status": "string or null — read the report's 'Business status' field exactly as printed, e.g. 'In Business'. null if absent.",
  "csd_report_date": "string (YYYY-MM-DD) or null — the report's 'Report Date' line near the top. null if absent.",
  "address": "string",
