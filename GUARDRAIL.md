...
The repo root should contain zero standalone scripts. Every file in the repo root that isn't `README.md`, `PLANNING.md`, `pyproject.toml`, `pytest.ini`, or `sources.yaml` is bloat.
